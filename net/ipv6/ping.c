...
typedef int (ipv6_recv_error_type)(struct sock *sk, struct msghdr *msg, int len);
typedef int (ipv6_chk_addr_type)(struct net *net, const struct in6_addr *addr,
		struct net_device *dev, int strict);
int __init pingv6_init(void)
{
	pingv6_ops.ipv6_recv_error = (ipv6_recv_error_type *)ipv6_recv_error;
	pingv6_ops.ip6_datagram_recv_ctl = ip6_datagram_recv_ctl;
	pingv6_ops.icmpv6_err_convert = icmpv6_err_convert;
	pingv6_ops.ipv6_icmp_error = ipv6_icmp_error;
	pingv6_ops.ipv6_chk_addr = (ipv6_chk_addr_type *)ipv6_chk_addr;

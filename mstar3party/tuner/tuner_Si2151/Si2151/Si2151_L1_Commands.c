    ...
    switch (cmd_code) {
     ...
     case         Si2151_PART_INFO_CMD_CODE:
      sprintf(msg,"PART_INFO ");
       ...
       sprintf(msg,"%s%s",msg,separator); strcat(msg,"-SERIAL   "); sprintf(msg,"%s%d", msg, api->rsp->part_info.serial);
     ...
     case         Si2151_PART_INFO2_CMD_CODE:
      sprintf(msg,"PART_INFO2 ");
       ...
       sprintf(msg,"%s%s",msg,separator); strcat(msg,"-SERIAL   "); sprintf(msg,"%s%d", msg, api->rsp->part_info2.serial);
     break;
    #endif /*     Si2151_PART_INFO2_CMD */
     ...
     case         Si2151_TUNER_STATUS_CMD_CODE:
      sprintf(msg,"TUNER_STATUS ");
       ...
       sprintf(msg,"%s%s",msg,separator); strcat(msg,"-FREQ     "); sprintf(msg,"%s%d", msg, api->rsp->tuner_status.freq);

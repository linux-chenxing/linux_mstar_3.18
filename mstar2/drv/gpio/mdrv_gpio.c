...
{
    MHal_GPIO_Pad_Set(u8IndexGPIO-1);
}
...
{
    MHal_GPIO_Pad_Oen(u8IndexGPIO-1);
}
...
{
    MHal_GPIO_Pad_Odn(u8IndexGPIO-1);
}
...
{
    return MHal_GPIO_Pad_Level(u8IndexGPIO-1);
}
...
{
    return MHal_GPIO_Pad_InOut(u8IndexGPIO-1);
}
...
{
    MHal_GPIO_Pull_High(u8IndexGPIO-1);
}
...
{
    MHal_GPIO_Pull_Low(u8IndexGPIO-1);
}
...
{
    MHal_GPIO_Set_High(u8IndexGPIO-1);
}
...
{
    MHal_GPIO_Set_Low(u8IndexGPIO-1);
}

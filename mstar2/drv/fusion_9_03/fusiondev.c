...
compat_shmpool_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	switch (_IOC_NR(cmd))
	{
		...
		case _IOC_NR(COMPAT_FUSION_SHMPOOL_GET_BASE):
...
compat_ref_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	switch (_IOC_NR(cmd))
	{
		...
		case _IOC_NR(COMPAT_FUSION_REF_SET_SYNC):
		case _IOC_NR(COMPAT_FUSION_REF_CATCH):
		case _IOC_NR(COMPAT_FUSION_REF_THROW):
	    		return filp->f_op->unlocked_ioctl(filp, cmd, (unsigned long)compat_ptr(arg));
	}
...
static int compat_get_fusion_call_get_owner_allocation_data(
			CompatFusionCallGetOwner __user *data32,
			FusionCallGetOwner __user *data)
{
      int err;
      compat_int_t  s32;
      compat_uptr_t compat_ptr;
      err = get_user(s32, &data32->fusion_id);
      err |= put_user(s32, &data->fusion_id);
      err |= get_user(s32, &data32->call_id);
      err |= put_user(s32, &data->call_id);
...
static int compat_put_fusion_call_get_owner_allocation_data(
			CompatFusionCallGetOwner __user *data32,
			FusionCallGetOwner __user *data)
{
      int err;
      compat_int_t  s32;
      compat_uptr_t compat_ptr;
      err = get_user(s32, &data->fusion_id);
      err |= put_user(s32, &data32->fusion_id);
			...
			FusionCallExecute __user *data)
{
	...
	err |= get_user(s32, &data->call_id);
	err |= put_user(s32, &data32->call_id);
	err |= get_user(s32, &data->call_arg);
	err |= put_user(s32, &data32->call_arg);
	err |= get_user(compat_ptr, &data->call_ptr);
	err |= put_user(compat_ptr, &data32->call_ptr);
	err |= get_user(s32,&data->flags);
	err |= put_user(s32,&data32->flags);
      err |= get_user(s32,&data->serial);
	err |= put_user(s32,&data32->serial);
	return err;
}


static int compat_put_fusion_call_execute_allocation_data2(
			CompatFusionCallExecute2 __user *data32,
			FusionCallExecute2 __user *data)
{
	int err;
	compat_int_t  s32;
	compat_uptr_t compat_ptr;
	...
	err |= get_user(s32, &data->call_arg);
	err |= put_user(s32, &data32->call_arg);
	err |= get_user(compat_ptr, &data->ptr);
	err |= put_user(compat_ptr, &data32->ptr);
	err |= get_user(s32,&data->flags);
	err |= put_user(s32,&data32->flags);
	err |= get_user(s32,&data->serial);
	err |= put_user(s32,&data32->serial);
...
static int compat_put_fusion_call_execute_allocation_data3(
			CompatFusionCallExecute3 __user *data32,
			FusionCallExecute3 __user *data)
{
	int err;
	compat_int_t  s32;
	compat_uptr_t compat_ptr;
	err = get_user(compat_ptr, &data->ret_ptr);
	err |= put_user(compat_ptr, &data32->ret_ptr);
	err |= get_user(s32, &data->call_id);
	err |= put_user(s32, &data32->call_id);
	err |= get_user(s32, &data->call_arg);
	err |= put_user(s32, &data32->call_arg);
	...
	err |= get_user(s32,&data->flags);
	err |= put_user(s32,&data32->flags);
	err |= get_user(s32,&data->length);
	err |= put_user(s32,&data32->length);
	err |= get_user(s32,&data->ret_length);
	err |= put_user(s32,&data32->ret_length);
			...
			FusionCallExecute __user *data)
{
	...
	err |= put_user(s32,&data->flags);
      err |= get_user(s32,&data32->serial);
	err |= put_user(s32,&data->serial);

	return err;
}


static int compat_get_fusion_call_execute_allocation_data2(
			CompatFusionCallExecute2 __user *data32,
			FusionCallExecute2 __user *data)
{
	int err;
	compat_int_t  s32;
	compat_uptr_t compat_ptr;
	err = get_user(compat_ptr, &data32->ret_val);
	err |= put_user(compat_ptr, &data->ret_val);
	err |= get_user(s32, &data32->call_id);
	err |= put_user(s32, &data->call_id);
	err |= get_user(s32, &data32->call_arg);
	err |= put_user(s32, &data->call_arg);
	err |= get_user(compat_ptr, &data32->ptr);
	err |= put_user(compat_ptr, &data->ptr);
	err |= get_user(s32,&data32->flags);
	err |= put_user(s32,&data->flags);
	err |= get_user(s32,&data32->length);
	err |= put_user(s32,&data->length);
	err |= get_user(s32,&data32->serial);
	err |= put_user(s32,&data->serial);
...
static int compat_get_fusion_call_execute_allocation_data3(
			CompatFusionCallExecute3 __user *data32,
			FusionCallExecute3 __user *data)
{
	int err;
	...
	err = get_user(compat_ptr, &data32->ret_ptr);
	err |= put_user(compat_ptr, &data->ret_ptr);
	err |= get_user(s32, &data32->call_id);
	err |= put_user(s32, &data->call_id);
	err |= get_user(s32, &data32->call_arg);
	err |= put_user(s32, &data->call_arg);
	...
	err |= get_user(s32,&data32->length);
	err |= put_user(s32,&data->length);
	err |= get_user(s32,&data32->ret_length);
	err |= put_user(s32,&data->ret_length);
	err |= get_user(s32,&data32->serial);
	err |= put_user(s32,&data->serial);
...
static int compat_get_fusion_call_return3_allocation_data(
			CompatFusionCallReturn3 __user *data32,
			FusionCallReturn3 __user *data)
{
	int err;
	compat_int_t  s32;
	compat_uptr_t compat_ptr;
...
static int compat_put_fusion_call_set_quota_allocation_data(
			CompatFusionCallSetQuota __user *data32,
			FusionCallSetQuota __user *data)
{
      int err;
      compat_int_t  s32;
      compat_uptr_t compat_ptr;
	...
	err |= get_user(s32, &data->fusion_id);
	err |= put_user(s32, &data32->fusion_id);
	err |= get_user(s32, &data->limit);
	err |= put_user(s32, &data32->limit);
	return err;

}
static int compat_get_fusion_call_set_quota_allocation_data(
			CompatFusionCallSetQuota __user *data32,
			FusionCallSetQuota __user *data)
{
      int err;
	...
	err |= get_user(s32, &data32->fusion_id);
	err |= put_user(s32, &data->fusion_id);
	err |= get_user(s32, &data32->limit);
	err |= put_user(s32, &data->limit);
...
compat_call_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	switch (_IOC_NR(cmd))
	{
		...
		case _IOC_NR(COMPAT_FUSION_CALL_EXECUTE2):
		{
	            CompatFusionCallExecute2 __user *data32;
	            FusionCallExecute2 __user *data;
	            data32 = compat_ptr(arg);
	            ...
	            err = compat_get_fusion_call_execute_allocation_data2(data32, data);
	            if (err)
	                return err;

	    		ret = filp->f_op->unlocked_ioctl(filp, FUSION_CALL_EXECUTE2, (unsigned long)data);

                   return compat_put_fusion_call_execute_allocation_data2(data32, data);
		}
		case _IOC_NR(COMPAT_FUSION_CALL_EXECUTE3):
		{
	            CompatFusionCallExecute3 __user *data32;
	            FusionCallExecute3 __user *data;
	            data32 = compat_ptr(arg);
	            ...
	            err = compat_get_fusion_call_execute_allocation_data3(data32, data);
	            if (err){
	                return err;}

	    		ret = filp->f_op->unlocked_ioctl(filp, FUSION_CALL_EXECUTE3, (unsigned long)data);

                   return compat_put_fusion_call_execute_allocation_data3(data32, data);
		}
		...
		case _IOC_NR(COMPAT_FUSION_CALL_DESTROY):
		 ...
		 case _IOC_NR(COMPAT_FUSION_CALL_RETURN3):	
		 {
		      CompatFusionCallReturn3 __user *data32;
	            FusionCallReturn3 __user *data;
	            data32 = compat_ptr(arg);
			 ...
			 err = compat_get_fusion_call_return3_allocation_data(data32, data);
	            if (err)
	                return err;

	    		return filp->f_op->unlocked_ioctl(filp, FUSION_CALL_RETURN3, (unsigned long)data);
		 }

		case _IOC_NR(COMPAT_FUSION_CALL_GET_OWNER): 
		{
			CompatFusionCallGetOwner __user *data32;
	            FusionCallGetOwner __user *data;
	            data32 = compat_ptr(arg);
	            ...
	            err = compat_get_fusion_call_get_owner_allocation_data(data32, data);
	            if (err)
	                return err;

	    		ret = filp->f_op->unlocked_ioctl(filp, FUSION_CALL_GET_OWNER, (unsigned long)data);

                   return compat_put_fusion_call_get_owner_allocation_data(data32, data);

		}
		case _IOC_NR(COMPAT_FUSION_CALL_SET_QUOTA):
		{
	            CompatFusionCallSetQuota __user *data32;
	            FusionCallSetQuota __user *data;
	            data32 = compat_ptr(arg);
	            ...
	            err = compat_get_fusion_call_set_quota_allocation_data(data32, data);
	            if (err)
	                return err;

	    		ret = filp->f_op->unlocked_ioctl(filp, FUSION_CALL_SET_QUOTA, (unsigned long)data);
                    err = compat_put_fusion_call_set_quota_allocation_data(data32, data);
...
static int compat_get_fusion_get_fusionee_info_allocation_data(
			CompatFusionGetFusioneeInfo __user *data32,
			FusionGetFusioneeInfo __user *data)
{
      int err;
      compat_int_t  s32;
      compat_ulong_t u32;
      err = get_user(s32, &data32->fusion_id);
      err |= put_user(s32, &data->fusion_id);
      err |= get_user(s32, &data32->pid);
      err |= put_user(s32, &data->pid);
     copy_in_user(data->exe_file, data32->exe_file, PATH_MAX);

      return err;

}

static int compat_get_fusion_entry_add_permissions(
			CompatFusionEntryPermissions __user *data32,
			FusionEntryPermissions __user *data)
{
      int err;
      compat_int_t  s32;
      compat_ulong_t u32;
      err = get_user(s32, &data32->fusion_id);
      err |= put_user(s32, &data->fusion_id);
      err |= get_user(s32, &data32->type);
      err |= put_user(s32, &data->type);
      err |= get_user(s32, &data32->id);
      err |= put_user(s32, &data->id);
	err |= get_user(s32, &data32->permissions);
      err |= put_user(s32, &data->permissions);
...
static int compat_get_fusion_entry_set_info(
			CompatFusionEntryInfo __user *data32,
			FusionEntryInfo __user *data)
{
      int err;
      compat_int_t  s32;
      compat_ulong_t u32;
      ...
      copy_in_user(data->name, data32->name, FUSION_ENTRY_INFO_NAME_LENGTH);
...
static int compat_put_fusion_get_fusionee_info_allocation_data(
			CompatFusionGetFusioneeInfo __user *data32,
			FusionGetFusioneeInfo __user *data)
{
      int err;
      ...
      err = get_user(s32, &data->fusion_id);
      err |= put_user(s32, &data32->fusion_id);
      err |= get_user(s32, &data->pid);
      err |= put_user(s32, &data32->pid);
     copy_in_user(data32->exe_file, data->exe_file, PATH_MAX);
...
compat_lounge_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	switch (_IOC_NR(cmd)) {
		...
		case _IOC_NR(COMPAT_FUSION_GET_FUSIONEE_INFO):
		{
		      CompatFusionGetFusioneeInfo __user *data32;
	            FusionGetFusioneeInfo __user *data;
	            data32 = compat_ptr(arg);
	            ...
	            err = compat_get_fusion_get_fusionee_info_allocation_data(data32, data);
	            if (err)
	                return err;

	    	      ret = filp->f_op->unlocked_ioctl(filp, FUSION_GET_FUSIONEE_INFO, (unsigned long)data);
	            err = compat_put_fusion_get_fusionee_info_allocation_data(data32, data);
	            return ret ? ret : err;
		}
		...
		case _IOC_NR(COMPAT_FUSION_SYNC):

		      return filp->f_op->unlocked_ioctl(filp, FUSION_SYNC, (unsigned long)compat_ptr(arg));
		...
		case _IOC_NR(COMPAT_FUSION_ENTRY_SET_INFO):
		 {
		     CompatFusionEntryInfo __user *data32;
	            ...
	            err = compat_get_fusion_entry_set_info(data32, data);
	            if (err)
	                return err;
		...
		case _IOC_NR(COMPAT_FUSION_FORK):
		{
            ...
            case _IOC_NR(COMPAT_FUSION_SHM_GET_BASE):
            {
                return filp->f_op->unlocked_ioctl(filp, cmd, (unsigned long)compat_ptr(arg));
            }
            case _IOC_NR(COMPAT_FUSION_ENTRY_ADD_PERMISSIONS):
		 {
	            CompatFusionEntryPermissions __user *data32;
	            FusionEntryPermissions __user *data;
	            data32 = compat_ptr(arg);
	            ...
	            err = compat_get_fusion_entry_add_permissions(data32, data);
	            if (err)
	                return err;

	    	      return filp->f_op->unlocked_ioctl(filp, FUSION_ENTRY_ADD_PERMISSIONS, (unsigned long)data);
		 }

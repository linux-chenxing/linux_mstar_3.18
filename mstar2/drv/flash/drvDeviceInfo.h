...
#define FLASH_IC_MX25L6406EA     0x0513UL
// NX
...
static ST_WRITE_PROTECT _pstWriteProtectTable_MX25L6455EA[] =
{
    //  BPX,                            Lower Bound                 Upper Bound
    {   BITS(5:2, 14),  FROM_BLK(0,   SIZE_64KB),   TO_BLK(127, SIZE_64KB) }, // 14, 0~127
    {   BITS(5:2, 13),  FROM_BLK(0,   SIZE_64KB),   TO_BLK(127, SIZE_64KB) }, // 13, 0~127
...
static hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_MX25L6406EA, MID_MXIC,   0x26,   0x1A,   _pstWriteProtectTable_MX25L6455EA,    NULL,                       0x800000,   128,    SIZE_64KB,  256,    50,     BITS(5:2, 0x0F),    ISP_DEV_ST,     ISP_SPI_ENDIAN_LITTLE, {E_SPI_54M  , E_DUAL_AD_MODE}, TRUE,  BITS(6:6, 1)},

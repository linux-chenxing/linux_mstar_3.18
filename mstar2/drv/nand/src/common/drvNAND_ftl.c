...
#endif
#if UNFD_FTL_FMAP
static U32  nand_FM_WriteFlow(U32 u32_StartSectorIdx, U32 u32_SectorCnt, uintptr_t u32_RWBufferAddress);
static U32  nand_FM_ReadFlow(U32 u32_StartSectorIdx, U32 u32_SectorCnt, uintptr_t u32_RWBufferAddress);
...
U32 nand_WriteFlow(U32 u32_StartSectorIdx, U32 u32_SectorCnt, uintptr_t u32_RWBufferAddress)
{
    NAND_DRIVER *pNandDrv = drvNAND_get_DrvContext_address();
    DATA_BLK_SPARE_t *pDataBlkSpare_t = (P_DATA_BLK_SPARE_t)pNandDrv->PlatCtx_t.pu8_PageSpareBuf;
...
U32 nand_ReadFlow(U32 u32_StartSectorIdx, U32 u32_SectorCnt, uintptr_t u32_RWBufferAddress)
{
    NAND_DRIVER *pNandDrv = drvNAND_get_DrvContext_address();
    U32 u32_Row;

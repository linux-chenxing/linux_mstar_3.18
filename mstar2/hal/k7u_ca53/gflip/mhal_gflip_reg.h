...
// For 2nd MIU GROUP
#define GOP_MIU_REG_GROUP2                      0x7C
#define GOP_MIU_CLIENT_GROUP2                   BIT(2)
...
#define REG_GOP_BANK_SEL_EX                     0x007c
    #define GOP1GX0_INT_FLAG                    BIT(1)
    #define GOP1GX0_WR_ACK                      BIT(2)
...
#define GOP_GOP3CLK                             0x42
    ...
    #define CKG_GOPG3_IDCLK1                    BITS(12:10, 2)

/* GOP4 CLK*/ //Note: Actually, means GOP_5 in K6 HW reg table. K6 don't have GOP_4
#define GOP_GOP4CLK                             0x44
    #define CKG_GOPG4_DISABLE_CLK               ~(BIT(8))

...
MS_U32 MHal_GFLIP_GetHDREOTFInfo(void)
{
    MS_U32 u32GFlipSupportType = 0;

    // not support (E_EOTF_HLG,E_EOTF_SMPTE_ST_2084,E_EOTF_HDR,E_EOTF_SDR) , return 0
    return u32GFlipSupportType;
}
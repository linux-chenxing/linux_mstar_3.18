#ifndef __UNFD_K6LITE_LINUX_H__
#define __UNFD_K6LITE_LINUX_H__
...
#define NFIE_4CLK_TABLE                     { NFIE_4CLK_12M, NFIE_4CLK_48M, NFIE_4CLK_62M, \
                                              ...
                                              NFIE_4CLK_160M, NFIE_4CLK_192M, NFIE_4CLK_216M, NFIE_4CLK_240M, NFIE_4CLK_320M}
...
#define EMMC_PLL_BASE_ADDR                  GET_REG_ADDR(RIU_BASE, REG_BANK_EMMC_PLL)
#define REG_DDR_SDR_CTRL                    GET_REG_ADDR(EMMC_PLL_BASE_ADDR, 0x6D)
#define NC_SM_STS                           GET_REG_ADDR(EMMC_PLL_BASE_ADDR, 0x6C)
...
#define BIT_DQS_DIR                         BIT8
#define BIT_SDR_RISING_LAT                  BIT1
#define BIT_SDR_FEEDBACK_LAT                BIT2

...
#define CFD_MAININOPUT_DummyRegs_Debug 1
...
#define CFD_SW_VERSION 0x00000017
#define CFD_TESTVECTORS_VERSION 0x0000
#define CFD_MAIN_CONTROL_ST_VERSION 2
...
#define CFD_ENUM_VERSION 1

#define CFD_HDMI_OSD_ST_VERSION 1

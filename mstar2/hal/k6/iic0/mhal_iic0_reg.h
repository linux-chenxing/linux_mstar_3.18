...
#define REG_IIC0_BASE              0xFD226800 // 0xBF200000 + (0x8D80*4) //The 4th port
...
#define MHal_IIC0_REG(addr)			(*(volatile U32*)(REG_IIC0_BASE + ((addr)<<2)))
...
//for port 0
#define CHIP_REG_HWI2C_MIIC0            (CHIP_REG_BASE+ (0x09)) 
//    #define CHIP_MIIC0_PAD_0            (__BIT0)
//    #define CHIP_MIIC0_PAD_1            (0)
...
//for port 1 
#define CHIP_REG_HWI2C_MIIC1            (CHIP_REG_BASE+ (0x09)) 
    #define CHIP_MIIC1_PAD_0            (0)
    #define CHIP_MIIC1_PAD_1            (__BIT1)
    #define CHIP_MIIC1_PAD_MSK          (__BIT1)

//for port 2
#define CHIP_REG_HWI2C_MIIC2            (CHIP_REG_BASE+ (0x09)) 
...
//for port 3
#define CHIP_REG_HWI2C_DDCR             (CHIP_REG_BASE+ (0x09)) //0x1EAE
...
#define REG_HWI2C_MIIC0_VER_SEL          (PIU_NONPM_REG_BASE+ (0x02*2)) //select MI2C mode
    #define REG_HWI2C_MIIC0_VER_V2       (0)
    #define REG_HWI2C_MIIC0_VER_V3       (__BIT1|__BIT0)
    #define REG_HWI2C_MIIC0_VER_MSK      (__BIT1|__BIT0)
...
//############################
//Standard mode
#define HWI2C0_REG_BASE                  (0x113400) //0x1(11800) + offset ==> default set to port 0
#define REG_HWI2C0_MIIC_CFG              (HWI2C0_REG_BASE+0x00*2)
...
#define REG_HWI2C0_CMD_START             (HWI2C0_REG_BASE+0x01*2)
    #define _CMD_START                  (__BIT0)
#define REG_HWI2C0_CMD_STOP              (HWI2C0_REG_BASE+0x01*2+1)
    #define _CMD_STOP                   (__BIT0)
#define REG_HWI2C0_WDATA                 (HWI2C0_REG_BASE+0x02*2)
#define REG_HWI2C0_WDATA_GET             (HWI2C0_REG_BASE+0x02*2+1)
    #define _WDATA_GET_ACKBIT           (__BIT0)
#define REG_HWI2C0_RDATA                 (HWI2C0_REG_BASE+0x03*2)
#define REG_HWI2C0_RDATA_CFG             (HWI2C0_REG_BASE+0x03*2+1)
    #define _RDATA_CFG_TRIG             (__BIT0)
    #define _RDATA_CFG_ACKBIT           (__BIT1)
#define REG_HWI2C0_INT_CTL               (HWI2C0_REG_BASE+0x04*2)
    #define _INT_CTL                    (__BIT0) //write this register to clear int
#define REG_HWI2C0_CUR_STATE             (HWI2C0_REG_BASE+0x05*2) //For Debug
    #define _CUR_STATE_MSK              (__BIT4|__BIT3|__BIT2|__BIT1|__BIT0)
#define REG_HWI2C0_INT_STATUS            (HWI2C0_REG_BASE+0x05*2+1) //For Debug
...
#define REG_HWI2C0_STP_CNT               (HWI2C0_REG_BASE+0x08*2)
#define REG_HWI2C0_CKH_CNT               (HWI2C0_REG_BASE+0x09*2)
#define REG_HWI2C0_CKL_CNT               (HWI2C0_REG_BASE+0x0A*2)
#define REG_HWI2C0_SDA_CNT               (HWI2C0_REG_BASE+0x0B*2)
#define REG_HWI2C0_STT_CNT               (HWI2C0_REG_BASE+0x0C*2)
#define REG_HWI2C0_LTH_CNT               (HWI2C0_REG_BASE+0x0D*2)
#define REG_HWI2C0_TMT_CNT               (HWI2C0_REG_BASE+0x0E*2)
#define REG_HWI2C0_SCLI_DELAY            (HWI2C0_REG_BASE+0x0F*2)
    #define _SCLI_DELAY                 (__BIT2|__BIT1|__BIT0)

//DMA mode
#define REG_HWI2C0_DMA_CFG               (HWI2C0_REG_BASE+0x20*2)
    #define _DMA_CFG_RESET              (__BIT1)
    #define _DMA_CFG_INTEN              (__BIT2)
    #define _DMA_CFG_MIURST             (__BIT3)
    #define _DMA_CFG_MIUPRI             (__BIT4)
#define REG_HWI2C0_DMA_MIU_ADR           (HWI2C0_REG_BASE+0x21*2) // 4 bytes
#define REG_HWI2C0_DMA_CTL               (HWI2C0_REG_BASE+0x23*2)
...
#define REG_HWI2C0_DMA_TXR               (HWI2C0_REG_BASE+0x24*2)
    #define _DMA_TXR_DONE               (__BIT0)
#define REG_HWI2C0_DMA_CMDDAT0           (HWI2C0_REG_BASE+0x25*2) // 8 bytes
#define REG_HWI2C0_DMA_CMDDAT1           (HWI2C0_REG_BASE+0x25*2+1)
#define REG_HWI2C0_DMA_CMDDAT2           (HWI2C0_REG_BASE+0x26*2)
#define REG_HWI2C0_DMA_CMDDAT3           (HWI2C0_REG_BASE+0x26*2+1)
#define REG_HWI2C0_DMA_CMDDAT4           (HWI2C0_REG_BASE+0x27*2)
#define REG_HWI2C0_DMA_CMDDAT5           (HWI2C0_REG_BASE+0x27*2+1)
#define REG_HWI2C0_DMA_CMDDAT6           (HWI2C0_REG_BASE+0x28*2)
#define REG_HWI2C0_DMA_CMDDAT7           (HWI2C0_REG_BASE+0x28*2+1)
#define REG_HWI2C0_DMA_CMDLEN            (HWI2C0_REG_BASE+0x29*2)
    #define _DMA_CMDLEN_MSK             (__BIT2|__BIT1|__BIT0)
#define REG_HWI2C0_DMA_DATLEN            (HWI2C0_REG_BASE+0x2A*2) // 4 bytes
#define REG_HWI2C0_DMA_TXFRCNT           (HWI2C0_REG_BASE+0x2C*2) // 4 bytes
#define REG_HWI2C0_DMA_SLVADR            (HWI2C0_REG_BASE+0x2E*2)
    #define _DMA_SLVADR_10BIT_MSK       0x3FF //10 bits
    #define _DMA_SLVADR_NORML_MSK       0x7F //7 bits
#define REG_HWI2C0_DMA_SLVCFG            (HWI2C0_REG_BASE+0x2E*2+1)
    #define _DMA_10BIT_MODE             (__BIT2)
#define REG_HWI2C0_DMA_CTL_TRIG          (HWI2C0_REG_BASE+0x2F*2)
    #define _DMA_CTL_TRIG               (__BIT0)
#define REG_HWI2C0_DMA_CTL_RETRIG        (HWI2C0_REG_BASE+0x2F*2+1)

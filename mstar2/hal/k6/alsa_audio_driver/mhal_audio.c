...
#define _MAD_DMA_READER2_BASE_OFFSET    (0x2E7000 + _MAD_DSP2_TO_COMMON_DRAM_OFFSET)
...
#define _MAD_PCM_CAPTURE2_BASE_OFFSET   (0x2F7000 + _MAD_DSP2_TO_COMMON_DRAM_OFFSET)

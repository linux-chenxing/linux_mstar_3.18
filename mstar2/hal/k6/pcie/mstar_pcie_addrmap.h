...
#define CPDREF_RP_BASE                  mstar_pm_base + 0x003C0000    // Kano RC MAC IP Controller , Must Use Write32, it doesnt support 16bit write
#define REG_LOCAL_MANAGMENT             mstar_pm_base + 0x003C1000    // RC Local Management Registers, Must Use Write32/Read32
#define CPDREF_RP_BASE_RO_MODIFY        mstar_pm_base + 0x003C2000    // Root Port Registers. In this mode, certain RO fields in the configuration space can be written
#define REG_ADDRESS_TRANSLATION         mstar_pm_base + 0x003C4000    // Address Translation registers
...
#define MSTAR_REG_000F_BANK             mstar_pm_base + (0x00000F00<<1)
#define MSTAR_REG_0014_BANK             mstar_pm_base + (0x00001400<<1)
#ifdef CONFIG_MSTAR_K6
#define REG_PCIE_DM_BASE                0x1FA00000                     // PCIE Direct memory mapping
#define RIU_PCIE_DM_SIZE                  0x200000
#endif
//#define UINT64_T                        uint64_t
...
#define MSTAR_REG_0014_BANK             MSTAR_RIU_BASE + (0x00001400<<1)
#ifdef CONFIG_MSTAR_K6
#define REG_PCIE_DM_BASE                0x1FA00000                      // PCIE Direct memory mapping
#define RIU_PCIE_DM_SIZE                  0x200000
#endif
...
#define MSTAR_PCIE_IOMEM_BASE			0x1F800000
#define MSTAR_PCIE_IOMEM_LEN			0x400000
#define CONFIG_MSTAR_PCIE_OB_MEMIO_ENABLE									//Enable indirect outbound memory io
	#define MSTAR_PCIE_OB_MEMIO_REG1_BASE		(MSTAR_PCIE_IOMEM_BASE+0x200000)	//skip 2MB for two RC's BARs
	#define MSTAR_PCIE_OB_MEMIO_REG_START 	1									//start region number of ob memory io
	#define MSTAR_PCIE_OB_MEMIO_REGS		 	2									//region count for ob memory io

//#define CONFIG_MSTAR_PCIE_OB_MSG_ENABLE										//Enable outbound message io
	#define MSTAR_PCIE_OB_MSG_REG_START		MSTAR_PCIE_OB_MEMIO_REG_START+MSTAR_PCIE_OB_MEMIO_REGS  //start region number of ob message io

#define PCIE_ENABLE_PPC
#define PCIE_POWERCTRL_GPIO_OFFSET 			0xEE
#define PCIE_PERST_GPIO_OFFSET 				0xF2

#ifdef CONFIG_MP_PCI_PATCH_ADDR_TRANSLATE
#define CPDI_RP_IB_APERTURE_SIZE             31            // 1<< (31+1) == 4GB
#else
#define CPDI_RP_IB_APERTURE_SIZE             28            // 1<< (28+1) == 512MB
#endif
...
#define CPDI_RP_OB_REGION_NUMBER              MSTAR_PCIE_OB_MEMIO_REG_START            // must > 0
#define CPDI_RP_OB_REGION_ENABLE             25

#define CPDREF_PCIE_AXI_PHYS_BASE_EP            0x40000000    // 0x1f3a0010; for inbound Address Translation base "check"
#define CPDREF_RP_SRAM_LOCAL                    0x30000000    // 0x1f3a4800; BAR0 RP Inbound Physical MIU Address Translation  //43c00000-5fdfffff : System RAM
...
#define PCIE_DM_SIZE                        0x200000   // (2MB direct memory mapping)

#define PCIE_3LAYER_INTERRUPT               //Enable 3 layers Interrupt
#define PCIE_IRQ_INTA                       E_IRQ_INT_PCIE_RC + 10
#define PCIE_IRQ_INTB                       E_IRQ_INT_PCIE_RC + 11
#define PCIE_IRQ_INTC                       E_IRQ_INT_PCIE_RC + 12
#define PCIE_IRQ_INTD                       E_IRQ_INT_PCIE_RC + 13

#define BUS0_RC_ENABLE  //Enable Bus0 for RC, Bus1 for EP

#define CONFIG_MSTAR_PCIE_MIU01_DYNAMIC_SELECTION             //Enable KANO U03 Enable, MIU01 dynamic selection
//#define CONFIG_MSTAR_PCIE_HW_VAPA_ADDRESS_TRANSLATION         //Enable HW VAPA address translation

#ifdef CONFIG_MSTAR_PCIE_MIU01_DYNAMIC_SELECTION
#define ECO_MIU_SEL_OFF_MASK	~(REG_U02_DYNAMIC_MIU01_SELECTION | REG_U02_DYNAMIC_MIU01_CROSSING_CHECK | REG_U02_FIX_AXI_RLAST)
#define ECO_MIU_SEL_VAL			REG_U02_DYNAMIC_MIU01_SELECTION | REG_U02_DYNAMIC_MIU01_CROSSING_CHECK | REG_U02_FIX_AXI_RLAST
#endif

#ifdef CONFIG_MSTAR_PCIE_HW_VAPA_ADDRESS_TRANSLATION
#define ECO_HW_VAPA_ADR_TRANS_OFF_MASK ~(REG_U02_VAPA_ADDRESS_TRANSLATION + 0x0000FF00)
#define ECO_HW_VAPA_ADR_TRANS_VAL	( (((ARM_MIU0_BASE_ADDR-ARM_MIU0_BUS_BASE)>>28)<<REG_U02_MIU0_VAPA_ADDRESS_OFFSET_VALUE)	\
									| (((ARM_MIU1_BASE_ADDR-ARM_MIU1_BUS_BASE)>>28) << REG_U02_MIU1_VAPA_ADDRESS_OFFSET_VALUE) \
									| REG_U02_VAPA_ADDRESS_TRANSLATION )
#endif

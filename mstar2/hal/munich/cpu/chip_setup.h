...
#define SECOND_MAGIC_NUMBER_ADRESS  (TEEINFO_TYPTE==SECURITY_TEEINFO_OSTYPE_OPTEE ? 0xC0008000:(0xFD000000 + 0x101D00 * 2 + 0x6D * 4))
#define SECOND_START_ADDR  (TEEINFO_TYPTE==SECURITY_TEEINFO_OSTYPE_OPTEE ? 0xC0008000:(0xFD000000 + (0x101D00 * 2) + (0x7B * 4)))

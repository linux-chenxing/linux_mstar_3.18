...
#define REG_RTC_MATCH_VAL       (0x000E)    //BIT0-BIT31
#define REG_RTC_INT             (0x0000)
    #define RTC_RAW_INT_BIT         (0x0100)//BIT0
    #define RTC_INT_BIT             (0x0200)//BIT1
#define REG_RTC_CNT             (0x0016)    //BIT0-BIT31

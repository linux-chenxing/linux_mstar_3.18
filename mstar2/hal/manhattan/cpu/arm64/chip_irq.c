...
unsigned int interrupt_configs[MSTAR_CHIP_INT_END / 16] =
{
    ...
    0x00000000, /* 160~175 spi, set edge/level for mstar fiq */
    0x00000000, /* 176~191 spi, set edge/level for mstar fiq */
    0x00000000, /* 192~223 spi, set edge/level for mstar fiq */
};

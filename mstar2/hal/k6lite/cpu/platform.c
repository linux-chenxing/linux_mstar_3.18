...
#define THIRD_UTMI_BASE_ADDRESS_START   (0xFD000000 + (0x103800 << 1))  //0xFD207000
#define THIRD_UTMI_BASE_ADDRESS_END     (0xFD000000 + (0x10387E << 1))  //0xFD2070FC
...
static struct resource Third_Mstar_usb_ehci_resources[] =
{
	...
	[2] =
	{
		.start		=  E_IRQHYPH_UHC_P2,
		.end		=  E_IRQHYPH_UHC_P2,
		.flags		= IORESOURCE_IRQ,
	},
};
#endif

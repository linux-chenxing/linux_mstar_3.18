...
#endif
#ifdef CONFIG_GMAC_TX_DMA
#define TX_ZERO_COPY
#endif
#ifdef CONFIG_GMAC_TX_DESC_MODE
#define TX_DESC_MODE
#else
#ifdef CONFIG_GMAC_NEW_TX_QUEUE_V3
#define NEW_TX_QUEUE
#else
#define GMAC_TX_QUEUE_4
#endif
#endif
#ifdef CONFIG_GMAC_TX_SOFTWARE_QUEUE
...
#define REG_XIU32_GMAC0_BANK            0x1A1EUL
#define INTERNEL_PHY_REG_BASE           RIU_REG_BASE + ((REG_ALBANY0_BANK*0x100UL)<<1)
#define GMAC0_XIU16_REG_ADDR_BASE       RIU_REG_BASE + ((REG_GMAC0_BANK*0x100UL)<<1)
#define GMAC0_XIU32_REG_ADDR_BASE       RIU_REG_BASE + ((REG_XIU32_GMAC0_BANK*0x100UL)<<1)
#define GMAC_REG_ADDR_BASE_XIU16        GMAC0_XIU16_REG_ADDR_BASE
#define GMAC_REG_ADDR_BASE_XIU32        GMAC0_XIU32_REG_ADDR_BASE
#define GMAC_REG_ADDR_BASE              GMAC_REG_ADDR_BASE_XIU16
...
#else
    #ifdef GMAC_MEMORY_PROTECT
#define CONFIG2_VAL                     GMAC_POWER_UP|SOFTWARE_RESET|GMAC_RMII|GMAC_RMII_12|WRITE_PROTECT_ENABLE
    #else
#define CONFIG2_VAL                     GMAC_POWER_UP|SOFTWARE_RESET|GMAC_RMII|GMAC_RMII_12
    #endif
#endif
// Delay Interrupt mode:
//#define DELAY_NUMBER                    0x1
//#define DELAY_TIME                      1
...
#else
#define RX_DESC_NUMBER                  0x0100UL
#endif
...
#define TX_LOW_PRI_DESC_NUMBER          0x00F0UL                                //32 descriptor
...
#ifdef NEW_TX_QUEUE
//#define TX_BUFF_ENTRY_NUMBER            0x3CUL
#define TX_BUFF_ENTRY_NUMBER            CONFIG_GMAC_NEW_TX_QUEUE_THRESHOLD_V3
#endif
#ifdef TX_DESC_MODE
...
#define GMAC_RW_TX_DESC_EN_R    ( 0x1UL << 15) // TX_Descriptor Enable Read
#define GMAC_RW_TX_DESC_EN_W    ( 0x1UL << 15) // TX_Descriptor Enable Write
// -------- REG_RO_LOW_PRI_TX_DESC_QUEUED --------
// -------- REG_RO_HIGH_PRI_TX_DESC_QUEUED --------
#define GMAC_RO_TX_DESC_OVERRUN ( 0x1UL << 15) // TX_Descriptor Enable Read
/* ........................................................................ */
...
#define GMAC_TX_DESC_WRAP               (0x1UL << 14) /* bit for wrap */
...
#define REG_RW32_LOW_PRI_TX_DESC_BASE       0x00000156UL
#define REG_RO16_LOW_PRI_TX_DESC_PTR        0x0000015AUL
#define REG_RO16_LOW_PRI_TX_DESC_QUEUED     0x0000015CUL
#define REG_RW16_LOW_PRI_TX_DESC_THRESHOLD  0x0000015EUL
#define REG_RW32_HIGH_PRI_TX_DESC_BASE      0x00000160UL
#define REG_RO16_HIGH_PRI_TX_DESC_PTR       0x00000164UL
#define REG_RO16_HIGH_PRI_TX_DESC_QUEUED    0x00000166UL
#define REG_RW16_HIGH_PRI_TX_DESC_THRESHOLD 0x00000168UL
...
#ifdef NEW_TX_QUEUE
#define GMAC_REG_NEW_TX_QUEUE                0x0000042e
#define GMAC_NEW_TXQ_CNT                     ( 0x7F << 0)
#define GMAC_NEW_TXQ_OV                      ( 0x1 << 7)
#define GMAC_NEW_TXQ_THR_OFFSET              8
#define GMAC_NEW_TXQ_THR                     ( 0x3F << GMAC_NEW_TXQ_THR_OFFSET)
#define GMAC_NEW_TXQ_EN                      ( 0x1 << 15)
#endif /* NEW_TX_QUEUE */
...
u8  MHal_GMAC_Read_LOW_PRI_TX_DESC_TRANSMIT0(void);
u8  MHal_GMAC_Read_LOW_PRI_TX_DESC_TRANSMIT1(void);

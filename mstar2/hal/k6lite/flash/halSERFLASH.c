...
//#define WRITE_WORD_MASK(_reg, _val, _mask)  {*((volatile MS_U16*)(_reg)) = (*((volatile MS_U16*)(_reg))) & ~(_mask)) | ((MS_U16)(_val) & (_mask); }
#else
#define READ_BYTE(_reg)             (*(volatile unsigned char*)(_reg))
#define READ_WORD(_reg)             (*(volatile unsigned short*)(_reg))
#define READ_LONG(_reg)             (*(volatile unsigned long*)(_reg))
#define WRITE_BYTE(_reg, _val)      { (*((volatile unsigned char*)(_reg))) = (unsigned char)(_val); }
#define WRITE_WORD(_reg, _val)      { (*((volatile unsigned short*)(_reg))) = (unsigned short)(_val); }
#define WRITE_LONG(_reg, _val)      { (*((volatile unsigned long*)(_reg))) = (unsigned long)(_val); }
#define WRITE_WORD_MASK(_reg, _val, _mask)  {(*((volatile unsigned short*)(_reg))) = ((*((volatile unsigned short*)(_reg))) & ~(_mask)) | ((unsigned short)(_val) & (_mask)); }
#endif
...
static struct mutex serflashlock;
...
{
    mutex_lock(&serflashlock);
    return TRUE;
}

MS_BOOL MsOS_ReleaseMutex (MS_S32 s32MutexId)
{
    mutex_unlock(&serflashlock);
    return TRUE;
}

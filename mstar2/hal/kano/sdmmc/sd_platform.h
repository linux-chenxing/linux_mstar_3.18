...
#define PMGPIO_REG_27			GET_CARD_REG_ADDR(BANK_PM_SLEEP, 0x28) // MUJI MST215C & 072B card detect
#define PMGPIO_27				GET_CARD_REG_ADDR(BANK_PM_GPIO,0x47)

#define PMGPIO27_EN				BIT15 // 0: output, 1: input
#define PMGPIO27_IN				BIT02

...
static int mstar_pm_enter(suspend_state_t state)
{
    ...
    {
          *(volatile u32 *)(0xfd000000 + 0x101ea0 *2) =0x0000;
          *(volatile u32 *)(0xfd000000 + 0x101eea *2) =0x4000;
          *(volatile u32 *)(0xfd000000 + 0x101896 *2) =0x01;
          *(volatile u32 *)(0xfd000000 + 0x101eee *2) =0x0002;
          *(volatile u32 *)(0xfd000000 + 0x101eec *2) =0x0001;
          *(volatile u32 *)(0xfd000000 + 0x101e00 *2) = 0x8000;
          *(volatile u32 *)(0xfd000000 + 0x101e00 *2) = 0x0000;
    }

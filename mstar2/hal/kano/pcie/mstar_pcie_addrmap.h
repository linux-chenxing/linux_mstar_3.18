...
#define CPDREF_RP_BASE_RO_MODIFY        mstar_pm_base + 0x003A2000    // Root Port Registers. In this mode, certain RO fields in the configuration space can be written
#define REG_ADDRESS_TRANSLATION         mstar_pm_base + 0x003A4000    // Address Translation registers
...
#define CPDREF_RP_BASE_RO_MODIFY        MSTAR_RIU_BASE + 0x003A2000    // Root Port Registers. In this mode, certain RO fields in the configuration space can be written
#define REG_ADDRESS_TRANSLATION         MSTAR_RIU_BASE + 0x003A4000    // Address Translation registers
...
#define MSTAR_PCIE_IOMEM_BASE			0xF0000000
#define MSTAR_PCIE_IOMEM_LEN			0x8000000
...
#define CONFIG_MSTAR_PCIE_OB_MEMIO_ENABLE									//Enable indirect outbound memory io
	...
	#define MSTAR_PCIE_OB_MEMIO_REGS		 	16									//region count for ob memory io
...
#define CPDREF_RP_SRAM_LOCAL                    0x40000000    // 0x1f3a4800; BAR0 RP Inbound Physical MIU Address Translation  //43c00000-5fdfffff : System RAM
...
#define ECO_MIU_SEL_OFF_MASK	~(REG_U03_DYNAMIC_MIU01_SELECTION | REG_U03_DYNAMIC_MIU01_CROSSING_CHECK | REG_U03_FIX_AXI_RLAST)
#define ECO_MIU_SEL_VAL			REG_U03_DYNAMIC_MIU01_SELECTION | REG_U03_DYNAMIC_MIU01_CROSSING_CHECK | REG_U03_FIX_AXI_RLAST
#endif

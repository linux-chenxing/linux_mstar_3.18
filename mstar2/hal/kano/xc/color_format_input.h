...
#define CFD_VERSION "2.7.10"

//#define CFD_SW_VERSION 0x00000025

//CFD_SW_VERSION = 2<<24 + 3<<16 +0<<8 + 0
#define CFD_SW_VERSION 0x02070a00
...
#define CFD_KANO_DLCIP_ST_VERSION 0
...
//#define DePQClampNOffset 520
//#define DePQClampMin 450
...
#if (NowHW == Kano)
MS_BOOL Mhal_Cfd_HDRIP_copy(MS_U8 u8window, STU_CFDAPI_Kano_HDRIP* pstHDRIP);
#endif
...
//void Mapi_Cfd_Kano_DLCIP_Param_Init(STU_CFDAPI_Kano_DLCIP *pstu_Kano_DLCIP_Param);
MS_U16 Mapi_Cfd_Kano_TMOIP_Param_Check(STU_CFDAPI_Kano_TMOIP *pstu_Kano_TMOIP_Param);
INTERFACE void Mapi_Cfd_Kano_TMOIP_Param_Set(MS_U8 u8HWMainSubMode, STU_CFDAPI_Kano_TMOIP *pstu_Kano_TMOIP_Param);
...
INTERFACE void Mapi_Cfd_Kano_DLCIP_CurveMode_Set(MS_U8 u8HWMainSubMode, MS_BOOL bUserMode);
...
INTERFACE void Mapi_Cfd_Kano_SDRIP_Param_Set(MS_U8 u8HWMainSubMode, STU_CFDAPI_Kano_SDRIP *pstu_Kano_SDRIP_Param);
...
INTERFACE void Mapi_Cfd_Kano_HDRIP_Param_Set(MS_U8 u8HWMainSubMode, STU_CFDAPI_Kano_HDRIP *pstu_Kano_HDRIP_Param);

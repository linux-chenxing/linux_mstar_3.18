...
/// @return
//-------------------------------------------------------------------------------------------------
void DoVi_Prepare_B05(MsHdr_3D_RegTable_t_dv* pRegTable, const DoVi_Config_t* pConfig, const DoVi_MdsExt_t* pMdsExt)
{
...
/// @return
//-------------------------------------------------------------------------------------------------
void MsHdr_Update_3D(const MsHdr_3D_RegTable_t_dv* pRegTable)
{
    ST_KDRV_XC_AUTODOWNLOAD_FORMAT_INFO stAutoDownloadFormat;

...
#define XC_DISABLE_KERNEL_FILM_CONTROL   1
...
#define REG_SC_BK2F_70_L                        (0x132F00 | 0x70<< 1)
#define REG_SC_BK2F_71_L                        (0x132F00 | 0x71<< 1)
#define REG_SC_BK2F_75_L                        (0x132F00 | 0x75<< 1)
#define REG_SC_BK2F_79_L                        (0x132F00 | 0x79<< 1)
...
#define REG_SC_BK67_38_H                        (0x136700 | ((0x39<< 1)+1))
#define REG_SC_BK67_39_L                        (0x136700 | 0x39<< 1)
#define REG_SC_BK67_39_L                        (0x136700 | ((0x39<< 1)+1))
...
} ST_KDRV_XC_CFD_OSD_PROCESS_CONFIGS;
...
INTERFACE BOOL MHAL_XC_IsCFDInitFinished(void);
INTERFACE void MHAL_XC_FireADL(void);
INTERFACE BOOL MHal_XC_ReadMute(void);
INTERFACE void MHAL_XC_TMOHandle(MS_BOOL bWindow);
#endif // _MHAL_TEMP_H_

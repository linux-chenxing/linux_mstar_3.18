        ...
        case CPDI_VENDOR_ID: {
            ...
            switch (rdOrWr) {
                ...
                case CPDI_DO_WRITE:
                    ...
                    CPDI_REG_WR ((uint32_t) &(pcieAddr->i_vendor_id_reg), regVal);
                    break;
                default: return EINVAL;
            }
        }
...
uint32_t CPDI_Init (void *pD,
    ...
    if (pInitParam->initBaseAddresses.initparamLmBase. changeDefault) {
        ...
        ((pvt_data_t *) pD)->p_lm_base = (struct pcie_LM_addrmap__regf_lm_pcie_base *)
              (((UINT64_T)((pvt_data_t *) pD)->p_pcie_base) + CPDI_REGS_OFFSET_LOCAL_MANAGEMENT);
    }
    ...
    if (pInitParam->initBaseAddresses.initparamAwBase. changeDefault) {
        ...
        ((pvt_data_t *) pD)->p_aw_base = (struct cdn_axi_wrapper_ob *)
              (((UINT64_T)((pvt_data_t *) pD)->p_pcie_base) + CPDI_REG_OFFSET_AXI_WRAPPER);
    }
...
CPDI_UpdateObWrapperTrafficClass (void   *pD,
    ...
    aw_base = (UINT64_T) ((pvt_data_t *) pD)->p_aw_base;
    aw_base += (regionNo << 5);
    ...
    */
    ...
    switch (size) {
        ...
        case CPDI_4_BYTE:
            ...
            if(offset >= 4*1024)
            {
            	 ret = _mdrv_RC_ob_config_read(NULL, ( 0x2000000 + offset), &rdata);
...
*/
    ...
    switch (size) {
        ...
        case CPDI_4_BYTE:
            ...
            if(offset >= 4*1024)
            {
            	 ret_val = _mdrv_RC_ob_config_write(NULL, ( 0x2000000 + offset), data);
...
uint32_t CPDI_EnableBarAccess (void * pD,
    ...
    if(io) {
         ...
         */
        CPDI_DoConfigWrite (pD, bus, dev, func, 4, CPDI_4_BYTE, 6);
    }
...
uint32_t CPDI_GetRootPortBAR (void    *pD,
    ...
    pcieAddr = (struct pcie_RC_addrmap__regf_rc_pcie_base *)
        (((UINT64_T)((pvt_data_t *) pD)->p_pcie_base) + CPDI_REGS_OFFSET_RP_MANAGEMENT);
    switch (bar) {
    case 0:

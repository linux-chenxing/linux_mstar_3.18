...
void MHal_GMAC_New_TX_QUEUE_Enable(void)
{
    ...
    val = MHal_GMAC_ReadReg32(GMAC_REG_NEW_TX_QUEUE);
    val |= GMAC_NEW_TXQ_EN;
    MHal_GMAC_WritReg32(GMAC_REG_NEW_TX_QUEUE, val);
}
...
void MHal_GMAC_Power_On_Clk( void )
{
    ...
    MHal_GMAC_WritReg8(0x121f, 0x22, 0x08);
    MHal_GMAC_WritReg8(0x121f, 0x23, 0x00);
    MHal_GMAC_WritReg8(0x121f, 0x24, 0x80);
	MHal_GMAC_WritReg8(0x121f, 0x25, 0x20);
	MHal_GMAC_WritReg8(0x121f, 0x26, 0xe6);
	MHal_GMAC_WritReg8(0x121f, 0x27, 0x6e);
	MHal_GMAC_WritReg8(0x121f, 0x20, 0x00);
	MHal_GMAC_WritReg8(0x121f, 0x21, 0x52);

...
//#define LD_SUPPORT_120HZ


//-------------------------------------------------------------------------------------------------
//  Hardware Capability
//-------------------------------------------------------------------------------------------------
#define MHAL_LD_PACKLENGTH    (32)    //manhattan 32, monaco 16, muji 16
#define MHAL_LD_MIU_BUS       (32)

#define REG_LD_ENABLE           (LD_BK | (0x02))
#define REG_LD_ENABLE_BIT       (BIT0)

#define REG_LD_LDFW           (LD_BK | (0x06))
#define REG_LD_LDFW_BITS       (0x7F)

#define REG_LD_LDFH           (LD_BK | (0x07))
#define REG_LD_LDFH_BITS       (0x3F)
...
#define REG_LD_CURFRAMIDX           (LD_BK | (80))
...
#define REG_LD_LDBLW_MSK       (0x3F)
#define REG_LD_LDBLH           (LD_BK | (0xC7))
#define REG_LD_LDBLH_MSK       (0x3F)

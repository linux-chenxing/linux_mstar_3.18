...
#define CONFIG_DVFS_CPU_IRBOOST_CLOCK                   MDrvDvfsQueryCpuClock(CONFIG_DVFS_IR_BOOTS_CPU_CLOCK)
...
typedef struct
{
    ...
    U32     dwFreezeMaximumCpuClock;    //Freeze mode Maximum CPU Clock
    U32     dwNormalMaximumCpuClock;    //Normal mode Maximum CPU Clock

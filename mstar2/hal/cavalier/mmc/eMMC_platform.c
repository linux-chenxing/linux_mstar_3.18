...
U32 eMMC_pads_switch(U32 u32Mode)
{
    ...
    REG_FCIE_CLRBIT(reg_emmcpll_0x1c, BIT9|BIT8);
...
U32 eMMC_PlatformInit(void)
{
    ...
    REG_FCIE_SETBIT(reg_emmcpll_0x47, 0xFFFF);
    REG_FCIE_SETBIT(reg_emmcpll_0x48, BIT1|BIT0);
    REG_FCIE_SETBIT(reg_emmcpll_0x49, 0xDAFF);
    REG_FCIE_SETBIT(reg_emmcpll_0x4a, BIT1|BIT0);

...
//1:IP2 CSC before HDR IP
#define HW_PIPE_MODE 0
//#include "Color_map_driver_lib_Manhattan.h"
#endif
...
#define HW_PIPE_RANGE E_CFD_CFIO_RANGE_LIMIT
#define HE_PIPE_PRECONSTRAINTS
#define HW_peaking_bug 0
//#include "Color_map_driver_lib_Maserati.h"
#endif

#if NowHW == U13_Universe
#define HW_PIPE_MODE 0
//#include "Color_map_driver_lib_U13.h"
#endif
...
MS_U16 MS_Cfd_Kano_InterfaceControl(
    STU_CFD_MS_ALG_COLOR_FORMAT *pstu_input,
...
//0: OFF
//1: ON
INTERFACE MS_U8 MS_Cfd_OnlyEnable_Decision_OFF();
INTERFACE MS_U8 MS_Cfd_OnlyEnable_Decision_ON();

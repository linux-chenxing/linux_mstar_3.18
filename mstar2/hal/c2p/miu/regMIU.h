...
#define REG_MIU_SLIT_AUTO_CLEAR_EN              BIT2
#define REG_MIU_SLIT_DYN_UPDATE_EN              BIT3
#define REG_MIU_SLIT_AUTO_CLEAR_DONE            BIT8
#define REG_MIU_SLIT_DYN_UPDATE_DONE            BIT9

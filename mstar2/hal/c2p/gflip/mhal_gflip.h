...
#define GFLIP_GOP_MIXER_MUX (0x6)

#define GFLIP_GOP_HDR_MUX   OP_MUX_1
#define GFLIP_GOP_HDR_MUX_MASK  GOP_OP_MUX1
#define GFLIP_GOP_HDR_MUX_SHIFT (3)
...
INTERFACE MS_BOOL MHAL_GFLIP_SDRHDR_CTRL(MS_BOOL bHDR_STATUS, MS_BOOL gop_csc_en);
INTERFACE void OSDB_BLENING_ENABLE(MS_U16 u16OP_Mux, MS_BOOL bEnable);

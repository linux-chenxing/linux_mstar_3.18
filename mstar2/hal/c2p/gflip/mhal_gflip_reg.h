...
#define GOP_MIU_CLIENT                          (BIT(0)|BIT(1)|BIT(2)|BIT(3))
...
#define REG_GOP_HANDSHAKE                       0x000b
#define GOP_HANDSHAKE_MASK                      BIT(13)

#define REG_GOP_BAK_FORCE_WRITE_REG             0x0050
#define GOP_BAK_WRITE                           BIT(0)

#define REG_GOP_BANK_SEL_EX                     0x007c
#define GOP1GX0_INT_FLAG                        BMASK(0:0)
#define GOP1GX0_WR_ACK                          BMASK(4:4)
#define GOP_MIXER_WR_ACK                        BIT(5)
#define GOP_OP_MUX_DBF_EN                       (15)

#define REG_GOP_MUX                             0x007e
#define GOP_OP_MUX0                             BMASK(2:0)
#define GOP_OP_MUX0_SHIFT                       (0)
#define GOP_OP_MUX1                             BMASK(5:3)
#define GOP_OP_MUX1_SHIFT                       (3)
#define GOP_OP_MUX2                             BMASK(8:6)
#define GOP_OP_MUX2_SHIFT                       (6)
#define GOP_OP_MUX3                             BMASK(11:9)
#define GOP_OP_MUX3_SHIFT                       (9)
#define GOP_OP_MUX4                             BMASK(14:12)
#define GOP_OP_MUX4_SHIFT                       (12)
#define GOP_OP_MUX_MASK                         (GOP_OP_MUX4|GOP_OP_MUX3|GOP_OP_MUX2|GOP_OP_MUX1|GOP_OP_MUX0)

#define GOP_MIXER_L_REG                   0x0010
#define GOP_HDR_BYPASS                    BIT(1)
#define GOP_MIXER_ALPHA_INV               BIT(2)
#define GOP_MIXER_VDE_SEL                 BIT(12)

#define GOP_MIXER_H_REG                     0x0011
#define GOP_MIXER_VALID_EN_MASK             BMASK(4:0)
...
#define GOP_SC_VOP2BLENDING_BK                  0x2F
#define GOP_SC_VOP2BLENDING_L                   0x37
#define GOP_MUX0_OSDB_MASK                      BIT(3)
#define GOP_MUX1_OSDB_MASK                      BIT(11)

#define GOP_SC_VOP2BLENDING_H                   0x38
#define GOP_MUX2_OSDB_MASK                      BIT(3)
#define GOP_MUX3_OSDB_MASK                      BIT(11)

#define GOP_SC_VOP2BLENDING_EX                  0x39
#define GOP_MUX4_OSDB_MASK                      BIT(3)
...
#define GOP_SC_GOPBLENDING_EX                   GOP_SC_VOP2BLENDING_EX

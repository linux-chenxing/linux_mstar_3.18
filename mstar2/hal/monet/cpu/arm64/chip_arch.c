...
BOOT_MEM_INFO list[3]={ LINUX_MEM2, LINUX_MEM3 };
...
unsigned int query_frequency(void)
{
    ...
    if(dwCpuSpeed == 0)
    {
        ...
        {
            dwCpuSpeed = (3623878000UL / dwCpuSpeed);
        }
    }
    else
    {
...
int Mtd_erase_ctrl_blocks(void)
{
    ...
    count = ctrl_mtd->size >> ctrl_mtd->writesize_shift;

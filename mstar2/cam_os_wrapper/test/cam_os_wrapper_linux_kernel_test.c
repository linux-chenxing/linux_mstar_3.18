...
static int ThreadTestTimeMsleep(void *pUserData)
{
...
#ifdef TEST_TIMER
static void CamOsTimerCallback(unsigned long nDataAddr)
{
...
// Test Function
    ...
    CamOsPrintf("=================================\n");
    CamOsThreadCreate(&tTimeThread0, NULL, (void *)ThreadTestTimeMsleep, NULL);
    CamOsMsSleep(10000);
    ...
    nTimerMs = 2000;
    CamOsTimerAdd(&tTimer, (uint32_t)nTimerMs, (void*)&nTimerMs, CamOsTimerCallback);
    CamOsMsSleep(2100);

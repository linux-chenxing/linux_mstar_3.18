...
int32_t _CamOsIdrAlloc(CamOsIdr_t *ptIdr, void *pDataPtr, int32_t nStart, int32_t nEnd)
{
    CamOsInformalIdr_t *pInformalIdr = (CamOsInformalIdr_t *)ptIdr;
    int32_t nEmptyID=-1;
...
void _CamOsIdrRemove(CamOsIdr_t *ptIdr, int32_t nId)
{
    CamOsInformalIdr_t *pInformalIdr = (CamOsInformalIdr_t *)ptIdr;
...
void *_CamOsIdrFind(CamOsIdr_t *ptIdr, int32_t nId)
{
    CamOsInformalIdr_t *pInformalIdr = (CamOsInformalIdr_t *)ptIdr;

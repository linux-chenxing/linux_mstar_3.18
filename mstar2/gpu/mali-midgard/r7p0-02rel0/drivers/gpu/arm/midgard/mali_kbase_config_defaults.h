 ...
 */
#ifdef MSTAR_PM_DVFS_PERIOD
#define DEFAULT_PM_DVFS_PERIOD (MSTAR_PM_DVFS_PERIOD)
#else
 ...
 */
#ifdef MSTAR_PM_GPU_POWEROFF_TICK_NS
#define DEFAULT_PM_GPU_POWEROFF_TICK_NS (MSTAR_PM_GPU_POWEROFF_TICK_NS)
#else

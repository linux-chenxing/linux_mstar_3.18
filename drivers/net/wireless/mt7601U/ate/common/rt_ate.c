...
//
TX_POWER_TUNING_ENTRY_STRUCT _TxPowerTuningTable;
	...
	{
		{
            ...
            _TxPowerTuningTable = TxPowerTuningTable[pAd->TxPowerCtrl.idxTxPowerTable + TX_POWER_TUNING_ENTRY_OFFSET];
            pTxPowerTuningEntry = &_TxPowerTuningTable;

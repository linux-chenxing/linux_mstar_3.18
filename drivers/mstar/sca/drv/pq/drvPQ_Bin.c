...
static MS_U16 u16SRAM1Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16SRAM2Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16SRAM3Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16SRAM4Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16CSRAM1Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16CSRAM2Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16CSRAM3Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16CSRAM4Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16ICC_CRD_Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
static MS_U16 u16IHC_CRD_Table[PQ_MAX_WINDOW]={0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF};
...
void MDrv_PQBin_DumpFilterTable(MS_PQBin_IP_Table_Info *pTabInfo)
{
    ...
    case PQ_TABTYPE_SRAM1:
        Hal_PQ_set_y_sram_table(pTabInfo->ePQWin, SC_FILTER_Y_SRAM1, (void *)u32Addr);
        break;
    case PQ_TABTYPE_SRAM2:
        Hal_PQ_set_y_sram_table(pTabInfo->ePQWin, SC_FILTER_Y_SRAM2, (void *)u32Addr);
        break;
    case PQ_TABTYPE_SRAM3:
        Hal_PQ_set_y_sram_table(pTabInfo->ePQWin, SC_FILTER_Y_SRAM3, (void *)u32Addr);
        break;

    case PQ_TABTYPE_SRAM4:
        Hal_PQ_set_y_sram_table(pTabInfo->ePQWin, SC_FILTER_Y_SRAM4, (void *)u32Addr);
        break;
    case PQ_TABTYPE_C_SRAM1:
        Hal_PQ_set_c_sram_table(pTabInfo->ePQWin, SC_FILTER_C_SRAM1, (void *)u32Addr);
        break;
    case PQ_TABTYPE_C_SRAM2:
        Hal_PQ_set_c_sram_table(pTabInfo->ePQWin, SC_FILTER_C_SRAM2, (void *)u32Addr);
        break;
    case PQ_TABTYPE_C_SRAM3:
        Hal_PQ_set_c_sram_table(pTabInfo->ePQWin, SC_FILTER_C_SRAM3, (void *)u32Addr);
        break;
    case PQ_TABTYPE_C_SRAM4:
        Hal_PQ_set_c_sram_table(pTabInfo->ePQWin, SC_FILTER_C_SRAM4, (void *)u32Addr);
        break;
...
void MDrv_PQBin_DumpTable(MS_PQBin_IP_Table_Info* pTabInfo)
{
    ...
    case PQ_TABTYPE_VIP_ICC_CRD_SRAM:
        if(u16ICC_CRD_Table[pTabInfo->ePQWin]  != pTabInfo->u16GroupIdx)
        {
            PQ_BIN_DUMP_FILTER_DBG(printf("[PQBin]old ICC_CRD_SRAM: %u, new ICC_CRD_SRAM: %u\n",
                u16ICC_CRD_Table[pTabInfo->ePQWin], pTabInfo->u16GroupIdx));
    ...
    MS_U16 u16TableSize)
{
    ...
    if(stTableInfo.u16TableType == PQ_TABTYPE_PICTURE_1)
    {
        ...
        memcpy((MS_U8 *)pTable, (MS_U8 *)u32Addr, sizeof(MS_U8)*stTableInfo.u16RegNum);
    }
    else if(stTableInfo.u16TableType == PQ_TABTYPE_PICTURE_2)
    {
        ...
        memcpy((MS_U16 *)pTable, (MS_U16 *)u32Addr, sizeof(MS_U16)*stTableInfo.u16RegNum);
    }
    else
    {
        return FALSE;

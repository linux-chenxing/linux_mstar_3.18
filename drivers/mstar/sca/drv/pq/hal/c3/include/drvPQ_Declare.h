...
DECLARE_PQ_FUNCTIONS(SC1_MAIN)    // table config parameter
DECLARE_PQ_FUNCTIONS(SC1_MAINEX)      // table config parameter

DECLARE_PQ_FUNCTIONS(SC2_MAIN)    // table config parameter
DECLARE_PQ_FUNCTIONS(SC2_MAINEX)      // table config parameter

DECLARE_PQ_FUNCTIONS(SC2_SUB)    // table config parameter
DECLARE_PQ_FUNCTIONS(SC2_SUBEX)      // table config parameter


#if defined(AMBER3)
    #include "Amber3_Main.h"              // table config parameter
    #include "Amber3_Main_HSDRule.h"      // table config parameter
    #include "Amber3_Main_VSDRule.h"      // table config parameter
    #include "Amber3_Main_HSPRule.h"      // table config parameter
    #include "Amber3_Main_VSPRule.h"      // table config parameter
    #include "Amber3_Main_CSCRule.h"      // table config parameter
    #include "Amber3_Main_GRule.h"        // table config parameter
    #include "Amber3_Main_Ex.h"           // table config parameter

    #include "Amber3_Sub.h"               // table config parameter
    #include "Amber3_Sub_HSDRule.h"       // table config parameter
    #include "Amber3_Sub_VSDRule.h"       // table config parameter
    #include "Amber3_Sub_HSPRule.h"       // table config parameter
    #include "Amber3_Sub_VSPRule.h"       // table config parameter
    #include "Amber3_Sub_CSCRule.h"       // table config parameter
    #include "Amber3_Sub_GRule.h"         // table config parameter
    #include "Amber3_Sub_Ex.h"            // table config parameter
#else
    // SC0
    #include "Cedric_Main.h"              // table config parameter
    #include "Cedric_Main_HSDRule.h"      // table config parameter
    #include "Cedric_Main_VSDRule.h"      // table config parameter
    #include "Cedric_Main_HSPRule.h"      // table config parameter
    #include "Cedric_Main_VSPRule.h"      // table config parameter
    #include "Cedric_Main_CSCRule.h"      // table config parameter
    #include "Cedric_Main_GRule.h"        // table config parameter
    #include "Cedric_Main_Ex.h"           // table config parameter

    #include "Cedric_Sub.h"               // table config parameter
    #include "Cedric_Sub_HSDRule.h"       // table config parameter
    #include "Cedric_Sub_VSDRule.h"       // table config parameter
    #include "Cedric_Sub_HSPRule.h"       // table config parameter
    #include "Cedric_Sub_VSPRule.h"       // table config parameter
    #include "Cedric_Sub_CSCRule.h"       // table config parameter
    #include "Cedric_Sub_GRule.h"         // table config parameter
    #include "Cedric_Sub_Ex.h"            // table config parameter

    // SC1
    #include "Cedric_SC1_Main.h"              // table config parameter
    #include "Cedric_SC1_Main_HSDRule.h"      // table config parameter
    #include "Cedric_SC1_Main_VSDRule.h"      // table config parameter
    #include "Cedric_SC1_Main_HSPRule.h"      // table config parameter
    #include "Cedric_SC1_Main_VSPRule.h"      // table config parameter
    #include "Cedric_SC1_Main_CSCRule.h"      // table config parameter
    #include "Cedric_SC1_Main_GRule.h"        // table config parameter
    #include "Cedric_SC1_Main_Ex.h"           // table config parameter

    // SC2
    #include "Cedric_SC2_Main.h"              // table config parameter
    #include "Cedric_SC2_Main_HSDRule.h"      // table config parameter
    #include "Cedric_SC2_Main_VSDRule.h"      // table config parameter
    #include "Cedric_SC2_Main_HSPRule.h"      // table config parameter
    #include "Cedric_SC2_Main_VSPRule.h"      // table config parameter
    #include "Cedric_SC2_Main_CSCRule.h"      // table config parameter
    #include "Cedric_SC2_Main_GRule.h"        // table config parameter
    #include "Cedric_SC2_Main_Ex.h"           // table config parameter

    #include "Cedric_SC2_Sub.h"               // table config parameter
    #include "Cedric_SC2_Sub_HSDRule.h"       // table config parameter
    #include "Cedric_SC2_Sub_VSDRule.h"       // table config parameter
    #include "Cedric_SC2_Sub_HSPRule.h"       // table config parameter
    #include "Cedric_SC2_Sub_VSPRule.h"       // table config parameter
    #include "Cedric_SC2_Sub_CSCRule.h"       // table config parameter
    #include "Cedric_SC2_Sub_GRule.h"         // table config parameter
    #include "Cedric_SC2_Sub_Ex.h"            // table config parameter

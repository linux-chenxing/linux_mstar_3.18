...
code U8 MST_GRule_NR_IP_Index_SC2_Sub[PQ_GRULE_NR_IP_NUM_SC2_Sub]=
{
    PQ_IP_DNR_SC2_Sub,
    PQ_IP_DNR_Y_SC2_Sub,
    PQ_IP_DNR_C_SC2_Sub,
...
#if PQ_GRULE_NR_ENABLE
code U8 MST_GRule_NR_SC2_Sub[QM_INPUTTYPE_NUM_SC2_Sub][PQ_GRULE_NR_NUM_SC2_Sub][PQ_GRULE_NR_IP_NUM_SC2_Sub]=
{
    #if PQ_QM_CVBS
    {//RF_NTSC_44, 0
        {//Off

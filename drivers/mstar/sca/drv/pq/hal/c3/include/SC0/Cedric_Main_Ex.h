...
#ifndef _CEDRIC_MAIN_EX_H_
#define _CEDRIC_MAIN_EX_H_

#define PQ_IP_NUM_Main_Ex 15
...
PQ_IP_HISDNR_Main_Ex,  //1
PQ_IP_SPF_DBK_Main_Ex,  //2
PQ_IP_DMS_Main_Ex,  //3
PQ_IP_DMS_H_Main_Ex,  //4
PQ_IP_DMS_V_Main_Ex,  //5
PQ_IP_DMS_NMR_Main_Ex,  //6
PQ_IP_VIP_HNMR_Y_lowY_Main_Ex,  //7
PQ_IP_VIP_VNMR_Y_lowY_Main_Ex,  //8
PQ_IP_VIP_Peaking_adptive_Main_Ex,  //9
PQ_IP_VIP_Peaking_Pcoring_ad_C_Main_Ex,  //10
PQ_IP_VIP_Peaking_gain_by_Cedge_Main_Ex,  //11
PQ_IP_VIP_ICC_Target_Main_Ex,  //12
PQ_IP_VIP_IBC_weight_Main_Ex,  //13
PQ_IP_VIP_ACK_Main_Ex,  //14
 }   PQ_IPTYPE_Main_Ex;

typedef enum
{
PQ_IP_AFEC_no_comm_COM_Main_Ex,  //0
PQ_IP_HISDNR_COM_Main_Ex,  //1
PQ_IP_SPF_DBK_COM_Main_Ex,  //2
PQ_IP_DMS_COM_Main_Ex,  //3
PQ_IP_DMS_H_COM_Main_Ex,  //4
PQ_IP_DMS_V_COM_Main_Ex,  //5
PQ_IP_DMS_NMR_COM_Main_Ex,  //6
PQ_IP_VIP_HNMR_Y_lowY_COM_Main_Ex,  //7
PQ_IP_VIP_VNMR_Y_lowY_COM_Main_Ex,  //8
PQ_IP_VIP_Peaking_adptive_COM_Main_Ex,  //9
PQ_IP_VIP_Peaking_Pcoring_ad_C_COM_Main_Ex,  //10
PQ_IP_VIP_Peaking_gain_by_Cedge_COM_Main_Ex,  //11
PQ_IP_VIP_ICC_Target_COM_Main_Ex,  //12
PQ_IP_VIP_IBC_weight_COM_Main_Ex,  //13
PQ_IP_VIP_ACK_COM_Main_Ex,  //14
...
typedef enum
{
PQ_IP_HISDNR_OFF_Main_Ex,
PQ_IP_HISDNR_ON_Main_Ex,
PQ_IP_HISDNR_NUMS_Main_Ex
} PQ_IP_HISDNR_Group_Main_Ex;
...
extern code U8 QMAP_1920_PIP_Main_Ex[QM_INPUTTYPE_NUM_Main_Ex][PQ_IP_NUM_Main_Ex];
extern code U8 QMAP_1920_POP_Main_Ex[QM_INPUTTYPE_NUM_Main_Ex][PQ_IP_NUM_Main_Ex];
extern code U8 QMAP_1366_Main_Ex[QM_INPUTTYPE_NUM_Main_Ex][PQ_IP_NUM_Main_Ex];
extern code U8 QMAP_1366_PIP_Main_Ex[QM_INPUTTYPE_NUM_Main_Ex][PQ_IP_NUM_Main_Ex];
extern code U8 QMAP_1366_POP_Main_Ex[QM_INPUTTYPE_NUM_Main_Ex][PQ_IP_NUM_Main_Ex];

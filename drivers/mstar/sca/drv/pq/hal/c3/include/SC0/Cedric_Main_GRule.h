...
typedef enum
{
    ...
    PQ_GRule_OSD_BW_2DDR_On_1920_Main,
    PQ_GRule_OSD_BW_2DDR_On_1920_PIP_Main,
    PQ_GRule_OSD_BW_2DDR_On_1920_POP_Main,
    PQ_GRule_OSD_BW_2DDR_On_1366_Main,
    PQ_GRule_OSD_BW_2DDR_On_1366_PIP_Main,
    PQ_GRule_OSD_BW_2DDR_On_1366_POP_Main,
    PQ_GRule_OSD_BW_1DDR_On_1920_Main,
    PQ_GRule_OSD_BW_1DDR_On_1920_PIP_Main,
    PQ_GRule_OSD_BW_1DDR_On_1920_POP_Main,
    PQ_GRule_OSD_BW_1DDR_On_1366_Main,
    PQ_GRule_OSD_BW_1DDR_On_1366_PIP_Main,
    PQ_GRule_OSD_BW_1DDR_On_1366_POP_Main,
}
...
typedef enum
{
    PQ_GRule_DDR_SELECT_2DDR_1920_Main,
    PQ_GRule_DDR_SELECT_2DDR_1920_PIP_Main,
    PQ_GRule_DDR_SELECT_2DDR_1920_POP_Main,
    PQ_GRule_DDR_SELECT_2DDR_1366_Main,
    PQ_GRule_DDR_SELECT_2DDR_1366_PIP_Main,
    PQ_GRule_DDR_SELECT_2DDR_1366_POP_Main,
    PQ_GRule_DDR_SELECT_1DDR_1920_Main,
    PQ_GRule_DDR_SELECT_1DDR_1920_PIP_Main,
    PQ_GRule_DDR_SELECT_1DDR_1920_POP_Main,
    PQ_GRule_DDR_SELECT_1DDR_1366_Main,
    PQ_GRule_DDR_SELECT_1DDR_1366_PIP_Main,
    PQ_GRule_DDR_SELECT_1DDR_1366_POP_Main,
}
...
typedef enum
{
    ...
    PQ_GRule_Lvl_OSD_BW_2DDR_On_Main,
    PQ_GRule_Lvl_OSD_BW_1DDR_On_Main,
}
...
typedef enum
{
    PQ_GRule_Lvl_DDR_SELECT_2DDR_Main,
    PQ_GRule_Lvl_DDR_SELECT_1DDR_Main,
}
...
#if PQ_GRULE_OSD_BW_ENABLE
#define PQ_GRULE_OSD_BW_IP_NUM_Main 2
#define PQ_GRULE_OSD_BW_NUM_Main 18
#define PQ_GRULE_OSD_BW_LVL_NUM_Main 3
#endif

#if PQ_GRULE_MPEG_NR_ENABLE
#define PQ_GRULE_MPEG_NR_IP_NUM_Main 2
...
#if PQ_GRULE_DDR_SELECT_ENABLE
#define PQ_GRULE_DDR_SELECT_IP_NUM_Main 1
#define PQ_GRULE_DDR_SELECT_NUM_Main 12
#define PQ_GRULE_DDR_SELECT_LVL_NUM_Main 2
#endif
...
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_1920_PIP_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_DDR_SELECT_ENABLE
extern code U8 MST_GRule_1920_PIP_DDR_SELECT_Main[PQ_GRULE_DDR_SELECT_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_1920_POP_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_DDR_SELECT_ENABLE
extern code U8 MST_GRule_1920_POP_DDR_SELECT_Main[PQ_GRULE_DDR_SELECT_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_1366_PIP_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_DDR_SELECT_ENABLE
extern code U8 MST_GRule_1366_PIP_DDR_SELECT_Main[PQ_GRULE_DDR_SELECT_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
...
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern code U8 MST_GRule_1366_POP_DYNAMIC_CONTRAST_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_Main];
#endif
#if PQ_GRULE_DDR_SELECT_ENABLE
extern code U8 MST_GRule_1366_POP_DDR_SELECT_Main[PQ_GRULE_DDR_SELECT_LVL_NUM_Main];
#endif
#if PQ_GRULE_PTP_ENABLE

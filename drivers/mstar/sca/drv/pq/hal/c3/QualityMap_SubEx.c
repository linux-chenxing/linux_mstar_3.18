...
#if PQ_ENABLE_PIP
    #include "Cedric_Sub_Ex.c"                // table config parameter
    #include "Cedric_Sub_Ex_1366.c"           // table config parameter
    #include "Cedric_Sub_Ex_1366_PIP.c"       // table config parameter
    #include "Cedric_Sub_Ex_1366_POP.c"       // table config parameter
#endif
#endif

...
#define MAX_IP_NUM  (MAX(PQ_IP_NUM_Main, MAX(PQ_IP_NUM_SC1_Main, PQ_IP_NUM_SC2_Main)))
...
static void _MDrv_PQ_DumpFilterTable(EN_IP_Info* pIP_Info)
{
    ...
    case PQ_TABTYPE_SRAM1:
        Hal_PQ_set_y_sram_table(_PQTableInfo.eWin, SC_FILTER_Y_SRAM1, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_Y_SRAM1)]));
        break;
    case PQ_TABTYPE_SRAM2:
        Hal_PQ_set_y_sram_table(_PQTableInfo.eWin, SC_FILTER_Y_SRAM2, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_Y_SRAM2)]));
        break;

    case PQ_TABTYPE_SRAM3:
        Hal_PQ_set_y_sram_table(_PQTableInfo.eWin, SC_FILTER_Y_SRAM3, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_Y_SRAM3)]));
        break;
    case PQ_TABTYPE_SRAM4:
        Hal_PQ_set_y_sram_table(_PQTableInfo.eWin, SC_FILTER_Y_SRAM4, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_Y_SRAM4)]));
        break;

    case PQ_TABTYPE_C_SRAM1:
        Hal_PQ_set_c_sram_table(_PQTableInfo.eWin, SC_FILTER_C_SRAM1, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_C_SRAM1)]));
        break;

    case PQ_TABTYPE_C_SRAM2:
        Hal_PQ_set_c_sram_table(_PQTableInfo.eWin, SC_FILTER_C_SRAM2, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_C_SRAM2)]));
        break;

    case PQ_TABTYPE_C_SRAM3:
        Hal_PQ_set_c_sram_table(_PQTableInfo.eWin, SC_FILTER_C_SRAM3, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_C_SRAM3)]));
        break;

    case PQ_TABTYPE_C_SRAM4:
        Hal_PQ_set_c_sram_table(_PQTableInfo.eWin, SC_FILTER_C_SRAM4, (void *)((MS_U32)&pIP_Info->pIPTable[pIP_Info->u8TabIdx * Hal_PQ_get_sram_size(SC_FILTER_C_SRAM4)]));
        break;
...
static MS_BOOL _MDrv_PQ_LoadPictureSetting(MS_U8 u8TabIdx, MS_U8 u8PQIPIdx, void *pTable, MS_U16 u16TableSize)
{
    ...
    if(ip_Info.u8TabType == PQ_TABTYPE_PICTURE_1)
    {
        ...
        memcpy((MS_U8 *)pTable, &pu8PQTbl[u32Addr], sizeof(MS_U8)*u16TableSize);
    }
    else if(ip_Info.u8TabType == PQ_TABTYPE_PICTURE_2)
    {
        MS_U16 *pu16PQTbl =  (MS_U16 *)ip_Info.pIPTable;
        memcpy((MS_U16 *)pTable, &pu16PQTbl[u32Addr], sizeof(MS_U16)*u16TableSize);

...
#define MSIF_VE_LIBVER              {'0','0'}            //LIB version
#define MSIF_VE_BUILDNUM            {'9','0'}            //Build Number
#define MSIF_VE_CHANGELIST          {'0','0','4','8','6','1','9','4'} //P4 ChangeList Number
//#define MSIF_OS                     '0'                  //OS
...
typedef enum
{
    ...
    MS_VE_OUT_CAPTURE,///< output signal from TVEncoder
}MS_VE_OUT_TYPE;

...
typedef enum
{
    ...
    INPUT_PORT_BT656_0 = 210,
    INPUT_PORT_BT656_1 = 211,

    INPUT_PORT_SC0_VOP = 220,
    INPUT_PORT_SC1_VOP = 221,
    INPUT_PORT_SC2_VOP = 222,
} E_MUX_INPUTPORT;
...
typedef enum
{
    ...
    OUTPUT_PORT_SCALER1_MAIN_WINDOW,
    OUTPUT_PORT_SCALER2_MAIN_WINDOW,

    // Reserved area

    OUTPUT_PORT_SCALER_SUB_WINDOW1 = 10,
    OUTPUT_PORT_SCALER2_SUB_WINDOW,

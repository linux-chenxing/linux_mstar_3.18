...
#define REG_MSPI_CTRL                  0x49
    #define MSPI_ENABLE_BIT            BIT0
	#define MSPI_RESET_BIT             BIT1
	#define MSPI_INT_EN_BIT            BIT2
...
//bank chiptop
#define REG_MSPI0_MODE                 0x09
    #define MSPI_MSPI0_MODE_SHIFT      8
	#define MSPI_MSPI0_MODE_MASK       3 << 8

#define REG_MSPI1_MODE                 0x04

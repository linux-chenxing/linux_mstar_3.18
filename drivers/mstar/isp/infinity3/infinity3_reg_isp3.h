...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __INFINITY3_REG_ISP3__
#define __INFINITY3_REG_ISP3__
typedef struct {
	// h0000, bit: 0
	...
	unsigned int reg_ae_statis_base_0:16;
	...
	unsigned int reg_awb_statis_base_0:16;
	...
	unsigned int reg_histo_statis_base_0:16;
	...
	unsigned int reg_ae_max_wadr_0:16;
	...
	unsigned int reg_awb_max_wadr_0:16;
	...
	unsigned int reg_histo_max_wadr_0:16;
	...
	unsigned int reg_coef_buf_wd_0:16;
	...
	// h0028, bit: 14
	/* ALSC interpolation coefficients*/
	unsigned int reg_coef_buf_rd_0:16;
	...
	unsigned int reg_dnr_lum_table_0:16;
	...
	// h0034, bit: 14
	/* DNR table*/
	unsigned int reg_dnr_tabley_0:16;
	...
	unsigned int reg_dnr_fb_base_0_0:16;
	...
	unsigned int reg_dnr_fb_base_1_0:16;
	...
	unsigned int reg_mot_fb_base_0:16;
	...
	unsigned int reg_dnr_wdma_uaddr_0:16;
...
}  __attribute__((packed, aligned(1))) bank_3;
#endif

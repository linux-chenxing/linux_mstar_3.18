...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef __INFINITY3_REG_ISP0__
#define __INFINITY3_REG_ISP0__
typedef struct {
	// h0000, bit: 0
	/* Enable ISP Engine
	...
	// h000d, bit: 14
	/* */
	unsigned int reg_isp_bist_fail_read_0:16;
	...
	unsigned int reg_isp_sw_used_0:16;
	...
	// h001e, bit: 14
	/* isp debug out*/
	unsigned int reg_isp_debug_0:16;
...
}  __attribute__((packed, aligned(1))) bank_0;
#endif

...
typedef struct MHal_VIF_DevCfg_s
{
    ...
    MS_U32                    au32CompMask[2];
    MHal_VIF_ClkEdge_e        eClkEdge;
    MS_S32                    as32AdChnId[4];
...
{
    MS_U64 u64PhyAddr[2]; /**< physical buffer address*/
    MS_U32 u32Stride[2];

    MS_U16 nCropX;      /**< crop start x*/
    MS_U16 nCropY;      /**< crop start y*/
    MS_U16 nCropW;      /**< crop start width*/
    MS_U16 nCropH;      /**< crop start height*/
    MS_U32 nPTS;        /**< timestamp in 90KHz*/
...
#define VIF_BUF_INVALID 3 /**< Do not use */
    MS_U32 nStatus;      /**< Vif buffer status*/
    MS_U32 nMiPriv;      /**< MI use , Hhal should not modify*/

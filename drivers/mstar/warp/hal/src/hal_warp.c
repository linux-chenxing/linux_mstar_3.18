 ...
 */
 void warp_hal_set_image_point(warp_hal_handle* handle, HAL_WARP_CONFIG* config)
 {
    ...
    handle->reg_bank.dlua_yrgb = (s32)input_data->data[HAL_WARP_IMAGE_PLANE_Y];
    handle->reg_bank.dlua_uvg = (s32)input_data->data[HAL_WARP_IMAGE_PLANE_UV];
    handle->reg_bank.dsua_yrgb = (s32)output_data->data[HAL_WARP_IMAGE_PLANE_Y];
    handle->reg_bank.dsua_uvg = (s32)output_data->data[HAL_WARP_IMAGE_PLANE_UV];
 ...
 */
 ...
 {
    handle->reg_bank.ocs.fields.ocsx = (u16)config->output_tiles_width;
    handle->reg_bank.ocs.fields.ocsy = (u16)config->output_tiles_height;
 ...
 */
 void warp_hal_set_disp(warp_hal_handle* handle, HAL_WARP_CONFIG* config)
 {
    ...
    handle->reg_bank.distba = (s32)disp_table->overlay;
 ...
 */
 ...
 {
    HAL_WARP_BOUND_BOX_TABLE_T* bb_table = &config->bb_table; //< Bounding box table descriptor

    handle->reg_bank.bba = (s32)bb_table->table;

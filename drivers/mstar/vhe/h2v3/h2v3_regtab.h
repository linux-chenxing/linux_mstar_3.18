...
H2REG(HWIF_ENC_STRM_SWAP                                    ,  2,15:12,0,RW,\
...
H2REG(HWIF_ENC_PIC_SWAP                                     ,  2,11: 8,0,RW,\
...
/*
H2REG(HWIF_ENC_ROI_MAP_QP_DELTA_MAP_SWAP                    ,  2, 7: 4,0,RW,\
    "Byte swap configuration for qp delta of ROI map                       "\
    ),
*/
...
/*
H2REG(HWIF_ENC_CTB_RC_MEM_OUT_SWAP                          ,  2, 3: 0,0,RW,\
    "Byte swap configuration for ctb rate control memory out               "\
    ),
*/
...
H2REG(HWIF_ENC_OUTPUT_STRM_MODE                             ,  4,18:18,1,RW,\
...
H2REG(HWIF_ENC_NUM_SHORT_TERM_REF_PIC_SETS                  ,  6,24:22,0,RW,\
...
H2REG(HWIF_ENC_RPS_ID                                       ,  6, 4: 2,0,RW,\
...
H2REG(HWIF_ENC_ROI1_DELTA_QP                                ,  7, 7: 4,0,RW,\
    "ROI1 delta qp                                                         "\
    ),
H2REG(HWIF_ENC_ROI2_DELTA_QP                                ,  7, 3: 0,0,RW,\
    "ROI2 delta qp                                                         "\
    ),
H2REG(HWIF_ENC_OUTPUT_STRM_BASE                             ,  8,31: 0,0,RW,\
    "output stream base address                                            "\
    ),
H2REG(HWIF_ENC_OUTPUT_STRM_BUFFER_LIMIT                     ,  9,31: 0,1,RW,\
...
H2REG(HWIF_ENC_SIZE_TBL_BASE                                , 10,31: 0,0,RW,\
    "sizeTblBase                                                           "\
    ),
H2REG(HWIF_ENC_POC                                          , 11,31: 0,0,RW,\
    "encoded Picture order count                                           "\
    ),
H2REG(HWIF_ENC_INPUT_Y_BASE                                 , 12,31: 0,0,RW,\
    "input image lum base address                                          "\
    ),
H2REG(HWIF_ENC_INPUT_CB_BASE                                , 13,31: 0,0,RW,\
    "input image cb base address                                           "\
    ),
H2REG(HWIF_ENC_INPUT_CR_BASE                                , 14,31: 0,0,RW,\
    "input image cr base address                                           "\
    ),
H2REG(HWIF_ENC_RECON_Y_BASE                                 , 15,31: 0,0,RW,\
    "recon image lum base address                                          "\
    ),
H2REG(HWIF_ENC_RECON_CHROMA_BASE                            , 16,31: 0,0,RW,\
    "recon image chroma base address                                       "\
    ),
H2REG(HWIF_ENC_DELTA_POC0                                   , 17,31:22,0,RW,\
    "delta of poc0.  For H2V1 only.                                        "\
    ),
...
H2REG(HWIF_ENC_DELTA_POC1                                   , 17,19:10,0,RW,\
    "delta of poc1. For H2V1 only.                                         "\
    ),
...
H2REG(HWIF_ENC_INTRA_AREA_LEFT                              , 23,31:24,0,RW,\
    "intra Area Left                                                       "\
    ),
H2REG(HWIF_ENC_INTRA_AREA_RIGHT                             , 23,23:16,0,RW,\
    "intra Area Right                                                      "\
    ),
H2REG(HWIF_ENC_INTRA_AREA_TOP                               , 23,15: 8,0,RW,\
    "intra Area Top                                                        "\
    ),
H2REG(HWIF_ENC_INTRA_AREA_BOTTOM                            , 23, 7: 0,0,RW,\
    "intra Area Bottom                                                     "\
    ),
H2REG(HWIF_ENC_ROI1_LEFT                                    , 24,31:24,0,RW,\
    "ROI1 Area Left                                                        "\
    ),
H2REG(HWIF_ENC_ROI1_RIGHT                                   , 24,23:16,0,RW,\
    "ROI1 Area Right                                                       "\
    ),
H2REG(HWIF_ENC_ROI1_TOP                                     , 24,15: 8,0,RW,\
    "ROI1 Area Top                                                         "\
    ),
H2REG(HWIF_ENC_ROI1_BOTTOM                                  , 24, 7: 0,0,RW,\
    "ROI1 Area Bottom                                                      "\
    ),
H2REG(HWIF_ENC_ROI2_LEFT                                    , 25,31:24,0,RW,\
    "ROI2 Area Left                                                        "\
    ),
H2REG(HWIF_ENC_ROI2_RIGHT                                   , 25,23:16,0,RW,\
    "ROI2 Area Right                                                       "\
    ),
H2REG(HWIF_ENC_ROI2_TOP                                     , 25,15: 8,0,RW,\
    "ROI2 Area Top                                                         "\
    ),
H2REG(HWIF_ENC_ROI2_BOTTOM                                  , 25, 7: 0,0,RW,\
    "ROI2 Area Bottom                                                      "\
    ),
...
H2REG(HWIF_ENC_LAMDA_SATD_ME_0                              , 28,31:24,0,RW,\
    "lambda satd me 0                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_1                              , 28,23:16,0,RW,\
    "lambda satd me 1                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_2                              , 28,15: 8,0,RW,\
    "lambda satd me 2                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_3                              , 28, 7: 0,0,RW,\
    "lambda satd me 3                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_4                              , 29,31:24,0,RW,\
    "lambda satd me 4                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_5                              , 29,23:16,0,RW,\
    "lambda satd me 5                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_6                              , 29,15: 8,0,RW,\
    "lambda satd me 6                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_7                              , 29, 7: 0,0,RW,\
    "lambda satd me 7                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_8                              , 30,31:24,0,RW,\
    "lambda satd me 8                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_9                              , 30,23:16,0,RW,\
    "lambda satd me 9                                                      "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_10                             , 30,15: 8,0,RW,\
    "lambda satd me 10                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_11                             , 30, 7: 0,0,RW,\
    "lambda satd me 11                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_12                             , 31,31:24,0,RW,\
    "lambda satd me 12                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_13                             , 31,23:16,0,RW,\
    "lambda satd me 13                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_14                             , 31,15: 8,0,RW,\
    "lambda satd me 14                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_15                             , 31, 7: 0,0,RW,\
    "lambda satd me 15                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_0                               , 32,31:17,0,RW,\
    "inter me SSE lambda 0                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_1                               , 32,16: 2,0,RW,\
    "inter me SSE lambda 1                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_2                               , 33,31:17,0,RW,\
    "inter me SSE lambda 2                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_3                               , 33,16: 2,0,RW,\
    "inter me SSE lambda 3                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_4                               , 34,31:17,0,RW,\
    "inter me SSE lambda 4                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_5                               , 34,16: 2,0,RW,\
    "inter me SSE lambda 5                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_MOTION_SSE                             , 35,31:18,0,RW,\
...
H2REG(HWIF_ENC_OUTPUT_BITWIDTH_CHROMA                       , 36, 1: 0,0,RW,\
    "chroma output bitwidth 0=8 bit. 1=9 bit. 2=10 bit.                    "\
    ),
H2REG(HWIF_ENC_LAMDA_SAO_CHROMA                             , 37,31:18,0,RW,\
    "lambda for SAO chroma                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SAO_LUMA                               , 37,17: 4,0,RW,\
    "lambda for SAO luma                                                   "\
    ),
H2REG(HWIF_ENC_CHROFFSET                                    , 37, 3: 0,0,RW,\
...
H2REG(HWIF_ENC_OUTPUT_BITWIDTH_LUM                          , 38,25:24,0,RW,\
    "luma output bitwidth 0=8 bit. 1=9 bit. 2=10 bit.                      "\
    ),
H2REG(HWIF_ENC_LUMOFFSET                                    , 38,23:20,0,RW,\
...
H2REG(HWIF_ENC_BASESCALEDOUTLUM                             , 42,31: 0,0,RW,\
    "Base address for output of down-scaled encoder image in YUYV 4:2:2 for"\
    "mat                                                                   "\
    ),
H2REG(HWIF_ENC_SCALEDOUTWIDTH                               , 43,31:19,1,RW,\
    "Scaling width of down-scaled image. ScaledWidth. [96..4076]           "\
    ),
H2REG(HWIF_ENC_SCALEDOUTWIDTHRATIO                          , 43,18: 3,0,RW,\
...
H2REG(HWIF_ENC_SCALEDOUTHEIGHT                              , 44,31:18,1,RW,\
    "Scaling width of down-scaled image. ScaledHeight. [2..4078]           "\
    ),
H2REG(HWIF_ENC_SCALEDOUTHEIGHTRATIO                         , 44,17: 2,0,RW,\
    "Scaling ratio for height of down-scaled image. Fixed point integer 1.1"\
    "6.                                                                    "\
    ),
H2REG(HWIF_ENC_SCALEDOUT_SWAP                               , 45,31:28,0,RW,\
...
H2REG(HWIF_ENC_SCALEDSKIPLEFTPIXELCOLUMN                    , 45,13:12,0,RW,\
    "skip left pixel column                                                "\
    ),
H2REG(HWIF_ENC_SCALEDSKIPTOPPIXELROW                        , 45,11:10,0,RW,\
    "skip top pixel row                                                    "\
    ),
H2REG(HWIF_ENC_VSCALE_WEIGHT_EN                             , 45, 9: 9,0,RW,\
    "vertical scale weight enable.                                         "\
    ),
H2REG(HWIF_ENC_SCALEDHORIZONTALCOPY                         , 45, 8: 8,0,RW,\
    "horizontal data copy directly                                         "\
    ),
H2REG(HWIF_ENC_SCALEDVERTICALCOPY                           , 45, 7: 7,0,RW,\
    "vertical data copy directly                                           "\
    ),
H2REG(HWIF_ENC_NALUNITSIZE_SWAP                             , 45, 6: 3,0,RW,\
    "Byte swap configuration for Nal Unit size output                      "\
    ),
H2REG(HWIF_ENC_COMPRESSEDCOEFF_BASE                         , 46,31: 0,0,RW,\
    "Base address for compressed coefficients.                             "\
    ),
H2REG(HWIF_ENC_COMPRESSEDCOEFF_BASE_MSB                     , 47,31: 0,0,RW,\
    "Base address MSB for compressed coefficients.                         "\
    ),
H2REG(HWIF_ENC_BASESCALEDOUTLUM_MSB                         , 48,31: 0,0,RW,\
    "Base address MSB for output of down-scaled encoder image in YUYV 4:2:2"\
    " format                                                               "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_Y0_MSB                       , 49,31: 0,0,RW,\
    "reference picture reconstructed list0 luma0 MSB                       "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_CHROMA0_MSB                  , 50,31: 0,0,RW,\
    "reference picture reconstructed list0 chroma0 MSB                     "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_Y1_MSB                       , 51,31: 0,0,RW,\
    "reference picture reconstructed list0 luma1 MSB                       "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_CHROMA1_MSB                  , 52,31: 0,0,RW,\
    "reference picture reconstructed list0 chroma1 MSB                     "\
    ),
H2REG(HWIF_ENC_INPUT_Y_BASE_MSB                             , 53,31: 0,0,RW,\
    "input image lum base address MSB                                      "\
    ),
H2REG(HWIF_ENC_INPUT_CB_BASE_MSB                            , 54,31: 0,0,RW,\
    "input image cb base address MSB                                       "\
    ),
H2REG(HWIF_ENC_INPUT_CR_BASE_MSB                            , 55,31: 0,0,RW,\
    "input image cr base address MSB                                       "\
    ),
H2REG(HWIF_ENC_RECON_Y_BASE_MSB                             , 56,31: 0,0,RW,\
    "recon image lum base address MSB                                      "\
    ),
H2REG(HWIF_ENC_RECON_CHROMA_BASE_MSB                        , 57,31: 0,0,RW,\
    "recon image chroma base address MSB                                   "\
    ),
H2REG(HWIF_ENC_SIZE_TBL_BASE_MSB                            , 58,31: 0,0,RW,\
    "sizeTblBase MSB                                                       "\
    ),
H2REG(HWIF_ENC_OUTPUT_STRM_BASE_MSB                         , 59,31: 0,0,RW,\
    "output stream base address MSB                                        "\
    ),
H2REG(HWIF_ENC_RECON_LUMA_COMPRESS_TABLE_BASE               , 60,31: 0,0,RW,\
    "Base address for recon luma compress table LSB.                       "\
    ),
H2REG(HWIF_ENC_RECON_LUMA_COMPRESS_TABLE_BASE_MSB           , 61,31: 0,0,RW,\
    "Base address for recon luma compress table MSB.                       "\
    ),
H2REG(HWIF_ENC_RECON_CHROMA_COMPRESS_TABLE_BASE             , 62,31: 0,0,RW,\
    "Base address for recon Chroma compress table LSB.                     "\
    ),
H2REG(HWIF_ENC_RECON_CHROMA_COMPRESS_TABLE_BASE_MSB         , 63,31: 0,0,RW,\
    "Base address for recon Chroma compress table MSB.                     "\
    ),
H2REG(HWIF_ENC_L0_REF0_LUMA_COMPRESS_TABLE_BASE             , 64,31: 0,0,RW,\
    "Base address for list 0 ref 0 luma compress table LSB.                "\
    ),
H2REG(HWIF_ENC_L0_REF0_LUMA_COMPRESS_TABLE_BASE_MSB         , 65,31: 0,0,RW,\
    "Base address for list 0 ref 0 luma compress table MSB.                "\
    ),
H2REG(HWIF_ENC_L0_REF0_CHROMA_COMPRESS_TABLE_BASE           , 66,31: 0,0,RW,\
    "Base address for list 0 ref 0 Chroma compress table LSB.              "\
    ),
H2REG(HWIF_ENC_L0_REF0_CHROMA_COMPRESS_TABLE_BASE_MSB       , 67,31: 0,0,RW,\
    "Base address for list 0 ref 0 Chroma compress table MSB.              "\
    ),
H2REG(HWIF_ENC_L0_REF1_LUMA_COMPRESS_TABLE_BASE             , 68,31: 0,0,RW,\
    "Base address for list 0 ref 1 luma compress table LSB.                "\
    ),
H2REG(HWIF_ENC_L0_REF1_LUMA_COMPRESS_TABLE_BASE_MSB         , 69,31: 0,0,RW,\
    "Base address for list 0 ref 1 luma compress table MSB.                "\
    ),
H2REG(HWIF_ENC_L0_REF1_CHROMA_COMPRESS_TABLE_BASE           , 70,31: 0,0,RW,\
    "Base address for list 0 ref 1 Chroma compress table LSB.              "\
    ),
H2REG(HWIF_ENC_L0_REF1_CHROMA_COMPRESS_TABLE_BASE_MSB       , 71,31: 0,0,RW,\
    "Base address for list 0 ref 1 Chroma compress table MSB.              "\
    ),
H2REG(HWIF_ENC_RECON_LUMA_4N_BASE                           , 72,31: 0,0,RW,\
    "Base address for recon luma 4n base LSB.                              "\
    ),
H2REG(HWIF_ENC_RECON_LUMA_4N_BASE_MSB                       , 73,31: 0,0,RW,\
    "Base address for recon luma 4n base MSB.                              "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_4N0_BASE                     , 74,31: 0,0,RW,\
    "reference picture reconstructed list0 4n 0                            "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_4N0_BASE_MSB                 , 75,31: 0,0,RW,\
    "reference picture reconstructed list0 4n 0 MSB                        "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_4N1_BASE                     , 76,31: 0,0,RW,\
    "reference picture reconstructed list0 4n 1                            "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L0_4N1_BASE_MSB                 , 77,31: 0,0,RW,\
    "reference picture reconstructed list0 4n 1 MSB                        "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_6                               , 78,31:17,0,RW,\
    "inter me SSE lambda 6                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_7                               , 78,16: 2,0,RW,\
    "inter me SSE lambda 7                                                 "\
    ),
H2REG(HWIF_ENC_LAMBDA_MOTIONSAD_ROI1                        , 79,31:25,0,RW,\
    "roi1 lamda for motion SAD                                             "\
    ),
H2REG(HWIF_ENC_LAMBDA_MOTIONSAD_ROI2                        , 79,24:18,0,RW,\
    "roi2 lamda for motion SAD                                             "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_8                               , 79,31:17,0,RW,\
    "inter me SSE lambda 8                                                 "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_9                               , 79,16: 2,0,RW,\
...
H2REG(HWIF_ENC_REFPIC_RECON_L1_Y0                           , 83,31: 0,0,RW,\
    "reference picture reconstructed list1 luma0                           "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_CHROMA0                      , 84,31: 0,0,RW,\
    "reference picture reconstructed list1 chroma0                         "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_Y1                           , 85,31: 0,0,RW,\
    "reference picture reconstructed list1 luma1                           "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_CHROMA1                      , 86,31: 0,0,RW,\
    "reference picture reconstructed list1 chroma1                         "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_Y0_MSB                       , 87,31: 0,0,RW,\
    "reference picture reconstructed list1 luma0 MSB                       "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_CHROMA0_MSB                  , 88,31: 0,0,RW,\
    "reference picture reconstructed list1 chroma0 MSB                     "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_Y1_MSB                       , 89,31: 0,0,RW,\
    "reference picture reconstructed list1 luma1 MSB                       "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_CHROMA1_MSB                  , 90,31: 0,0,RW,\
...
H2REG(HWIF_ENC_L1_REF0_LUMA_COMPRESSOR_ENABLE               , 91, 3: 3,1,RW,\
    "list1 ref0 frame luma compressor enable flag 0=disable 1=enable.      "\
    ),
H2REG(HWIF_ENC_L1_REF0_CHROMA_COMPRESSOR_ENABLE             , 91, 2: 2,1,RW,\
    "list1 ref0 frame chroma compressor enable flag 0=disable 1=enable.    "\
    ),
H2REG(HWIF_ENC_L1_REF1_LUMA_COMPRESSOR_ENABLE               , 91, 1: 1,0,RW,\
    "list1 ref1 frame luma compressor enable flag 0=disable 1=enable.      "\
    ),
H2REG(HWIF_ENC_L1_REF1_CHROMA_COMPRESSOR_ENABLE             , 91, 0: 0,0,RW,\
    "list1 ref1 frame chroma compressor enable flag 0=disable 1=enable.    "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_4N0_BASE                     , 92,31: 0,0,RW,\
    "reference picture reconstructed list1 4n 0                            "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_4N0_BASE_MSB                 , 93,31: 0,0,RW,\
    "reference picture reconstructed list1 4n 0 MSB                        "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_4N1_BASE                     , 94,31: 0,0,RW,\
    "reference picture reconstructed list1 4n 1                            "\
    ),
H2REG(HWIF_ENC_REFPIC_RECON_L1_4N1_BASE_MSB                 , 95,31: 0,0,RW,\
    "reference picture reconstructed list1 4n 1 MSB                        "\
    ),
H2REG(HWIF_ENC_L1_REF0_LUMA_COMPRESS_TABLE_BASE             , 96,31: 0,0,RW,\
    "Base address for list 1 ref 0 luma compress table LSB.                "\
    ),
H2REG(HWIF_ENC_L1_REF0_LUMA_COMPRESS_TABLE_BASE_MSB         , 97,31: 0,0,RW,\
    "Base address for list 1 ref 0 luma compress table MSB.                "\
    ),
H2REG(HWIF_ENC_L1_REF0_CHROMA_COMPRESS_TABLE_BASE           , 98,31: 0,0,RW,\
    "Base address for list 1 ref 0 Chroma compress table LSB.              "\
    ),
H2REG(HWIF_ENC_L1_REF0_CHROMA_COMPRESS_TABLE_BASE_MSB       , 99,31: 0,0,RW,\
    "Base address for list 1 ref 0 Chroma compress table MSB.              "\
    ),
H2REG(HWIF_ENC_L1_REF1_LUMA_COMPRESS_TABLE_BASE             ,100,31: 0,0,RW,\
    "Base address for list 1 ref 1 luma compress table LSB.                "\
    ),
H2REG(HWIF_ENC_L1_REF1_LUMA_COMPRESS_TABLE_BASE_MSB         ,101,31: 0,0,RW,\
    "Base address for list 1 ref 1 luma compress table MSB.                "\
    ),
H2REG(HWIF_ENC_L1_REF1_CHROMA_COMPRESS_TABLE_BASE           ,102,31: 0,0,RW,\
    "Base address for list 1 ref 1 Chroma compress table LSB.              "\
    ),
H2REG(HWIF_ENC_L1_REF1_CHROMA_COMPRESS_TABLE_BASE_MSB       ,103,31: 0,0,RW,\
...
H2REG(HWIF_ENC_ROIMAPDELTAQPADDR                            ,109,31: 0,0,RW,\
    "Qp delta map                                                          "\
    ),
H2REG(HWIF_ENC_ROIMAPDELTAQPADDR_MSB                        ,110,31: 0,0,RW,\
    "Qp delta map MSB                                                      "\
    ),
...
H2REG(HWIF_ENC_CTBRCBITMEMADDR_CURRENT                      ,114,31: 0,0,RW,\
    "ctb rate control bit memory address of current frame                  "\
    ),
H2REG(HWIF_ENC_CTBRCBITMEMADDR_CURRENT_MSB                  ,115,31: 0,0,RW,\
    "ctb rate control bit memory address of current frame msb              "\
    ),
H2REG(HWIF_ENC_CTBRCBITMEMADDR_PREVIOUS                     ,116,31: 0,0,RW,\
    "ctb rate control bit memory address of previous frame                 "\
    ),
H2REG(HWIF_ENC_CTBRCBITMEMADDR_PREVIOUS_MSB                 ,117,31: 0,0,RW,\
...
H2REG(HWIF_ENC_LAMDA_SSE_ME_10                              ,122,31:17,0,RW,\
    "inter me SSE lambda 10                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_11                              ,122,16: 2,0,RW,\
    "inter me SSE lambda 11                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_12                              ,123,31:17,0,RW,\
    "inter me SSE lambda 12                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_13                              ,123,16: 2,0,RW,\
    "inter me SSE lambda 13                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_14                              ,124,31:17,0,RW,\
    "inter me SSE lambda 14                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_15                              ,124,16: 2,0,RW,\
    "inter me SSE lambda 15                                                "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_0                           ,125,31:18,0,RW,\
    "intra SATD lambda 0                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_1                           ,125,17: 4,0,RW,\
    "intra SATD lambda 1                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_2                           ,126,31:18,0,RW,\
    "intra SATD lambda 2                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_3                           ,126,17: 4,0,RW,\
    "intra SATD lambda 3                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_4                           ,127,31:18,0,RW,\
    "intra SATD lambda 4                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_5                           ,127,17: 4,0,RW,\
    "intra SATD lambda 5                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_6                           ,128,31:18,0,RW,\
    "intra SATD lambda 6                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_7                           ,128,17: 4,0,RW,\
    "intra SATD lambda 7                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_8                           ,129,31:18,0,RW,\
    "intra SATD lambda 8                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_9                           ,129,17: 4,0,RW,\
    "intra SATD lambda 9                                                   "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_10                          ,130,31:18,0,RW,\
    "intra SATD lambda 10                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_11                          ,130,17: 4,0,RW,\
    "intra SATD lambda 11                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_12                          ,131,31:18,0,RW,\
    "intra SATD lambda 12                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_13                          ,131,17: 4,0,RW,\
    "intra SATD lambda 13                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_14                          ,132,31:18,0,RW,\
    "intra SATD lambda 14                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_15                          ,132,17: 4,0,RW,\
...
H2REG(HWIF_ENC_LAMDA_SATD_ME_16                             ,138,31:24,0,RW,\
    "lambda satd me 16                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_17                             ,138,23:16,0,RW,\
    "lambda satd me 17                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_18                             ,138,15: 8,0,RW,\
    "lambda satd me 18                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_19                             ,138, 7: 0,0,RW,\
    "lambda satd me 19                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_20                             ,139,31:24,0,RW,\
    "lambda satd me 20                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_21                             ,139,23:16,0,RW,\
    "lambda satd me 21                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_22                             ,139,15: 8,0,RW,\
    "lambda satd me 22                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_23                             ,139, 7: 0,0,RW,\
    "lambda satd me 23                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_24                             ,140,31:24,0,RW,\
    "lambda satd me 24                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_25                             ,140,23:16,0,RW,\
    "lambda satd me 25                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_26                             ,140,15: 8,0,RW,\
    "lambda satd me 26                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_27                             ,140, 7: 0,0,RW,\
    "lambda satd me 27                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_28                             ,141,31:24,0,RW,\
    "lambda satd me 28                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_29                             ,141,23:16,0,RW,\
    "lambda satd me 29                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_30                             ,141,15: 8,0,RW,\
    "lambda satd me 30                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SATD_ME_31                             ,141, 7: 0,0,RW,\
    "lambda satd me 31                                                     "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_16                              ,142,31:17,0,RW,\
    "inter me SSE lambda 16                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_17                              ,142,16: 2,0,RW,\
    "inter me SSE lambda 17                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_18                              ,143,31:17,0,RW,\
    "inter me SSE lambda 18                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_19                              ,143,16: 2,0,RW,\
    "inter me SSE lambda 19                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_20                              ,144,31:17,0,RW,\
    "inter me SSE lambda 20                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_21                              ,144,16: 2,0,RW,\
    "inter me SSE lambda 21                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_22                              ,145,31:17,0,RW,\
    "inter me SSE lambda 22                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_23                              ,145,16: 2,0,RW,\
    "inter me SSE lambda 23                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_24                              ,146,31:17,0,RW,\
    "inter me SSE lambda 24                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_25                              ,146,16: 2,0,RW,\
    "inter me SSE lambda 25                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_26                              ,147,31:17,0,RW,\
    "inter me SSE lambda 26                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_27                              ,147,16: 2,0,RW,\
    "inter me SSE lambda 27                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_28                              ,148,31:17,0,RW,\
    "inter me SSE lambda 28                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_29                              ,148,16: 2,0,RW,\
    "inter me SSE lambda 29                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_30                              ,149,31:17,0,RW,\
    "inter me SSE lambda 30                                                "\
    ),
H2REG(HWIF_ENC_LAMDA_SSE_ME_31                              ,149,16: 2,0,RW,\
    "inter me SSE lambda 31                                                "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_16                          ,150,31:18,0,RW,\
    "intra SATD lambda 16                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_17                          ,150,17: 4,0,RW,\
    "intra SATD lambda 17                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_18                          ,151,31:18,0,RW,\
    "intra SATD lambda 18                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_19                          ,151,17: 4,0,RW,\
    "intra SATD lambda 19                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_20                          ,152,31:18,0,RW,\
    "intra SATD lambda 20                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_21                          ,152,17: 4,0,RW,\
    "intra SATD lambda 21                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_22                          ,153,31:18,0,RW,\
    "intra SATD lambda 22                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_23                          ,153,17: 4,0,RW,\
    "intra SATD lambda 23                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_24                          ,154,31:18,0,RW,\
    "intra SATD lambda 24                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_25                          ,154,17: 4,0,RW,\
    "intra SATD lambda 25                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_26                          ,155,31:18,0,RW,\
    "intra SATD lambda 26                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_27                          ,155,17: 4,0,RW,\
    "intra SATD lambda 27                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_28                          ,156,31:18,0,RW,\
    "intra SATD lambda 28                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_29                          ,156,17: 4,0,RW,\
    "intra SATD lambda 29                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_30                          ,157,31:18,0,RW,\
    "intra SATD lambda 30                                                  "\
    ),
H2REG(HWIF_ENC_INTRA_SATD_LAMDA_31                          ,157,17: 4,0,RW,\
    "intra SATD lambda 31                                                  "\
    ),
H2REG(HWIF_ENC_QP_FRACTIONAL                                ,158,31:16,0,RW,\
    "qp fractional part                                                    "\
    ),
...
H2REG(HWIF_ENC_RC_QPDELTA_RANGE                             ,162,21:18,0,RW,\
    "rc qp delta range                                                     "\
    ),
...
H2REG(HWIF_ENC_ROI1_DELTA_QP_RC                             ,163,31:27,0,RW,\
    "ROI1 delta qp with rc                                                 "\
    ),
H2REG(HWIF_ENC_ROI2_DELTA_QP_RC                             ,163,26:22,0,RW,\

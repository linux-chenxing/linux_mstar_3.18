...
#define SATA_GHC_1_PHY      0x113900



#define SATA_GHC_0_ADDRESS_START (0xFD000000 + (0x102B00 << 1))
#define SATA_GHC_0_ADDRESS_END   (0xFD000000 + (0x102BFE << 1))
#define SATA_GHC_0_P0_ADDRESS_START (0xFD000000 + (0x102C00 << 1))
#define SATA_GHC_0_P0_ADDRESS_END   (0xFD000000 + (0x102CFE << 1))
#define SATA_MISC_0_ADDRESS_START  (0xFD000000 + (0x102D00 << 1))
#define SATA_MISC_0_ADDRESS_END    (0xFD000000 + (0x102DFE << 1))


#define SATA_GHC_1_ADDRESS_START (0xFD000000 + (0x113100 << 1))
#define SATA_GHC_1_ADDRESS_END   (0xFD000000 + (0x1131FE << 1))
#define SATA_GHC_1_P0_ADDRESS_START (0xFD000000 + (0x113200 << 1))
#define SATA_GHC_1_P0_ADDRESS_END   (0xFD000000 + (0x1132FE << 1))
#define SATA_MISC_1_ADDRESS_START  (0xFD000000 + (0x113300 << 1))
#define SATA_MISC_1_ADDRESS_END    (0xFD000000 + (0x1133FE << 1))

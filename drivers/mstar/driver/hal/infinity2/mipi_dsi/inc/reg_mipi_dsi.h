...
#define DSI_REG_BASE        0x1A1A00//0x1A2100
#define DSI_REG_BASE_2      0x343400//0x344200
#define DSI_CMDQ_BASE       0x1A1B00//0x1A2200
#define DSI_CMDQ_BASE_2     0x343600//0x344400
#define REG_CHIPTOP_BASE    0x101E00
#define REG_PADTOP1_BASE    0x102600//0x101E00
#define REG_CKG_BASE        0x100B00//0x103800
#define DSI_DPHY_REG_BASE   0x150800//0x161200
#define REG_LPLL_BASE 	    0x103100//0x103300
...
//------------------------------------------------------------------------------
// Chiptop(Padtop1) Setting
//------------------------------------------------------------------------------
#define REG_PADTOP1_7     BK_REG(0x7)
#define PADTOP1_TX_MODE     (REG_PADTOP1_BASE+REG_PADTOP1_7)
    #define MIPITX_4LANE_MODE       BITS(5:4,2)
    #define MIPITX_2LANE_MODE       BITS(5:4,1)
    #define MIPITX_PAD_MASK         BITMASK(5:4)

#define REG_PADTOP1_A     BK_REG(0xA)
#define PADTOP1_LCDPAD_MUX     (REG_PADTOP1_BASE+REG_PADTOP1_A)
    #define RGB16_BITMODE       BIT(0)
    #define RGB24_BITMODE       BIT(1)
    #define RGB_PAD_MASK        BITMASK(1:0)

#define REG_PADTOP1_46     BK_REG(0x46)    //LCD IE(reg_ttl_d_lsh18_en)
#define REG_PADTOP1_47     BK_REG(0x47)    //LCD IE(reg_ttl_d_lsh18_en)
#define REG_PADTOP1_48     BK_REG(0x48)    //LCD PE(reg_ttl_d_pe)
#define REG_PADTOP1_49     BK_REG(0x49)    //LCD PE(reg_ttl_d_pe)
#define REG_PADTOP1_4A     BK_REG(0x4A)    //LCD PS(reg_ttl_d_ps)
#define REG_PADTOP1_4B     BK_REG(0x4B)    //LCD PS(reg_ttl_d_ps)
...
#define CLKG_MCU_CLK_CTRL0     (REG_CKG_BASE+BK_REG(0x10))
// wrong register offset, but not use now
...
#define DPHY_DSI_REG0A     (DSI_DPHY_REG_BASE+BK_REG(0x0A))

#define DPHY_DSI_REG0E     (DSI_DPHY_REG_BASE+BK_REG(0x0E))

#define DPHY_DSI_REG11     (DSI_DPHY_REG_BASE+BK_REG(0x11))

#define DPHY_DSI_REG14     (DSI_DPHY_REG_BASE+BK_REG(0x14))

#define DPHY_DSI_REG17     (DSI_DPHY_REG_BASE+BK_REG(0x17))

#define DPHY_DSI_REG18     (DSI_DPHY_REG_BASE+BK_REG(0x18))

#define DPHY_DSI_REG22     (DSI_DPHY_REG_BASE+BK_REG(0x22))

#define DPHY_DSI_REG28     (DSI_DPHY_REG_BASE+BK_REG(0x28))

#define DPHY_DSI_REG29     (DSI_DPHY_REG_BASE+BK_REG(0x29))

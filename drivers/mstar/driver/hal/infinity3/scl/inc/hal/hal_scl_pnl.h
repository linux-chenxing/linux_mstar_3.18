...
////////////////////////////////////////////////////////////////////////////////
//==============================================================================
#ifndef __HAL_SCL_PNL_H__
#define __HAL_SCL_PNL_H__
...
//  Prototype
//-------------------------------------------------------------------------------------------------
#ifndef __HAL_SCL_PNL_C__
#define INTERFACE extern
#else
#define INTERFACE
#endif

INTERFACE void   HalPnlSetRiuBase(u32 u32Riubase);
INTERFACE void   HalPnlSetChiptop(bool bEn);
INTERFACE void   HalPnlSetInitY2R(void);
...
INTERFACE void   HalPnlSetFrameColrEn(bool bEn);
INTERFACE void   HalPnlSetFrameColor(u32 u32Color);
INTERFACE void   HalPnlDumpLpllSetting(u16 u16Idx);
INTERFACE void   HalPnlSetLpllSet(u32 u32LpllSet);
INTERFACE u16    HalPnlGetLpllIdx(u64 u64Dclk);
INTERFACE u16    HalPnlGetLpllGain(u16 u16Idx);
INTERFACE u16    HalPnlGetLpllDiv(u16 u16Idx);
INTERFACE void   HalPnlSetCSCY2REn(bool bEn);
INTERFACE void   HalPnlSetCSCY2ROffset(u8 u8Y, u8 u8Cb, u8 u8Cr);
INTERFACE void   HalPnlSetCSCY2RCoef(u16 *pu16Coef);

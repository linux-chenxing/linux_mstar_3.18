...
//-------------------------------------------------------------------------------------------------
void MHal_GMAC_write_phy_EPHY( unsigned char phy_addr, unsigned char address, u32 value )
{
...
// Note: MDI interface is assumed to already have been enabled.
//-------------------------------------------------------------------------------------------------
void MHal_GMAC_read_phy_EPHY( unsigned char phy_addr, unsigned char address, u32* value )
{
    phys_addr_t uRegBase = INTERNEL_PHY_REG_BASE;
    u32 tempvalue ;
...
u32 MHal_GMAC_Hardware_check( u32 padmux_type )
{
    if(padmux_type == GMAC1_EPHY)
    {
        ...
        MHal_GMAC_This_Ops.read_phy = MHal_GMAC_read_phy_EPHY;
        MHal_GMAC_This_Ops.write_phy = MHal_GMAC_write_phy_EPHY;
        MHal_GMAC_This_Ops.GMAC_Reg_Addr_Base = GMAC1_REG_ADDR_BASE;
        TO_DO;MHal_GMAC_This_Ops.GMAC_IRQ = MAC_GMAC1_IRQ;
        MHal_GMAC_This_Ops.GPHY_ADDR = GMAC1_EPHY_PHY_ADDR;
        return GMAC_EPHY;
    }
    else if(padmux_type == GMAC1_GPHY)
    {
        ...
        MHal_GMAC_This_Ops.GMAC_Reg_Addr_Base = GMAC1_REG_ADDR_BASE;
        TO_DO;MHal_GMAC_This_Ops.GMAC_IRQ = MAC_GMAC1_IRQ;
        MHal_GMAC_This_Ops.GPHY_ADDR = GMAC1_GPHY_PHY_ADDR;
        return GMAC_GPHY;
    }
    else
    {
        ...
        TO_DO;MHal_GMAC_This_Ops.GMAC_IRQ = MAC_GMAC0_IRQ;
        MHal_GMAC_This_Ops.GPHY_ADDR = GMAC0_GPHY_PHY_ADDR;
        return GMAC_GPHY;
    }
}

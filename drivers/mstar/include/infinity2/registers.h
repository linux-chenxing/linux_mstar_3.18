...
#define CEVA_PHYS                0xC0000000
#define CEVA_VIRT                0xF9000000
#define CEVA_OFFSET              (CEVA_VIRT-CEVA_PHYS)
#define CEVA_SIZE                0x500000
...
#define IPC_MEM_PHYS			0x58000000
#define IPC_MEM_VIRT         	0xFE000000 //(IPC_MEM_PHYS+IPC_MEM_OFFSET)
#define IPC_MEM_OFFSET       	(MS_IO_OFFSET)
#define IPC_MEM_SIZE         	0x100000
#endif
...
#define BASE_REG_INTRCTL_PA1      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101000) //intr_ctrl_cpu2~3
#define BASE_REG_INTRCTL_PA0      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101900) //intr_ctrl_cpu2~3
#define BASE_REG_MCU_ARM          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x101D00)
...
#define BASE_REG_IRQ_PM          GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x002b00)
...
#define BASE_REG_UPLL0_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100800) //upll0
#define BASE_REG_UPLL1_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100840) //upll1
#define BASE_REG_UTMI0_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103A00)
...
#define BASE_REG_MAILBOX_PA      GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103300)
#define BASE_REG_BDMA1_PA        GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100900)
#define BASE_REG_CLKGEN0_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100B00)
#define BASE_REG_CLKGEN1_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x103300)
#define BASE_REG_CLKGEN2_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x100A00)
#define BASE_REG_PADTOP1_PA       GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x102600)
#define BASE_REG_IIC0_PA               GET_BASE_ADDR_BY_BANK(BASE_REG_RIU_PA, 0x113400)
...
typedef enum
{
    MS_I2_PACKAGE_UNKNOWN =0x00,
    MS_I2_PACKAGE_BGA_1GB,
    MS_I2_PACKAGE_FPGA_128MB =0x90,
} MS_I2_PACKAGE_TYPE;

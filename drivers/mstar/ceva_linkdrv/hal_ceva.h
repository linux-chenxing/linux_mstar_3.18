...
typedef enum
{
    CEVA_HAL_RESET_XM6_CORE         = 0x01,
    CEVA_HAL_RESET_XM6_SYS          = 0x02,
    CEVA_HAL_RESET_XM6_OCEM         = 0x04,
    CEVA_HAL_RESET_XM6_GLOBAL       = 0x08,
    CEVA_HAL_RESET_XM6_MIU          = 0x10,
    CEVA_HAL_RESET_XM6_MCU          = 0x20,
    CEVA_HAL_RESET_XM6_MCU2CEVA     = 0x40,
    CEVA_HAL_RESET_XM6_ISP2CEVA     = 0x80,
    CEVA_HAL_RESET_XM6_PERIPHERAL   = 0xFE,
    CEVA_HAL_RESET_XM6_ALL          = 0xFF
} CEVA_HAL_RESET_XM6;
...
void ceva_hal_write_dummy_data(ceva_hal_handle *handle, u32 data);
u32 ceva_hal_read_dummy_data(ceva_hal_handle *handle);

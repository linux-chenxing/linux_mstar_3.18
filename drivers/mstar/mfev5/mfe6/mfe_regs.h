...
typedef struct mfe_regs {
  ...
  #define MFE_REG_REF_NUM_TWO       1
    ...
    union {
        ...
        ushort reg87_g_intra4_penality:8;
        };
        ushort reg87;
    };
    union {
        struct {
        ushort reg88_g_intra16_penality:8;
        ushort reg88_g_inter_penality:8;
        };
        ushort reg88;
    };
    union {
        struct {
        ushort reg89_g_planar_penality_luma:8;
        ushort reg89_g_planar_penality_cbcr:8;
        };
        ushort reg89;
    };
    union {

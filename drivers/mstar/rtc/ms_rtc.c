...
#define REG_RTC_FREQ_CW_L   0x04    //01h << 2
#define REG_RTC_FREQ_CW_H   0x08    //02h << 2

#define REG_RTC_LOAD_VAL_L  0x0C    //03h << 2
#define REG_RTC_LOAD_VAL_H  0x10    //04h << 2

#define REG_RTC_MATCH_VAL_L 0x14    //05h << 2
#define REG_RTC_MATCH_VAL_H 0x18    //06h << 2

#define REG_RTC_INT_STATE   0x1C    //07h << 2

#define REG_RTC_CNT_VAL_L   0x20    //08h << 2
#define REG_RTC_CNT_VAL_H   0x24    //09h << 2

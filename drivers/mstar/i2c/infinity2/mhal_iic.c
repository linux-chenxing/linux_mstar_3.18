...
BOOL HAL_HWI2C_SelectPort(HAL_HWI2C_PORT ePort)
{
    ...
    else if(ePort==E_HAL_HWI2C_PORT2_0)
    {
        ...
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT2_1)
    {
        u8Value1 = CHIP_MIIC2_PAD_1;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT2_2)
    {
        u8Value1 = CHIP_MIIC2_PAD_2;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT2_3)
    {
        u8Value1 = CHIP_MIIC2_PAD_3;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC2, u8Value1, CHIP_MIIC2_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT3_0)
    {
        u8Value1 = CHIP_MIIC3_PAD_0;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC3, u8Value1, CHIP_MIIC3_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT3_1)
    {
        u8Value1 = CHIP_MIIC3_PAD_1;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC3, u8Value1, CHIP_MIIC3_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT3_2)
    {
        u8Value1 = CHIP_MIIC3_PAD_2;
        HAL_HWI2C_WriteChipByteMask(CHIP_REG_HWI2C_MIIC3, u8Value1, CHIP_MIIC3_PAD_MSK);
    }
    else if(ePort==E_HAL_HWI2C_PORT3_3)
    {

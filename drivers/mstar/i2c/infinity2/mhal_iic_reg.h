...
#define REG_ALL_PAD_IN			(0x102600)   //set all pads (except SPI) as input
...
//for port 0
#define CHIP_REG_HWI2C_MIIC0            (CHIP_REG_BASE+ (0x06*2))
...
//for port 1
#define CHIP_REG_HWI2C_MIIC1            (CHIP_REG_BASE+ (0x06*2))
	...
	#define CHIP_MIIC1_PAD_4            (__BIT4)
    #define CHIP_MIIC1_PAD_MSK          (__BIT2|__BIT3|__BIT4)

//for port 2
#define CHIP_REG_HWI2C_MIIC2            (CHIP_REG_BASE+ (0x06*2))
    #define CHIP_MIIC2_PAD_0            (0)
    #define CHIP_MIIC2_PAD_1            (__BIT5)
    #define CHIP_MIIC2_PAD_2            (__BIT6)
    #define CHIP_MIIC2_PAD_3            (__BIT5|__BIT6)
	#define CHIP_MIIC2_PAD_4            (__BIT7)
    #define CHIP_MIIC2_PAD_MSK          (__BIT5|__BIT6|__BIT7)

//for port 3
#define CHIP_REG_HWI2C_MIIC3            (CHIP_REG_BASE+ (0x06*2))
    #define CHIP_MIIC3_PAD_0            (0)
    #define CHIP_MIIC3_PAD_1            (__BIT8)
    #define CHIP_MIIC3_PAD_2            (__BIT9)
    #define CHIP_MIIC3_PAD_3            (__BIT8|__BIT9)
	#define CHIP_MIIC3_PAD_4            (__BIT10)
    #define CHIP_MIIC3_PAD_MSK          (__BIT8|__BIT9|__BIT10)

//for port 4
#define CHIP_REG_HWI2C_MIIC4            (CHIP_REG_BASE+ (0x06*2))
    #define CHIP_MIIC4_PAD_0            (0)
    #define CHIP_MIIC4_PAD_1            (__BIT11)
    #define CHIP_MIIC4_PAD_2            (__BIT12)
    #define CHIP_MIIC4_PAD_3            (__BIT11|__BIT12)
    #define CHIP_MIIC4_PAD_MSK          (__BIT11|__BIT12)

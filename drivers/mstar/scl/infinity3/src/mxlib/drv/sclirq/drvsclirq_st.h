...
#define SCLIRQ_MSK_SC2_FRM2_W_ACTIVE     (((MS_U64)1)<<36)
#define SCLIRQ_MSK_SC2_FRM2_W_ACTIVE_N   (((MS_U64)1)<<37)
...
typedef enum
{
    ...
    E_SCLIRQ_EVENT_SC2POLL    = (E_SCLIRQ_EVENT_SC2FRM|E_SCLIRQ_EVENT_SC2RESTART|E_SCLIRQ_EVENT_RESUME | E_SCLIRQ_EVENT_FRM2RESTART),

    ...
    (ST_VIP_DLC_HISTOGRAM_CONFIG stDLCCfg,MS_U16 u16valueForReg1Eh04)
{
    ...
    Drv_CMDQ_WriteCmd(EN_CMDQ_TYPE_IP0,stCfg,0);
    Drv_CMDQ_FillCmd(&stCfg,REG_VIP_MWE_1C_L,(stDLCCfg.u8trig_ref_mode<<2),0x0004);
    Drv_CMDQ_WriteCmd(EN_CMDQ_TYPE_IP0,stCfg,0);
    ...
    Drv_CMDQ_WriteCmd(EN_CMDQ_TYPE_IP0,stCfg,0);
    Drv_CMDQ_FillCmd(&stCfg,REG_VIP_MWE_1B_L,(MS_U16)stDLCCfg.u32StatBase[1]>>20,0x07FF);
    Drv_CMDQ_WriteCmd(EN_CMDQ_TYPE_IP0,stCfg,0);
    Drv_CMDQ_FillCmd(&stCfg,REG_VIP_DLC_08_L,stDLCCfg.bRange<<7,0x0080);
    Drv_CMDQ_WriteCmd(EN_CMDQ_TYPE_IP0,stCfg,0);
...
MS_BOOL Drv_VIP_Init(ST_VIP_INIT_CONFIG *pCfg)
{
    ...
    {
        gpvSRAMBuffer[idx] = MsOS_VirMemalloc(_Drv_VIP_GetSRAMBufferSize(idx));
    }
...
void * Drv_VIP_SetAIPSRAMConfig(void * pvPQSetParameter, EN_VIP_DRV_AIP_SRAM_TYPE enAIPType)
{
    ...
    else
    {
        ...
        //    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
        //}
        bRet = Hal_VIP_SRAM_Dump(enType,(MS_U32)pvPQSetParameter);
    ...
    switch(u32Type)
    {
        case E_SCLIRQ_EVENT_GAMMA_Y:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                ...
                (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GAMMA_Y],REG_VIP_SCNR_41_L))
                {
                    break;
                }
                else
        ...
        case E_SCLIRQ_EVENT_GAMMA_U:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                ...
                (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GAMMA_U],REG_VIP_SCNR_41_L))
                {
                    break;
                }
                else
        ...
        case E_SCLIRQ_EVENT_GAMMA_V:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                ...
                (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GAMMA_V],REG_VIP_SCNR_41_L))
                {
                    break;
                }
                else
        ...
        case E_SCLIRQ_EVENT_GM10to12_R:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                if(Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_GM10to12_R,
                    (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM10to12_R],REG_SCL_HVSP1_7A_L))
                {
                    break;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    ...
                    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
                    Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM10to12_R,
                        (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM10to12_R],REG_SCL_HVSP1_7A_L);
                    break;
                }
            }
        ...
        case E_SCLIRQ_EVENT_GM10to12_G:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                if(Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_GM10to12_G,
                    (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM10to12_G],REG_SCL_HVSP1_7A_L))
                {
                    break;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    ...
                    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
                    Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM10to12_G,
                        (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM10to12_G],REG_SCL_HVSP1_7A_L);
                    break;
                }
            }
        ...
        case E_SCLIRQ_EVENT_GM10to12_B:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                if(Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_GM10to12_B,
                    (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM10to12_B],REG_SCL_HVSP1_7A_L))
                {
                    break;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    ...
                    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
                    Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM10to12_B,
                        (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM10to12_B],REG_SCL_HVSP1_7A_L);
                    break;
                }
            }
        ...
        case E_SCLIRQ_EVENT_GM12to10_R:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                if(Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_GM12to10_R,
                    (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_R],REG_SCL_HVSP1_7D_L))
                {
                    break;
                }
                else
            ...
            else
            {
                if(Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM12to10_R,
                    (u32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_R],REG_SCL_HVSP1_7D_L))
                {
                    break;
                }
                else
                {
                    ...
                    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
                    Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM12to10_R,
                        (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_R],REG_SCL_HVSP1_7D_L);
                    break;
                }
            }
        ...
        case E_SCLIRQ_EVENT_GM12to10_G:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                if(Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_GM12to10_G,
                    (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_G],REG_SCL_HVSP1_7D_L))
                {
                    break;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    ...
                    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
                    Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM12to10_G,
                        (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_G],REG_SCL_HVSP1_7D_L);
                    break;
                }
            }
        ...
        case E_SCLIRQ_EVENT_GM12to10_B:
                ...
                ||(VIPSETRULE() == E_VIPSetRule_CMDQAllONLYSRAMCheck))
            {
                if(Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_GM12to10_B,
                    (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_B],REG_SCL_HVSP1_7D_L))
                {
                    break;
                }
                else
            ...
            else
            {
                ...
                else
                {
                    ...
                    MsOS_WaitEvent(Drv_SCLIRQ_Get_IRQ_SYNCEventID(), E_SCLIRQ_EVENT_FRMENDSYNC, &u32Events, E_OR, 200); // get status: FRM END
                    Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_GM12to10_B,
                        (MS_U32)gpvSRAMBuffer[EN_VIP_DRV_AIP_SRAM_GM12to10_B],REG_SCL_HVSP1_7D_L);
                    break;
                }
            }

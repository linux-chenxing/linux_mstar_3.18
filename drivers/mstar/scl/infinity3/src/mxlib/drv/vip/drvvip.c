...
{
    Drv_CMDQ_AssignFrameWriteCmd
        (REG_SCL_LDC_09_L,((MS_U16)stLDCCfg.enLDCType == EN_DRV_HVSP_LDCLCBANKMODE_64)? BIT0 :0,BIT0,
        stLDCCfg.stFCfg.u8framecnt);
    Drv_CMDQ_AssignFrameWriteCmd
        (REG_SCL_LDC_10_L, stLDCCfg.u8FBidx,BIT1|BIT0,stLDCCfg.stFCfg.u8framecnt);
    Drv_CMDQ_AssignFrameWriteCmd
        (REG_SCL_LDC_11_L, stLDCCfg.u8FBrwdiff,BIT1|BIT0,stLDCCfg.stFCfg.u8framecnt);
    Drv_CMDQ_AssignFrameWriteCmd
        (REG_SCL_LDC_12_L, stLDCCfg.bEnSWMode,BIT0,stLDCCfg.stFCfg.u8framecnt);
    Drv_CMDQ_AssignFrameWriteCmd

...
MS_BOOL Drv_HVSP_SetPatTgen(MS_BOOL bEn, ST_DRV_HVSP_PAT_TGEN_CONFIG *pCfg)
{
    ...
    if(bEn)
    {
        ...
        if(pCfg)
        {
            ...
            {
                Hal_HVSP_SetPatTgVtt(3000); //scaling up need bigger Vtt, , using vtt of 1920x1080 for all timing
            }
            else
            {
                Hal_HVSP_SetPatTgVtt(3000); //rotate
            }
            ...
            Hal_HVSP_SetPatTgHtt(3000); // scaling up need bigger Vtt, , using vtt of 1920x1080 for all timing

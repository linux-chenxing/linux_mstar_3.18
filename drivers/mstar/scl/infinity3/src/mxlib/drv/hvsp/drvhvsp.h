...
INTERFACE ST_HVSP_SCALING_CONFIG Drv_HVSP_SetScaling(EN_HVSP_ID_TYPE enHVSP_ID, ST_HVSP_SCALING_CONFIG stCfg, ST_HVSP_CLK_CONFIG* stclk);
INTERFACE MS_BOOL Drv_HVSP_SetInputMux(EN_HVSP_IP_MUX_TYPE enIP,ST_HVSP_CLK_CONFIG* stclk);
INTERFACE MS_U32 Drv_HVSP_GetInputSrcMux(void);
...
INTERFACE ST_HVSP_SCINTS_TYPE Drv_HVSP_GetSCLInts(void);

...
INTERFACE MS_BOOL Hal_VIP_GetSRAMDumpGammaYUV(EN_VIP_SRAM_DUMP_TYPE endump,MS_U32 u32Sram,MS_U32 u32reg);
INTERFACE MS_BOOL Hal_VIP_GetSRAMDumpGammaRGB(EN_VIP_SRAM_DUMP_TYPE endump,MS_U32 u32Sram,MS_U32 u32reg);
INTERFACE MS_BOOL Hal_VIP_GetSRAMDumpGammaRGBCallback(EN_VIP_SRAM_DUMP_TYPE endump,u32 u32Sram,u32 u32reg);
INTERFACE MS_BOOL Hal_VIP_GetSRAMDumpGammaYUVCallback(EN_VIP_SRAM_DUMP_TYPE endump,MS_U32 u32Sram,MS_U32 u32reg);
...
INTERFACE MS_U8 Hal_VIP_SRAM_Dump(EN_VIP_SRAM_DUMP_TYPE endump,MS_U32 u32Sram);

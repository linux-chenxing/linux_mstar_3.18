...
int _mdrv_ms_vip_io_set_nlm_config(struct file *filp, unsigned long arg)
{
    ...
    {
        if(copy_from_user(&stIOCfg, (ST_IOCTL_VIP_NLM_CONFIG __user *)arg, sizeof(ST_IOCTL_VIP_NLM_CONFIG)))
        {
            return -EFAULT;
        }
        else
...
int _mdrv_ms_vip_io_set_mcnr_config(struct file *filp, unsigned long arg)
{
    ...
    stVersion = _mdrv_ms_vip_io_fill_versionchkstruct(sizeof(ST_IOCTL_VIP_MCNR_CONFIG),
        (((ST_IOCTL_VIP_MCNR_CONFIG __user *)arg)->VerChk_Size),
        &(((ST_IOCTL_VIP_MCNR_CONFIG __user *)arg)->VerChk_Version));
    if(_mdrv_ms_vip_io_version_check(stVersion))
    {
        SCL_ERR( "[VIP]   %s  \n", __FUNCTION__);
        return -EINVAL;
    ...
    {
        if(copy_from_user(&stioCfg, (ST_IOCTL_VIP_MCNR_CONFIG __user *)arg, sizeof(ST_IOCTL_VIP_MCNR_CONFIG)))
        {
            return -EFAULT;
        }
        else
...
int _mdrv_ms_vip_io_set_aip_config(struct file *filp, unsigned long arg)
{
    ...
    stVersion = _mdrv_ms_vip_io_fill_versionchkstruct(sizeof(ST_IOCTL_VIP_AIP_CONFIG),
        (((ST_IOCTL_VIP_AIP_CONFIG __user *)arg)->VerChk_Size),
        &(((ST_IOCTL_VIP_AIP_CONFIG __user *)arg)->VerChk_Version));
    if(_mdrv_ms_vip_io_version_check(stVersion))
    {
        SCL_ERR( "[VIP]   %s  \n", __FUNCTION__);
        return -EINVAL;
    ...
    {
        if(copy_from_user(&stioCfg, (ST_IOCTL_VIP_AIP_CONFIG __user *)arg, sizeof(ST_IOCTL_VIP_AIP_CONFIG)))
        {
            return -EFAULT;
        }
        else
...
int _mdrv_ms_vip_io_set_aip_sram_config(struct file *filp, unsigned long arg)
{
    ...
    stVersion = _mdrv_ms_vip_io_fill_versionchkstruct(sizeof(ST_IOCTL_VIP_AIP_SRAM_CONFIG),
        (((ST_IOCTL_VIP_AIP_SRAM_CONFIG __user *)arg)->VerChk_Size),
        &(((ST_IOCTL_VIP_AIP_SRAM_CONFIG __user *)arg)->VerChk_Version));
    if(_mdrv_ms_vip_io_version_check(stVersion))
    {
        SCL_ERR( "[VIP]   %s  \n", __FUNCTION__);
        return -EINVAL;
    ...
    {
        if(copy_from_user(&stioCfg, (ST_IOCTL_VIP_AIP_SRAM_CONFIG __user *)arg, sizeof(ST_IOCTL_VIP_AIP_SRAM_CONFIG)))
        {
            return -EFAULT;
        }
        else
        {
            stCfg.u32Viraddr = stioCfg.u32Viraddr;
            stCfg.enAIPType = stioCfg.enAIPType;
        }
    }
...
{
    ST_IOCTL_VIP_AllSET_CONFIG stIOCfg;
    ST_MDRV_VIP_AllSET_CONFIG stCfg;
    ST_MDRV_VIP_VERSIONCHK_CONFIG stVersion;
    ...
    {
        if(copy_from_user(&stIOCfg, (ST_IOCTL_VIP_AllSET_CONFIG __user *)arg, sizeof(ST_IOCTL_VIP_AllSET_CONFIG)))
        {
            return -EFAULT;
        }
        else
        {
            memcpy(&stIOCfg,&stIOCfg,sizeof(ST_IOCTL_VIP_AllSET_CONFIG));
        }
    }
...
long mdrv_ms_vip_ioctl(struct file *filp, unsigned int u32Cmd, unsigned long u32Arg)
{
    ...
    static unsigned long long u64lastTime = 0;

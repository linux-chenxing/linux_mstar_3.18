...
typedef enum
{
    //E_DRV_GOP_COLOR_RGB565
    E_MI_FB_COLOR_FMT_RGB565 = 1,
    //E_DRV_GOP_COLOR_ARGB4444
    E_MI_FB_COLOR_FMT_ARGB4444 = 2,
    //E_DRV_GOP_COLOR_ARGB8888
    E_MI_FB_COLOR_FMT_ARGB8888 = 5,
    //E_DRV_GOP_COLOR_ARGB1555
    E_MI_FB_COLOR_FMT_ARGB1555 = 6,
    //E_DRV_GOP_COLOR_YUV422
...
{
    MS_BOOL bAlphaEnable;	/* alpha enable flag */
    MS_BOOL bAlphaChannel;	/* alpha channel enable flag */
    MS_U8 u8Alpha0; /*alpha0 value*/
    MS_U8 u8Alpha1; /*alpha1 value*/
    MS_U8 u8GlobalAlpha;	/* global alpha value */
    MS_U8 u8Reserved;   /* reserved*/
}MI_FB_GlobalAlpha_t;
...
typedef enum
{
    //E_DRV_GOP_DST_IP0
    E_MI_FB_DST_IP0 = 0,
    //E_DRV_GOP_DST_IP0_SUB
    E_MI_FB_DST_IP0_SUB = 1,
    //E_DRV_GOP_DST_MIXER2VE
    ...
    //E_DRV_GOP_DST_IP1
    E_MI_FB_DST_IP1 = 5,
    //E_DRV_GOP_DST_IP1_SUB
    E_MI_FB_DST_IP1_SUB = 6,
    //E_DRV_GOP_DST_MIXER2OP
    E_MI_FB_DST_MIXER2OP = 7,
    //E_DRV_GOP_DST_VOP_SUB
    ...
    //E_DRV_GOP_DST_OP1
    E_MI_FB_DST_OP1 = 12,
    //E_DRV_GOP_DST_MIXER2OP1
    E_MI_FB_DST_MIXER2OP1 = 13,
    //E_DRV_GOP_DST_DIP
    E_MI_FB_DST_DIP = 14,
    //E_DRV_GOP_DST_GOPScaling
    E_MI_FB_DST_GOPScaling  = 15,
    //E_DRV_GOP_DST_OP_DUAL_RATE
...
{
    MS_U32 u32Xpos;    /**the x pos of orign point in screen*/
    MS_U32 u32YPos;   /**the y pos of orign point in screen*/
    MS_U32 u32dstWidth; /**display buffer dest with in screen*/
    MS_U32 u32dstHeight; /**display buffer dest hight in screen*/
    MS_U32 u32DisplayWidth;  /**the width of display buf in fb */
    MS_U32 u32DisplayHeight;  /**the height of display buf in fb. */
    MS_U32 u32ScreenWidth;  /**the width of screen */
    MS_U32 u32ScreenHeight; /** the height of screen */
    MS_BOOL bPreMul;  /**the data drawed in buffer whether is premultiply alpha or not*/
    ...
    MS_U32 u32SetAttrMask; /** display attribute modify mask*/
} MI_FB_DisplayLayerAttr_t;

typedef struct MI_FB_CursorImage_s
{
    MS_U32 u32Width; /**width, unit pixel*/
    MS_U32 u32Height; /**Height, unit pixel*/
    MS_U32 u32Pitch; /**Pitch, unit pixel*/
...
#define FBIOGET_SHOW _IOR(FB_IOC_MAGIC, 0x62, MS_BOOL)
#define FBIOSET_SHOW _IOW(FB_IOC_MAGIC, 0x63, MS_BOOL)

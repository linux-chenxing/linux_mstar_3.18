...
INTERFACE MBX_Result  MDrv_MBX_Init(TYPE_MBX_C_U64 u32AsyncID, MBX_CPU_ID eHKCPU, MBX_ROLE_ID eHostRole, MS_U32 u32TimeoutMillSecs);
INTERFACE MBX_Result  MDrv_MBX_DeInit(TYPE_MBX_C_U64 u32AsyncID, MS_BOOL bForceDiscardPendingMsg);
...
INTERFACE MBX_Result  MDrv_MBX_RegisterMSG(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eMsgClass, MS_U16 u16MsgQueueSize);
INTERFACE MBX_Result  MDrv_MBX_UnRegisterMSG(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eMsgClass, MS_BOOL bForceDiscardMsgQueue);
INTERFACE MBX_Result  MDrv_MBX_ClearMSG(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eMsgClass);
INTERFACE MBX_Result  MDrv_MBX_SendMsg(TYPE_MBX_C_U64 u32AsyncID, MBX_Msg *pMsg, MS_U8 u8Trigger);
INTERFACE MBX_Result  MDrv_MBX_SendMsgLoopback(TYPE_MBX_C_U64 u32AsyncID, MBX_Msg *pMsg, MBX_ROLE_ID eSrcRoleId);
INTERFACE MBX_Result  MDrv_MBX_RecvMsg(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag ,MS_U8 u8Trigger);
INTERFACE MBX_Result  MDrv_MBX_CheckMsg(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag);
INTERFACE MBX_Result  MDrv_MBX_GetMsgQueueStatus(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eTargetClass, MBX_MSGQ_Status *pMsgQueueStatus);
INTERFACE MBX_Result  MDrv_MBX_RemoveLatestMsg(void);

// For Application Set/Get Information API:
INTERFACE MBX_Result  MDrv_MBX_SetInformation(TYPE_MBX_C_U64 u32AsyncID, MBX_ROLE_ID eTargetRole, MS_U8 *pU8Info, MS_U8 u8Size);
INTERFACE MBX_Result  MDrv_MBX_GetInformation(TYPE_MBX_C_U64 u32AsyncID, MBX_ROLE_ID eTargetRole, MS_U8 *pU8Info, MS_U8 u8Size);

INTERFACE MBX_Result  MDrv_MBX_Enable(TYPE_MBX_C_U64 u32AsyncID, MS_BOOL bEnable);//Enable receiving regisited messages in kernel

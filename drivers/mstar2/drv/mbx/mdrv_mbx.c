...
/// <b>[MXLIB] <em></em></b>
//-------------------------------------------------------------------------------------------------
MBX_Result  MDrv_MBX_Init(TYPE_MBX_C_U64 u32AsyncID, MBX_CPU_ID eHKCPU, MBX_ROLE_ID eHostRole, MS_U32 u32TimeoutMillSecs)
{
	int i = 0;
    MBX_Result result;
    DRV_MBX_LockRecv();
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_DeInit(TYPE_MBX_C_U64 u32AsyncID, MS_BOOL bForceDiscardPendingMsg)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_RegisterMSG(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eMsgClass, MS_U16 u16MsgQueueSize)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
    MS_S16 mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_UnRegisterMSG(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eMsgClass, MS_BOOL bForceDiscardMsgQueue)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
    MS_S16 mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
    MS_S16 s16MsgQFirst;
...
/// <b>[MXLIB] <em> </em></b>
//-------------------------------------------------------------------------------------------------
MBX_Result  MDrv_MBX_ClearMSG(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eMsgClass)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
    MS_S16 mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_GetMsgQueueStatus(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eTargetClass, MBX_MSGQ_Status *pMsgQueueStatus)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
    MS_S16 mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_SendMsg(TYPE_MBX_C_U64 u32AsyncID, MBX_Msg *pMsg, MS_U8 u8Trigger)
{
    //parameter check:
    if(NULL==pMsg)
    {
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_SendMsgLoopback(TYPE_MBX_C_U64 u32AsyncID, MBX_Msg *pMsg, MBX_ROLE_ID eSrcRoleId)
{
    //parameter check:
    if(NULL==pMsg)
    {
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_RecvMsg(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag, MS_U8 u8Trigger)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
    MS_S16 mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
    long ret;
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_CheckMsg(TYPE_MBX_C_U64 u32AsyncID, MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32WaitMillSecs, MS_U32 u32Flag)
{
    MBX_Result mbxResult = E_MBX_SUCCESS;
    MS_S16 mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
    MS_U32 u32Idx;
...
MBX_Result  MDrv_MBX_SetInformation(TYPE_MBX_C_U64 u32AsyncID, MBX_ROLE_ID eTargetRole, MS_U8 *pU8Info, MS_U8 u8Size)
{
    return MHAL_MBX_SetInformation(eTargetRole, pU8Info, u8Size);
}

//The u32AsyncID is useless since SetInformation could be called before Init.
MBX_Result  MDrv_MBX_GetInformation(TYPE_MBX_C_U64 u32AsyncID, MBX_ROLE_ID eTargetRole, MS_U8 *pU8Info, MS_U8 u8Size)
{
...
/*
  ...
  Return Value:
        ...
        MBX_UNKNOW_ERROR-->Other undefined errors
*/
MBX_Result  MDrv_MBX_Enable(TYPE_MBX_C_U64 u32AsyncID, MS_BOOL bEnable)
{
    MS_S16 mbxAsyncNotifierID;
    DRV_MBX_Lock();
    mbxAsyncNotifierID = _MDrv_MBX_GetAsyncNotifierIDByAsyncID(u32AsyncID);
...
{
    TYPE_MBX_C_U64 u32AMBXAsyncID = 0;
    MS_S16 s16Idx;

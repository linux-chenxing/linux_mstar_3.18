...
#else
/*
*adjust the fusion shm pool virtual base address from 0x20010000 to 0x80010000
*The android platform art(virtual machine) use the virtual space 0x12c00000
*to 0x32c00000 and conflct with the orign fusion shm virtual address space
*/
#ifdef CONFIG_FUSION_FOR_ANDROID_VERSION_BIGGER_THAN_5.0
#define FUSION_SHM_BASE_32    0x80010000      /* virtual base address */
#else

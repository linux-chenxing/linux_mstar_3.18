...
static int __init init_key_map_konka_tv(void)
{
	return MIRC_Map_Register(&konka_tv_map);
}

static void __exit exit_key_map_konka_tv(void)
{
	MIRC_Map_UnRegister(&konka_tv_map);
}

module_init(init_key_map_konka_tv)
module_exit(exit_key_map_konka_tv)

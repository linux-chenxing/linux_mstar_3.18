...
static int __init init_key_map_haier_tv(void)
{
	return MIRC_Map_Register(&haier_tv_map);
}

static void __exit exit_key_map_haier_tv(void)
{
	MIRC_Map_UnRegister(&haier_tv_map);
}

module_init(init_key_map_haier_tv)
module_exit(exit_key_map_haier_tv)

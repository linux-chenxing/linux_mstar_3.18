...
static int __init init_key_map_hisense_tv(void)
{
	return MIRC_Map_Register(&hisense_tv_map);
}

static void __exit exit_key_map_hisense_tv(void)
{
	MIRC_Map_UnRegister(&hisense_tv_map);
}

module_init(init_key_map_hisense_tv)
module_exit(exit_key_map_hisense_tv)

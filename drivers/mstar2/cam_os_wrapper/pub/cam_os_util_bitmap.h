...
static inline void CAM_OS_SET_BIT(int32_t nr, volatile unsigned long *addr)
{
...
static inline void CAM_OS_CLEAR_BIT(int32_t nr, volatile unsigned long *addr)
{
    unsigned long mask = CAM_OS_BIT_MASK(nr);
    unsigned long *p = ((unsigned long *)addr) + CAM_OS_BIT_WORD(nr);
...
static inline void CAM_OS_CHANGE_BIT(int32_t nr, volatile unsigned long *addr)
{
    unsigned long mask = CAM_OS_BIT_MASK(nr);
    unsigned long *p = ((unsigned long *)addr) + CAM_OS_BIT_WORD(nr);
...
static inline int32_t CAM_OS_TEST_AND_SET_BIT(int32_t nr, volatile unsigned long *addr)
{
    unsigned long mask = CAM_OS_BIT_MASK(nr);
    unsigned long *p = ((unsigned long *)addr) + CAM_OS_BIT_WORD(nr);
    unsigned long old = *p;
...
static inline int32_t CAM_OS_TEST_AND_CLEAR_BIT(int32_t nr, volatile unsigned long *addr)
{
    unsigned long mask = CAM_OS_BIT_MASK(nr);
    unsigned long *p = ((unsigned long *)addr) + CAM_OS_BIT_WORD(nr);
    unsigned long old = *p;
...
static inline int32_t CAM_OS_TEST_AND_CHANGE_BIT(int32_t nr,
...
static inline int32_t CAM_OS_TEST_BIT(int32_t nr, const volatile unsigned long *addr)
{

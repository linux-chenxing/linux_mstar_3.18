...
#define PAGE_OFFSET2    \
        (lx_mem3_addr==INVALID_PHY_ADDR ? (PAGE_OFFSET1 + lx_mem2_left_size) :  \
        (PAGE_OFFSET1 + lx_mem2_left_size + VIRT_HOLE(lx_mem3_addr, PAGE_OFFSET1 + lx_mem2_left_size)))
...
/* page offset of LX_MEM2 */
#define PAGE_OFFSET1    (PAGE_OFFSET + lx_mem_left_size)

/* page offset of LX_MEM3*/
#define PAGE_OFFSET2    (PAGE_OFFSET1 + lx_mem2_left_size)
#endif

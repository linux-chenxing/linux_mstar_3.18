...
// Interrupt:
#ifndef KANO_GMAC0
#define MAC_IRQ                         E_IRQHYPH_SECGMAC //aliasing for interrupt enum (GMAC1 & Internal)
#else
#define MAC_IRQ                         E_IRQ_GMAC  //aliasing for interrupt enum (GMAC0)
#endif
...
#ifdef KANO_GMAC0
#define GMAC_REG_ADDR_BASE              GMAC0_REG_ADDR_BASE
#else
#define GMAC_REG_ADDR_BASE              GMAC1_REG_ADDR_BASE
#endif

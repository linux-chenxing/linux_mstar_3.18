...
S32 gs32_NANDCLKPHandle = 0;
S32 gs32_NANDCLKHandle = 0;

static char *gu8clkNANDtable[] =
{
    "g_nfie_clk_xtal",
    "g_nfie_clk_20",
    "g_nfie_clk_32",
...
U32 nand_clock_setting(U32 u32ClkParam)
{
    ...
    if( REG(NC_DDR_CTRL) & BIT_DDR_MASM )
    {
        ...
        #ifdef CONFIG_MSTAR_CLKM
        set_clk_source(gs32_NANDCLKHandle, "g_nfie_clk_xtal");
        set_clk_source(gs32_NANDCLKPHandle, "g_nfie_clk_2x_p");
        set_clk_source(gs32_NANDCLKHandle, "g_nfie_clk_p");
        #else
    ...
    else
    {
        ...
        #ifdef CONFIG_MSTAR_CLKM
        set_clk_source(gs32_NANDCLKHandle, "g_nfie_clk_xtal");
        set_clk_source(gs32_NANDCLKPHandle, gu8clkNANDtable[u32ClkParam>>2]);
        set_clk_source(gs32_NANDCLKHandle, "g_nfie_clk_p");
        #else
...
U32 NC_PlatformInit(void)
{
    ...
    gs32_NANDCLKPHandle = get_handle("g_clk_nfie_p");
    gs32_NANDCLKHandle = get_handle("g_clk_nfie");
    #endif

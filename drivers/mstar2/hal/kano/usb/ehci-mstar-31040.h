...
#define MAX_COMP_PORT_NUM 3
#else
#define MAX_COMP_PORT_NUM 4
#endif
#define MSTAR_RIU_1712_BANK (_MSTAR_USB_BASEADR+0x71200*2)
#define USB_MAC_SRAM_CTRL_ADDR(h) (MSTAR_RIU_1712_BANK+0x22*2)
#define USB_MAC_SRAM_CTRL_BIT(h) (1<<((h)->port_index+4))
#endif

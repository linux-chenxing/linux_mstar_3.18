...
void KHal_SC_ResetSWDSCommand(EN_KDRV_SC_DEVICE u32DeviceID,EN_KDRV_WINDOW eWindow, MS_U8 u8DSIndex)
{
    ...
    MS_U16 u16SWRstCmd_Pointer = (u8XCDepth-1)*(BYTE_PER_WORD/DS_CMD_LEN_64BITS);
#else
...
MS_BOOL KHAL_SC_Set_DynamicScaling(EN_KDRV_SC_DEVICE u32DeviceID,MS_PHY u32MemBaseAddr, MS_U8 u8MIU_Select, MS_U8 u8IdxDepth, MS_BOOL bOP_On, MS_BOOL bIPS_On, MS_BOOL bIPM_On, MS_U32 u32DSBufferSize, EN_KDRV_WINDOW eWindow)
{
    MS_U16 u16OnOff = 0;
...
void KHal_XC_WriteStoredSWDSCommand(EN_KDRV_SC_DEVICE u32DeviceID, EN_KDRV_WINDOW eWindow, E_DS_CLIENT client, MS_PHY phyStoredCmdAddr,

...
U32 MsOS1_PA2KSEG1(U32 addr)
{
	return ((U32)(((U32)addr) | 0xa0000000));
}
U32 MsOS1_VA2PA(U32 addr)
{
	return ((U32)(((U32)addr) & 0x1fffffff));
}

void HAL_HWI2C1_ExtraDelay(U32 u32Us)
{
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_SetIOMapBase
/// @brief \b Function  \b Description: Dump bdma all register
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_HWI2C1_SetIOMapBase(U32 u32Base)
{
    HWI2C_HAL_FUNC();
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Read4Byte
/// @brief \b Function  \b Description: read 2 Byte data
/// @param <IN>         \b u32RegAddr: register address
/// @param <OUT>        \b None :
/// @param <RET>        \b U16
////////////////////////////////////////////////////////////////////////////////
U16 HAL_HWI2C1_Read2Byte(U32 u32RegAddr)
{
	HWI2C_HAL_FUNC();
...
/// @param <RET>        \b U32
////////////////////////////////////////////////////////////////////////////////
U32 HAL_HWI2C1_Read4Byte(U32 u32RegAddr)
{
	HWI2C_HAL_FUNC();
	HWI2C_HAL_INFO("HWI2C IOMap base:%16lx u32RegAddr:%8lx\n", _gMIO_MapBase, u32RegAddr);

    return (HAL_HWI2C1_Read2Byte(u32RegAddr) | HAL_HWI2C1_Read2Byte(u32RegAddr+2) << 16);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_WriteByte
...
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_WriteByte(U32 u32RegAddr, U8 u8Val)
{
	U16 u16value;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Write2Byte
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Write2Byte(U32 u32RegAddr, U16 u16Val)
{
    if (!u32RegAddr)
    {
        HWI2C_HAL_ERR("%s reg error!\n", __FUNCTION__);
    ...
    //HAL_HWI2C1_WriteByte(u32RegAddr,LOWBYTE(u16Val));
    //HAL_HWI2C1_WriteByte(u32RegAddr+1,HIBYTE(u16Val));
    (*(volatile U32*)(_gMIO_MapBase+((u32RegAddr & 0xFFFFFF00ul) << 1) + (((u32RegAddr & 0xFF)/ 2) << 2))) = u16Val;
    return TRUE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Write4Byte
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Write4Byte(U32 u32RegAddr, U32 u32Val)
{
    if (!u32RegAddr)
    {
        HWI2C_HAL_ERR("%s reg error!\n", __FUNCTION__);
    ...
    HAL_HWI2C1_Write2Byte(u32RegAddr, u32Val & 0x0000FFFF);
    HAL_HWI2C1_Write2Byte(u32RegAddr+2, u32Val >> 16);
    return TRUE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_WriteRegBit
/// @brief \b Function  \b Description: write 1 Byte data
/// @param <IN>         \b u32RegAddr: register address
/// @param <IN>         \b u8Val : 1 byte data
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_WriteRegBit(U32 u32RegAddr, U8 u8Mask, BOOL bEnable)
{
    U8 u8Val = 0;
    ...
    u8Val = HAL_HWI2C1_ReadByte(u32RegAddr);
    u8Val = (bEnable) ? (u8Val | u8Mask) : (u8Val & ~u8Mask);
    HAL_HWI2C1_WriteByte(u32RegAddr, u8Val);
	HWI2C_HAL_INFO("read back u32RegAddr:%x\n", HAL_HWI2C1_ReadByte(u32RegAddr));
    return TRUE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_WriteByteMask
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_WriteByteMask(U32 u32RegAddr, U8 u8Val, U8 u8Mask)
{
    if (!u32RegAddr)
    {
        HWI2C_HAL_ERR("%s reg error!\n", __FUNCTION__);
    ...
    u8Val = (HAL_HWI2C1_ReadByte(u32RegAddr) & ~u8Mask) | (u8Val & u8Mask);
    HAL_HWI2C1_WriteByte(u32RegAddr, u8Val);
    return TRUE;
}
...
//#####################
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_EnINT
/// @brief \b Function  \b Description: Enable Interrupt
/// @param <IN>         \b bEnable : TRUE: Enable, FALSE: Disable
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static BOOL HAL_HWI2C1_EnINT(U16 u16PortOffset, BOOL bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C1_WriteRegBit(REG_HWI2C1_MIIC_CFG+u16PortOffset, _MIIC1_CFG_EN_INT, bEnable);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_EnClkStretch
/// @brief \b Function  \b Description: Enable Clock Stretch
/// @param <IN>         \b bEnable : TRUE: Enable, FALSE: Disable
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static BOOL HAL_HWI2C1_EnClkStretch(U16 u16PortOffset, BOOL bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C1_WriteRegBit(REG_HWI2C1_MIIC_CFG+u16PortOffset, _MIIC1_CFG_EN_CLKSTR, bEnable);
}


////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_EnFilter
/// @brief \b Function  \b Description: Enable Filter
/// @param <IN>         \b bEnable : TRUE: Enable, FALSE: Disable
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static BOOL HAL_HWI2C1_EnFilter(U16 u16PortOffset, BOOL bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C1_WriteRegBit(REG_HWI2C1_MIIC_CFG+u16PortOffset, _MIIC1_CFG_EN_FILTER, bEnable);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_EnPushSda
/// @brief \b Function  \b Description: Enable push current for SDA
/// @param <IN>         \b bEnable : TRUE: Enable, FALSE: Disable
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
static BOOL HAL_HWI2C1_EnPushSda(U16 u16PortOffset, BOOL bEnable)
{
    HWI2C_HAL_FUNC();
    return HAL_HWI2C1_WriteRegBit(REG_HWI2C1_MIIC_CFG+u16PortOffset, _MIIC1_CFG_EN_PUSH1T, bEnable);
}
...
//#####################
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Init_Chip
/// @brief \b Function  \b Description: Init HWI2C chip
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Init_Chip(void)
{
    BOOL bRet = TRUE;

    HWI2C_HAL_FUNC();
    //not set all pads (except SPI) as input
    bRet &= HAL_HWI2C1_WriteRegBit(CHIP_REG_ALLPADIN, CHIP_ALLPAD_IN, FALSE);
	bRet &= HAL_HWI2C1_WriteByteMask(REG_HWI2C_MIIC1_VER_SEL, REG_HWI2C_MIIC1_VER_V3, REG_HWI2C_MIIC1_VER_MSK);
    return bRet;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_IsMaster
/// @brief \b Function  \b Description: Check if Master I2C
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Master, FALSE: Slave
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_IsMaster(void)
{
    HWI2C_HAL_FUNC();
    return TRUE;
}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Master_Enable
/// @brief \b Function  \b Description: Master I2C enable
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Master_Enable(U16 u16PortOffset)
{
    U8 u8Port;
    BOOL bRet;
    ...
    if(HAL_HWI2C1_GetPortIdxByOffset(u16PortOffset,&u8Port)==FALSE)
        return FALSE;
    g_bLastByte[u8Port] = FALSE;

    //(1) clear interrupt
    HAL_HWI2C1_Clear_INT(u16PortOffset);
    //(2) reset standard master iic
    HAL_HWI2C1_Reset(u16PortOffset,TRUE);
    HAL_HWI2C1_Reset(u16PortOffset,FALSE);
    //(3) configuration
    HAL_HWI2C1_EnINT(u16PortOffset,TRUE);
    HAL_HWI2C1_EnClkStretch(u16PortOffset,TRUE);
    HAL_HWI2C1_EnFilter(u16PortOffset,TRUE);
    HAL_HWI2C1_EnPushSda(u16PortOffset,TRUE);

    return bRet;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_SetPortRegOffset
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_SetPortRegOffset(HAL_HWI2C_PORT ePort, U16* pu16Offset)
{
    HWI2C_HAL_FUNC();
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_GetPortIdxByRegOffset
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_GetPortIdxByOffset(U16 u16Offset, U8* pu8Port)
{
    HWI2C_HAL_FUNC();
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_GetPortIdxByPort
/// @brief \b Function  \b Description: Get HWI2C port index by port number
/// @param <IN>         \b ePort : port number
/// @param <OUT>         \b pu8Port :  port index
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_GetPortIdxByPort(HAL_HWI2C_PORT ePort, U8* pu8Port)
{
    HWI2C_HAL_FUNC();
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_SelectPort
/// @brief \b Function  \b Description: Select HWI2C port
/// @param <IN>         \b None : HWI2C port
/// @param param        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_SelectPort(HAL_HWI2C_PORT ePort)
{
    U8 u8Value1=0;
    ...
    if((ePort>=E_HAL_HWI2C_PORT0_0)&&(ePort<=E_HAL_HWI2C_PORT0_7))//port 0
    {
		...
		HAL_HWI2C1_WriteByteMask(CHIP_REG_HWI2C_MIIC1_CLK, CHIP_REG_HWI2C_MIIC1_CLK_XTAL, CHIP_REG_HWI2C_MIIC1_CLK_MSK);
        HAL_HWI2C1_WriteByteMask(CHIP_REG_HWI2C_MIIC1, u8Value1, CHIP_MIIC1_PAD_MSK);
    }
    else
    {
        return FALSE;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_SetClk
/// @brief \b Function  \b Description: Set I2C clock
/// @param <IN>         \b u8Clk: clock rate
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_SetClk(U16 u16PortOffset, HAL_HWI2C_CLKSEL eClkSel)
{
    ...
    HAL_HWI2C1_Write2Byte(REG_HWI2C1_CKH_CNT+u16PortOffset, u16ClkHCnt);
    HAL_HWI2C1_Write2Byte(REG_HWI2C1_CKL_CNT+u16PortOffset, u16ClkLCnt);
    HAL_HWI2C1_Write2Byte(REG_HWI2C1_STP_CNT+u16PortOffset, u16StpCnt);
    HAL_HWI2C1_Write2Byte(REG_HWI2C1_SDA_CNT+u16PortOffset, u16SdaCnt);
    HAL_HWI2C1_Write2Byte(REG_HWI2C1_STT_CNT+u16PortOffset, u16SttCnt);
    HAL_HWI2C1_Write2Byte(REG_HWI2C1_LTH_CNT+u16PortOffset, u16LchCnt);
    //HAL_HWI2C1_Write2Byte(REG_HWI2C1_TMT_CNT+u16PortOffset, 0x0000);
    return TRUE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Start
/// @brief \b Function  \b Description: Send start condition
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Start(U16 u16PortOffset)
{
    U16 u16Count = HWI2C_HAL_WAIT_TIMEOUT;

    HWI2C_HAL_FUNC();
    //reset I2C
    HAL_HWI2C1_WriteRegBit(REG_HWI2C1_CMD_START+u16PortOffset, _CMD_START, TRUE);
    while((!HAL_HWI2C1_Is_INT(u16PortOffset))&&(u16Count > 0))
        u16Count--;
	udelay(5);
    HAL_HWI2C1_Clear_INT(u16PortOffset);
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Stop
/// @brief \b Function  \b Description: Send Stop condition
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Stop(U16 u16PortOffset)
{
    U16 u16Count = HWI2C_HAL_WAIT_TIMEOUT;

    HWI2C_HAL_FUNC();
	udelay(5);
    HAL_HWI2C1_WriteRegBit(REG_HWI2C1_CMD_STOP+u16PortOffset, _CMD_STOP, TRUE);
    while((!HAL_HWI2C1_Is_Idle(u16PortOffset))&&(!HAL_HWI2C1_Is_INT(u16PortOffset))&&(u16Count > 0))
        u16Count--;
    HAL_HWI2C1_Clear_INT(u16PortOffset);
    return (u16Count)? TRUE:FALSE;
}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_ReadRdy
/// @brief \b Function  \b Description: Start byte reading
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_ReadRdy(U16 u16PortOffset)
{
    U8 u8Value=0;
    U8 u8Port;
    ...
    g_bLastByte[u8Port] = FALSE;
    return HAL_HWI2C1_WriteByte(REG_HWI2C1_RDATA_CFG+u16PortOffset, u8Value);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_SendData
/// @brief \b Function  \b Description: Send 1 byte data to SDA
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_SendData(U16 u16PortOffset, U8 u8Data)
{
    HWI2C_HAL_FUNC();

    return HAL_HWI2C1_WriteByte(REG_HWI2C1_WDATA+u16PortOffset, u8Data);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_RecvData
/// @brief \b Function  \b Description: Receive 1 byte data from SDA
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b U8 :
////////////////////////////////////////////////////////////////////////////////
U8 HAL_HWI2C1_RecvData(U16 u16PortOffset)
{
    HWI2C_HAL_FUNC();

    return HAL_HWI2C1_ReadByte(REG_HWI2C1_RDATA+u16PortOffset);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Get_SendAck
/// @brief \b Function  \b Description: Get ack after sending data
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Valid ack, FALSE: No ack
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Get_SendAck(U16 u16PortOffset)
{
    HWI2C_HAL_FUNC();
    return (HAL_HWI2C1_ReadByte(REG_HWI2C1_WDATA_GET+u16PortOffset) & _WDATA_GET_ACKBIT) ? FALSE : TRUE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_NoAck
/// @brief \b Function  \b Description: generate no ack pulse
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_NoAck(U16 u16PortOffset)
{
    U8 u8Port;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Ack
/// @brief \b Function  \b Description: generate ack pulse
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Ack(U16 u16PortOffset)
{
    U8 u8Port;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_GetStae
...
////////////////////////////////////////////////////////////////////////////////
U8 HAL_HWI2C1_GetState(U16 u16PortOffset)
{
	
	U8 cur_state =  HAL_HWI2C1_ReadByte(REG_HWI2C1_CUR_STATE+u16PortOffset) & _CUR_STATE_MSK;
	HWI2C_HAL_FUNC();
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Is_Idle
/// @brief \b Function  \b Description: Check if i2c is idle
/// @param <IN>         \b u16PortOffset: HWI2C Port Offset
/// @param <OUT>        \b None
/// @param <RET>        \b TRUE : idle, FALSE : not idle
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Is_Idle(U16 u16PortOffset)
{
    HWI2C_HAL_FUNC();

    return ((HAL_HWI2C1_GetState(u16PortOffset)==E_HAL_HWI2C_STATE_IDEL) ? TRUE : FALSE);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Is_INT
...
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Is_INT(U16 u16PortOffset)
{
    HWI2C_HAL_FUNC();
    return (HAL_HWI2C1_ReadByte(REG_HWI2C1_INT_CTL+u16PortOffset) & _INT_CTL) ? TRUE : FALSE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Clear_INT
/// @brief \b Function  \b Description: Enable interrupt for HWI2C
/// @param <IN>         \b None :
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE : ok, FALSE : fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Clear_INT(U16 u16PortOffset)
{
    HWI2C_HAL_FUNC();

    return HAL_HWI2C1_WriteRegBit(REG_HWI2C1_INT_CTL+u16PortOffset, _INT_CTL, TRUE);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Reset
/// @brief \b Function  \b Description: Reset HWI2C state machine
/// @param <IN>         \b bReset : TRUE: Reset FALSE: Not reset
/// @param <OUT>        \b None :
/// @param <RET>        \b TRUE: Ok, FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Reset(U16 u16PortOffset, BOOL bReset)
{
    HWI2C_HAL_FUNC();

    return HAL_HWI2C1_WriteRegBit(REG_HWI2C1_MIIC_CFG+u16PortOffset, _MIIC1_CFG_RESET, bReset);
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Send_Byte
/// @brief \b Function  \b Description: Send one byte
/// @param u8Data       \b IN: 1 byte data
/// @return             \b TRUE: Success FALSE: Fail
////////////////////////////////////////////////////////////////////////////////
BOOL HAL_HWI2C1_Send_Byte(U16 u16PortOffset, U8 u8Data)
{
    ...
    {
        HAL_HWI2C1_Clear_INT(u16PortOffset);
        if (HAL_HWI2C1_SendData(u16PortOffset,u8Data))
        {
            u16Count = HWI2C_HAL_WAIT_TIMEOUT;
            while(u16Count--)
            {
                HAL_HWI2C1_ExtraDelay(10000);
                if (HAL_HWI2C1_Is_INT(u16PortOffset))
                {
                    HAL_HWI2C1_Clear_INT(u16PortOffset);
                    if (HAL_HWI2C1_Get_SendAck(u16PortOffset))
                    {
                        #if 1
                        HAL_HWI2C1_ExtraDelay(1);
                        #else
                        MsOS_DelayTaskUs(1);
                        #endif
                        return TRUE;
...
BOOL HAL_HWI2C1_Recv_Byte(U16 u16PortOffset, U8 *pData)
{
    ...
    HAL_HWI2C1_ReadRdy(u16PortOffset);
    while((!HAL_HWI2C1_Is_INT(u16PortOffset))&&(u16Count > 0))
        u16Count--;
    HAL_HWI2C1_Clear_INT(u16PortOffset);
    if (u16Count)
    {
        ...
        *pData = HAL_HWI2C1_RecvData(u16PortOffset);
        //clear interrupt
        HAL_HWI2C1_Clear_INT(u16PortOffset);
        #if 1
        HAL_HWI2C1_ExtraDelay(1);
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_HWI2C1_Init_ExtraProc
/// @brief \b Function  \b Description: Do extral procedure after initialization
/// @param <IN>         \b None :
/// @param param        \b None :
/// @param <RET>        \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_HWI2C1_Init_ExtraProc(void)
{
    HWI2C_HAL_FUNC();

...
#ifndef _HAL_HWI2C1_H_
#define _HAL_HWI2C1_H_

#ifdef _HAL_IIC1_C_
#define _extern_HAL_IIC1_
#else
#define _extern_HAL_IIC1_ extern
#endif

//#include "../iic/mhal_iic.h"
...
// Extern function
////////////////////////////////////////////////////////////////////////////////
_extern_HAL_IIC1_ U32 MsOS1_PA2KSEG1(U32 addr);
_extern_HAL_IIC1_ U32 MsOS1_VA2PA(U32 addr);

_extern_HAL_IIC1_ void HAL_HWI2C1_ExtraDelay(U32 u32Us);
_extern_HAL_IIC1_ void HAL_HWI2C1_SetIOMapBase(U32 u32Base);
_extern_HAL_IIC1_ U8 HAL_HWI2C1_ReadByte(U32 u32RegAddr);
_extern_HAL_IIC1_ U16 HAL_HWI2C1_Read2Byte(U32 u32RegAddr);
_extern_HAL_IIC1_ U32 HAL_HWI2C1_Read4Byte(U32 u32RegAddr);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_WriteByte(U32 u32RegAddr, U8 u8Val);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Write2Byte(U32 u32RegAddr, U16 u16Val);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Write4Byte(U32 u32RegAddr, U32 u32Val);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_WriteRegBit(U32 u32RegAddr, U8 u8Mask, BOOL bEnable);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_WriteByteMask(U32 u32RegAddr, U8 u8Val, U8 u8Mask);

_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Init_Chip(void);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_IsMaster(void);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Master_Enable(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_SetPortRegOffset(HAL_HWI2C_PORT ePort, U16* pu16Offset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_GetPortIdxByOffset(U16 u16Offset, U8* pu8Port);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_GetPortIdxByPort(HAL_HWI2C_PORT ePort, U8* pu8Port);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_SelectPort(HAL_HWI2C_PORT ePort);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_SetClk(U16 u16PortOffset, HAL_HWI2C_CLKSEL eClkSel);

_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Start(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Stop(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_ReadRdy(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_SendData(U16 u16PortOffset, U8 u8Data);
_extern_HAL_IIC1_ U8 HAL_HWI2C1_RecvData(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Get_SendAck(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_NoAck(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Ack(U16 u16PortOffset);
_extern_HAL_IIC1_ U8 HAL_HWI2C1_GetState(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Is_Idle(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Is_INT(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Clear_INT(U16 u16PortOffset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Reset(U16 u16PortOffset, BOOL bReset);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Send_Byte(U16 u16PortOffset, U8 u8Data);
_extern_HAL_IIC1_ BOOL HAL_HWI2C1_Recv_Byte(U16 u16PortOffset, U8 *pData);

_extern_HAL_IIC1_ BOOL HAL_HWI2C1_DMA_WriteBytes(U16 u16PortOffset, U16 u16SlaveCfg, U32 uAddrCnt, U8 *pRegAddr, U32 uSize, U8 *pData);

_extern_HAL_IIC1_ void HAL_HWI2C1_Init_ExtraProc(void);


#endif  //_MHAL_HWI2C1_H_

...
#define REG_BRI_DUMMY_REG1          (0x004A*4 + (REG_AXI2MI_BASE))    /* 16 BITS */
		#define REG_U02_DYNAMIC_MIU01_SELECTION         (1<<0)
		#define REG_U02_DYNAMIC_MIU01_CROSSING_CHECK    (1<<1)
		#define REG_U02_VAPA_ADDRESS_TRANSLATION        (1<<4)
		#define REG_U02_FIX_AXI_RLAST                   (1<<5)
		#define REG_U02_MIU0_VAPA_ADDRESS_OFFSET_VALUE	8                /* 4 BITS [11:8] */
		#define REG_U02_MIU1_VAPA_ADDRESS_OFFSET_VALUE	12               /* 4 BITS [15:12] */
		#define REG_BRI_DUMMY_REG1_MASK           0x0000FFFFU

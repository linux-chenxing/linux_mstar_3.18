...
void MHal_GPIO_Pad_Set(U8 u8IndexGPIO)
{
    ...
    {
        case PAD_PM_IRIN:
            MHal_GPIO_WriteRegBit(REG_IRIN_CFG_GPIO, ENABLE, BIT4);
            break;
        case PAD_PM_SPI_CZ:
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, ENABLE, BIT1);
            break;
        case PAD_PM_SPI_CK:
        case PAD_PM_SPI_DI:
        case PAD_PM_SPI_DO:
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, ENABLE, BIT0);
            break;
        case PAD_PM_SPI_WPZ:
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, ENABLE, BIT4);
            break;
        case PAD_PM_SPI_HOLDZ:
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, DISABLE, BIT6|BIT7);
            break;
        case PAD_PM_GPIO0:
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, ENABLE, BIT2);
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, DISABLE, BIT6|BIT7);
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_L, DISABLE, BIT0|BIT1|BIT6|BIT7);
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_H, DISABLE, BIT2|BIT3|BIT4|BIT5);
            break;
        case PAD_PM_GPIO1:
            MHal_GPIO_WriteRegBit(REG_SPI_CFG_GPIO, DISABLE, BIT6|BIT7);
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_L, DISABLE, BIT2|BIT3);
			MHal_GPIO_WriteRegBit(REG_UART_CFG_GPIO, DISABLE, BIT1|BIT2);
            break;
        case PAD_PM_GPIO3:
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_L, DISABLE, BIT6|BIT7);
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_H, DISABLE, BIT2|BIT3|BIT4|BIT5);
            break;
        case PAD_PM_GPIO4:
            MHal_GPIO_WriteRegBit(REG_GPIO_PM_LOCK_L, DISABLE, BIT0|BIT6);
            MHal_GPIO_WriteRegBit(REG_GPIO_PM_LOCK_L, ENABLE, BIT1|BIT2|BIT3|BIT4|BIT5|BIT7);
            MHal_GPIO_WriteRegBit(REG_GPIO_PM_LOCK_H, DISABLE, BIT0|BIT2|BIT6);
            MHal_GPIO_WriteRegBit(REG_GPIO_PM_LOCK_H, ENABLE, BIT1|BIT3|BIT4|BIT5|BIT7);
			MHal_GPIO_WriteRegBit(REG_IRIN_CFG_GPIO, DISABLE, BIT3);
            break;
        case PAD_PM_GPIO6:
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_L, DISABLE, BIT0|BIT1);
            break;
        case PAD_PM_GPIO12:
		case PAD_PM_GPIO13:
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_H, DISABLE, BIT7);
            break;
        case PAD_PM_CEC:
            MHal_GPIO_WriteRegBit(REG_IRIN_CFG_GPIO, ENABLE, BIT6);
            break;
        case PAD_HDMITX_HPD:
            MHal_GPIO_WriteRegBit(REG_HDMI_HPD_BYPASS, DISABLE, BIT7);
            break;
        case PAD_VID0:
        case PAD_VID1:
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_L, DISABLE, BIT6|BIT7);
		...
		case PAD_PM_LED0:
        case PAD_PM_LED1:
            MHal_GPIO_WriteRegBit(REG_MISC_CFG_GPIO_L, DISABLE, BIT4|BIT5);
			break;
	    case PAD_SAR_GPIO0:
            MHal_GPIO_WriteRegBit(REG_SAR_CFG_GPIO, DISABLE, BIT0);
            break;
        case PAD_SAR_GPIO1:
            MHal_GPIO_WriteRegBit(REG_SAR_CFG_GPIO, DISABLE, BIT1);
            break;
        case PAD_SAR_GPIO2:
            MHal_GPIO_WriteRegBit(REG_SAR_CFG_GPIO, DISABLE, BIT2);
            break;
		case PAD_HSYNC_OUT:
		case PAD_VSYNC_OUT:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_L, DISABLE, BIT0|BIT1);
			break;
		case PAD_GPIO0:
		case PAD_GPIO1:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT6|BIT7);
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_H, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_MSPI_MODE_CFG_GPIO, DISABLE, BIT2|BIT3);
			MHal_GPIO_WriteRegBit(REG_PWM_MODE_CFG_GPIO, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_USB30_MODE0_CFG_GPIO, DISABLE, BIT0|BIT1);
			break;
		case PAD_GPIO2:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			...
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_H, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_MSPI_MODE_CFG_GPIO, DISABLE, BIT2|BIT3);
			MHal_GPIO_WriteRegBit(REG_PWM_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_USB30_MODE0_CFG_GPIO, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_USB30_MODE1_CFG_GPIO, DISABLE, BIT0|BIT1);
			break;
		case PAD_GPIO3:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
		...
		case PAD_GPIO5:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_FUART_MODE_CFG_GPIO, DISABLE, BIT2|BIT3|BIT4|BIT5);
		    break;
		case PAD_GPIO6:
		case PAD_GPIO7:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
		...
		case PAD_GPIO8:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_SPDIF_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT2|BIT3);
			break;
		case PAD_GPIO9:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_SPDIF_MODE_CFG_GPIO, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT2|BIT3);
			break;
		case PAD_TS0_D4:
		case PAD_TS0_D5:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TEST_MODE_CFG_GPIO, DISABLE, BIT0|BIT1|BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_TS_MODE_CFG_GPIO, DISABLE, BIT0);
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_L, DISABLE, BIT0|BIT1);
			break;
		case PAD_TS2_CLK:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_TS_MODE_CFG_GPIO, DISABLE, BIT3|BIT4);
			break;
		case PAD_TS2_D0:
		case PAD_TS2_D1:
		case PAD_TS2_D2:
		...
		case PAD_I2CM0_SDA:
			...
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_L, DISABLE, BIT0|BIT1);
			MHal_GPIO_WriteRegBit(REG_MSPI_MODE_CFG_GPIO, DISABLE, BIT0|BIT1);
			break;
		case PAD_I2CM1_SCL:
		case PAD_I2CM1_SDA:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT2|BIT3);
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_L, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_MSPI_MODE_CFG_GPIO, DISABLE, BIT0|BIT1);
			break;
		case PAD_HDMITX_SCL:
		case PAD_HDMITX_SDA:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_I2C_MODE_CFG_GPIO, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_UART_MODE_CFG_GPIO_L, DISABLE, BIT4|BIT5);
			MHal_GPIO_WriteRegBit(REG_HDMI_MODE_CFG_GPIO, DISABLE, BIT4);
			break;
		case PAD_EMMC_IO0:
		case PAD_EMMC_IO1:
		case PAD_EMMC_IO2:
		...
		case PAD_EMMC_IO17:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_EMMC_NAND_CFG_GPIO, DISABLE, BIT0|BIT3);
			break;
		case PAD_GT0_MDIO:
		case PAD_GT0_MDC:
		case PAD_GT0_RX_CLK:
		...
		case PAD_GT0_TX_D3:
			MHal_GPIO_WriteRegBit(REG_ALL_PAD_IN, DISABLE, BIT7);
			MHal_GPIO_WriteRegBit(REG_GT_MODE_CFG_GPIO, DISABLE, BIT0);
			break;
        default:
            break;

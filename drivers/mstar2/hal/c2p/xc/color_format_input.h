...
#define CFD_SW_VERSION 0x02070B00
...
//0:current method
//1:new feature
#define CFDControlCSC 0

//0:not test
//1:test
#define CFDTestINInitial 0
...
#else
INTERFACE void MS_Cfd_OSD_Control(STU_CFDAPI_OSD_CONTROL *pstu_OSD_Param,MS_U8 u8MainSubMode, STU_CFD_MS_ALG_COLOR_FORMAT *pstu_ControlParam);
#endif

    ...
    {
        {
            ...
            .DvfsSysInfo =
            {
                ...
                .dwProtectedCpuClock = 216,
                .dwDefaultCpuPower = 103,
                .dwDefaultCorePower = 98,
            },
            .DvfsTemperatureInfo =
            {
                .dwLowerFreezeTemperature = 80,
                .dwUpperFreezeTemperature = 100,
                .dwLowerLevelTemperature = 115,
        ...
        },
        {
            ...
            .DvfsSysInfo =
            {
                .dwDefaultCpuClock = 1200,
                .dwMinimumCpuClock = 700,
                .dwMaximumCpuClock = 2000,
                .dwIRBoostCpuClock = 1200,
                .dwFreezeMaximumCpuClock = 2000,
                .dwNormalMaximumCpuClock = 1500,
                .dwAntutuProtectedCpuClock = 1500,
                .dwProtectedCpuClock = 216,
                .dwDefaultCpuPower = 103,
            ...
            .DvfsTemperatureInfo =
            {
                .dwLowerFreezeTemperature = 60,
                .dwUpperFreezeTemperature = 60,
                .dwLowerLevelTemperature = 115,
                .dwUpperLevelTemperature = 135,
                .dwMaxLevelTemperature = 160,
            },
            ...
            .DvfsFreezeModeInfo =
            {
                ...
                {
                    //Freeze Mode: 1501MHz - 2000MHz
                    .DvfsCpuInfo =
                    {
                        .dwLowerCpuClock = 1501,
                        .dwUpperCpuClock = 2001,
                    },
                    .DvfsGpuInfo =
                    {
                        .dwLowerGpuClock = 600,
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if(dwCpuClock == hMstarDvfsInfo.DvfsModeInfo[DvfsRegInfo->reg_chip_package].DvfsSysInfo.dwMaximumCpuClock)        //Antutu Protect clock
                        dwCpuClock = hMstarDvfsInfo.DvfsModeInfo[DvfsRegInfo->reg_chip_package].DvfsSysInfo.dwAntutuProtectedCpuClock;
...
void MHalDvfsCpuTemperature(void)
{
    ...
    if(hMstarDvfsInfo.dwRefTemperature == 0)
    {
        ...
        dwRegisterValue = *(volatile U16 *)(CONFIG_REGISTER_BASE_ADDRESS + (0x171550 << 1));
        dwRegisterValue >>= 6;
...
U32  MHalDvfsQueryCpuClock(U32 dwCpuClockType)
{
    ...
    {
        dwOutputCpuClock = hMstarDvfsInfo.DvfsModeInfo[DvfsRegInfo->reg_chip_package].DvfsSysInfo.dwIRBoostCpuClock;
    }
    else
    {
    ...
    if(DvfsRegInfo->reg_vid_dvfs_id == CONFIG_DVFS_ENABLE_PATTERN)
    {
        ...
        else
        {
            ...
            else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_FREEZE_MODE)
            {
                ...
                {
                    hMstarDvfsInfo.dwMaxCpuClockByTemperature = hMstarDvfsInfo.DvfsModeInfo[DvfsRegInfo->reg_chip_package].DvfsSysInfo.dwFreezeMaximumCpuClock;
                }
            }
            else if((DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_NORMAL_MODE) || (DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_SPECIAL_CLOCK_MODE))
            {
                ...
                {
                    //Keep at Normal Mode
                    hMstarDvfsInfo.dwMaxCpuClockByTemperature = hMstarDvfsInfo.DvfsModeInfo[DvfsRegInfo->reg_chip_package].DvfsSysInfo.dwNormalMaximumCpuClock;
                }
            }
            else
            {
...
#ifdef CONFIG_MP_DVFS_CPUHOTPLUG
//=================================================================================================
U32 MHalDvfsGetOverTemperatureFlag(void)
{
...
void MHalDvfsRefTemperature(void)
{
    ...
    dwRegisterValue = *(volatile U16 *)(CONFIG_REGISTER_BASE_ADDRESS + (0x323cf0 << 1));
    dwRegisterValue >>= 6;
...
{
    return hMstarDvfsInfo.dwCpuTemperature;
}
//=================================================================================================

...
#define MIU_REG_BANK                         0x1006      // MIU2 of Miami
#define CKG_REG_BANK                         0x100A      // CLKGEN2 of Miami
...
#define REG_MIU_SEL_ZDEC                     0x7a
    #define MIU_SEL_ZDEC_0                        BIT(8)
    #define MIU_SEL_ZDEC_1                        BIT(12)

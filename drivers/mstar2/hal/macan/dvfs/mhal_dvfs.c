    ...
    {
        {
            ...
            .DvfsSysInfo =
            {
                .dwDefaultCpuClock = 1200, //1250,
                .dwMinimumCpuClock = 1200, //1250,
                .dwMaximumCpuClock = 1201, //1400,
            ...
            .DvfsBootModeInfo =
            {
                ...
                {
                    .dwLowerCpuClock = 1200,    //BGA: 1050MHz
                    .dwUpperCpuClock = 1200,    //BGA: 1400MHz
                },
                .DvfsGpuInfo =
                {
                    .dwLowerGpuClock = 550,     //BGA: 500MHz

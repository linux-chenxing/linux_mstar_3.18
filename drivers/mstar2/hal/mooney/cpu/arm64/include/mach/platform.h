 ...
 */
#define chip_CA53_MPIC          (0x16000000)

#define chip_MPCORE_SCU         (chip_CA53_MPIC + 0x4000)
#define chip_MPCORE_GIC_CPU     (chip_CA53_MPIC + 0x0100)
#define chip_MPCORE_GIT	        (chip_CA53_MPIC + 0x0200)
#define chip_MPCORE_TWD	        (chip_CA53_MPIC + 0x0600)
#define chip_MPCORE_GIC_DIST    (chip_CA53_MPIC + 0x1000)

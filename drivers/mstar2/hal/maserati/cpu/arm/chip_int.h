...
#define REG_INT_FRC_BASE                (0xFD800000UL + (0x000000UL << 1))
...
typedef enum
{
    ...
    E_FIQ_TEMPERATURE_FAIL              = E_FIQH_START + 11, //reserved
    E_FIQ_AFEC_VSYNC                    = E_FIQH_START + 12,
    E_FIQ_DEC_DSP2UP                    = E_FIQH_START + 13, //reserved 
    ...
    E_FIQ_TEMPERATURE_RISE              = E_FIQEXPL_START + 0, //reserved
    ...
    E_FIQ_CA9_SCUEVABORT                = E_FIQEXPL_START + 9,//reserved
    ...
    E_IRQHYPL_RESERVED                   = E_IRQHYPL_START + 0, 
    ...
    E_IRQHYPL_RESERVED_01                = E_IRQHYPL_START + 12,

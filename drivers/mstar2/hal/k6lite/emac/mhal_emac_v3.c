...
void MHal_EMAC_Power_On_Clk( void )
{
    ...
    /* Set EMAC ahb clock to 144MHz */
    //MHal_EMAC_WritReg8(0x1033, 0x64, 0x08);
    ...
    //Enable TP_IDL ECO
    uRegVal = MHal_EMAC_ReadReg8(0x0033, 0x4d);
    uRegVal &= ~(0x80);
    MHal_EMAC_WritReg8(0x0033, 0x4d, uRegVal);

    //release snr setting after 1ms
    MHal_EMAC_WritReg8(0x0033, 0x94, 0x18); //wriu      0x003394  0x18

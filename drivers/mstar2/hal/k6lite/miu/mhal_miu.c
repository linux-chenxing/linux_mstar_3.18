...
MS_U16 clientId_KernelProtect[IDNUM_KERNELPROTECT] =
{
    ...
    MIU_CLIENT_BDMA_RW,MIU_CLIENT_EMAC_RW,
#ifdef CONFIG_CMA
...
int clientId_KernelProtectToName(MS_U16 clientId,char *clientName)
{
    ...
    switch(clientId)
    {
		...
		case  MIU_CLIENT_G3D_RW:
			strcpy(clientName,"MIU_CLIENT_G3D_RW");
			break;
		...
		case MIU_CLIENT_SATA_RW:
			strcpy(clientName,"MIU_CLIENT_SATA_RW");
			break;
		...
		case MIU_CLIENT_BDMA_RW:
		    strcpy(clientName,"MIU_CLIENT_BDMA_RW");
			break;
		case MIU_CLIENT_EMAC_RW:
		    strcpy(clientName,"MIU_CLIENT_EMAC_RW");
			break;
#ifdef CONFIG_CMA
...
MS_U16 IDs[MIU_MAX_DEVICE][MIU_MAX_PROTECT_ID] = {{0}, {0}, {0}}; //IDs for protection

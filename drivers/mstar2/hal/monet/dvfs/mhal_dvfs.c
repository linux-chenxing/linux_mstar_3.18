    ...
    .DvfsModeInfo =
    {
        ...
        },
        {
            ...
            .DvfsBootModeInfo =
            {
                ...
                .DvfsCpuInfo =
                {
                    .dwLowerCpuClock = 1400,    //New QFP: 1294MHz
                    .dwUpperCpuClock = 1400,    //New QFP: 1294MHz
                },
                .DvfsGpuInfo =
                {
                    .dwLowerGpuClock = 500,     //New QFP: 500MHz
                ...
                .DvfsPowerInfo =
                {
                    ...
                    {
                        //FF Corner Chip
                        .dwCpuPower = 116,      //New QFP: 1.27V
                        .dwCorePower = 95,     //New QFP: 1.00V
                    },
                },
            },
            .DvfsOverTemperatureModeInfo =
        ...
        },
        {
            ...
            .DvfsInitModeInfo =
            {
                ...
                .DvfsCpuInfo =
                {
                    .dwLowerCpuClock = 1200,    //BGA: 1050MHz
                    .dwUpperCpuClock = 1200,    //BGA: 1050MHz
                },
                .DvfsGpuInfo =
                {
                    .dwLowerGpuClock = 500,     //BGA: 500MHz
            ...
            .DvfsBootModeInfo =
            {
                ...
                {
                    .dwLowerCpuClock = 1200,    //BGA: 1050MHz
                    .dwUpperCpuClock = 1500,    //BGA: 1400MHz
                },
                .DvfsGpuInfo =
                {
                    .dwLowerGpuClock = 500,     //BGA: 500MHz
...
//  U32     dwRegisterValue = 0;
    ...
    reg_chip_package = (DvfsRegInfo->reg_chip_package | (DvfsRegInfo->reg_chip_package_extra << 2)) & 0xFF;
    ...
    if(DvfsRegInfo->reg_vid_dvfs_id == CONFIG_DVFS_ENABLE_PATTERN)
    {
        if(hMstarDvfsInfo.bDvfsInitOk == 0)
        {
            ...
            {
                hMstarDvfsInfo.dwFinalCpuClock = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsInitModeInfo.DvfsCpuInfo.dwLowerCpuClock;
        ...
        if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_INIT_MODE)
        {
            ...
            MHalDvfsCpuClockAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsInitModeInfo.DvfsCpuInfo.dwLowerCpuClock);

            if((hMstarDvfsInfo.dwCpuTemperature >= hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwUpperFreezeTemperature) && \
               (hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwUpperFreezeTemperature != CONFIG_DVFS_TEMPERATURE_DISABLE))
            {
        ...
        else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_BOOT_MODE)
        {
            ...
            if(hMstarDvfsInfo.dwBootTimeCounter > CONFIG_DVFS_BOOT_MODE_TIME)
            {
                ...
                MHalDvfsCpuClockAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsBootModeInfo.DvfsCpuInfo.dwLowerCpuClock);
    
                //Change to Normal Mode
                DvfsRegInfo->reg_cur_dvfs_state = CONFIG_DVFS_NORMAL_MODE;
    
                hMstarDvfsInfo.dwFinalCpuClock = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsBootModeInfo.DvfsCpuInfo.dwLowerCpuClock;
            }
            else
            {
                //Use Maximum CPU Clock in Boot Mode
                MHalDvfsCpuClockAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsBootModeInfo.DvfsCpuInfo.dwUpperCpuClock);
                hMstarDvfsInfo.dwFinalCpuClock = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsBootModeInfo.DvfsCpuInfo.dwUpperCpuClock;
            }
        }
        else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_OVER_TEMPERATURE_MODE)
        {
            ...
            else
            {
                ...
                MHalDvfsCpuClockAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwProtectedCpuClock);
                hMstarDvfsInfo.dwFinalCpuClock = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwProtectedCpuClock;
        ...
        else
        {
            ...
            else if((hMstarDvfsInfo.dwCpuTemperature < hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwLowerFreezeTemperature) && \
                    (hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwLowerFreezeTemperature != CONFIG_DVFS_TEMPERATURE_DISABLE))
            {
            ...
            else
            {
                if(DvfsRegInfo->reg_special_cpu_clk != CONFIG_DVFS_DYNAMIC_CLOCK_ADJUST_INIT)
                {
                    ...
                    if((dwRegisterValue >= hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwMinimumCpuClock) && \
                       (dwRegisterValue <= hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwMaximumCpuClock))
                    {
                        //Special Clock Mode
...
U32 MHalDvfsSearchCpuClockLevel(U32 dwCpuClock)
{
    ...
    {
        if((dwCpuClock >= hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsNormalModeInfo[dwLoopCounter].DvfsCpuInfo.dwLowerCpuClock) && \
           (dwCpuClock < hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsNormalModeInfo[dwLoopCounter].DvfsCpuInfo.dwUpperCpuClock))
        {
...
void MHalDvfsPowerControl(U32 dwCpuClock)
{
    ...
    if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_INIT_MODE)
    {
        //Init Mode
        //Adjust CPU Power
        MHalDvfsCpuPowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsInitModeInfo.DvfsPowerInfo[DvfsRegInfo->reg_cpu_pwr_type].dwCpuPower);

        //Adjust Core Power
        MHalDvfsCorePowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsInitModeInfo.DvfsPowerInfo[DvfsRegInfo->reg_core_pwr_type].dwCorePower);
    }
    else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_BOOT_MODE)
    {
        //Boot Mode
        ...
        {
            //Adjust CPU Power
            MHalDvfsCpuPowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsFreezeModeInfo[dwClockLevel].DvfsPowerInfo[DvfsRegInfo->reg_cpu_pwr_type].dwCpuPower);

            //Adjust Core Power
            MHalDvfsCorePowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsFreezeModeInfo[dwClockLevel].DvfsPowerInfo[DvfsRegInfo->reg_core_pwr_type].dwCorePower);
        }
        else
        {
            //Adjust CPU Power
            MHalDvfsCpuPowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsBootModeInfo.DvfsPowerInfo[DvfsRegInfo->reg_cpu_pwr_type].dwCpuPower);
    
            //Adjust Core Power
            MHalDvfsCorePowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsBootModeInfo.DvfsPowerInfo[DvfsRegInfo->reg_core_pwr_type].dwCorePower);
        }
    }
    else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_FREEZE_MODE)
    {
        ...
        {
            //Adjust CPU Power
            MHalDvfsCpuPowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwDefaultCpuPower);

            //Adjust Core Power
            MHalDvfsCorePowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwDefaultCorePower);
        }
        else
        {
            //Adjust CPU Power
    ...
    else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_OVER_TEMPERATURE_MODE)
    {
        //Over-Temperature Mode
        //Adjust CPU Power
        MHalDvfsCpuPowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsOverTemperatureModeInfo.DvfsPowerInfo[DvfsRegInfo->reg_cpu_pwr_type].dwCpuPower);

        //Adjust Core Power
        MHalDvfsCorePowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsOverTemperatureModeInfo.DvfsPowerInfo[DvfsRegInfo->reg_core_pwr_type].dwCorePower);
    }
    else
    {
        ...
        {
            //Adjust CPU Power
            MHalDvfsCpuPowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsNormalModeInfo[dwClockLevel].DvfsPowerInfo[DvfsRegInfo->reg_cpu_pwr_type].dwCpuPower);

            //Adjust Core Power
            MHalDvfsCorePowerAdjustment(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsNormalModeInfo[dwClockLevel].DvfsPowerInfo[DvfsRegInfo->reg_core_pwr_type].dwCorePower);
        }
    }
}
...
U32  MHalDvfsQueryCpuClock(U32 dwCpuClockType)
{
    ...
    {
        dwOutputCpuClock = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwMaximumCpuClock;
    }
    else if(dwCpuClockType == CONFIG_DVFS_MIN_CPU_CLOCK)
    {
        dwOutputCpuClock = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwMinimumCpuClock;
    }
    else
    {
...
//  S32     dwCpuTemperature = 0;
    ...
    if(DvfsRegInfo->reg_vid_dvfs_id == CONFIG_DVFS_ENABLE_PATTERN)
    {
        ...
        {
            hMstarDvfsInfo.dwMaxCpuClockByTemperature = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwDefaultCpuClock;
        }
        ...
        else
        {
            ...
            if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_INIT_MODE)
            {
                hMstarDvfsInfo.dwMaxCpuClockByTemperature = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsInitModeInfo.DvfsCpuInfo.dwLowerCpuClock;
            }
            else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_OVER_TEMPERATURE_MODE)
            {
                if(hMstarDvfsInfo.dwCpuTemperature > DvfsRegInfo->reg_max_level_temp)
                ...
                else if(hMstarDvfsInfo.dwCpuTemperature < DvfsRegInfo->reg_low_level_temp)
                {
                    ...
                    else
                    {
                        //Return to Normal Mode
                        DvfsRegInfo->reg_cur_dvfs_state = CONFIG_DVFS_NORMAL_MODE;
                        hMstarDvfsInfo.dwMaxCpuClockByTemperature = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwMaximumCpuClock;
                ...
                {
                    //Keep at Over-Temperature Mode
                    hMstarDvfsInfo.dwMaxCpuClockByTemperature = hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsSysInfo.dwProtectedCpuClock;
                }
            }
            else if(DvfsRegInfo->reg_cur_dvfs_state == CONFIG_DVFS_BOOT_MODE)
            {
                ...
                else if((hMstarDvfsInfo.dwCpuTemperature >= hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwUpperFreezeTemperature) && \
                   (hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwUpperFreezeTemperature != CONFIG_DVFS_TEMPERATURE_DISABLE))
                {
                    if(hMstarDvfsInfo.dwTemperatureCounter < CONFIG_DVFS_AVERAGE_COUNT)
                    {
                ...
                else
                {
                    ...
                    {
                        //Return to Normal Mode
                        if(hMstarDvfsInfo.DvfsModeInfo[reg_chip_package].DvfsTemperatureInfo.dwUpperFreezeTemperature == CONFIG_DVFS_TEMPERATURE_DISABLE)
                        {
                            DvfsRegInfo->reg_cur_dvfs_state = CONFIG_DVFS_NORMAL_MODE;
                        }
                        else

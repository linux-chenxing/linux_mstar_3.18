...
#define MSK_GPU_SRAM_SD_EN          0x0080
...
static void power_on(void)
{
    ...
    G3D_REG(REG_GPUPLL_CTRL1_LOW)  = (G3D_REG(REG_GPUPLL_CTRL1_LOW) & ~MSK_GPU_CLOCK) | (GPU_MAX_CLOCK / 24);
...
{
    mali_gpu_clock = GPU_MAX_CLOCK/24*24;
    power_on();
}

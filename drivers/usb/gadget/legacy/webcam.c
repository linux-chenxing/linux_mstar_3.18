...
static bool bulk_streaming_ep = 0;   //add claude.rao
...
static const struct UVC_FRAME_UNCOMPRESSED(3) uvc_frame_yuv_240p = {
    ...
    .dwMinBitRate       = cpu_to_le32(9216000),
    .dwMaxBitRate       = cpu_to_le32(23040000),
...
static const struct UVC_FRAME_UNCOMPRESSED(3) uvc_frame_yuv_360p = {
    ...
    .dwMinBitRate       = cpu_to_le32(5529600),
    .dwMaxBitRate       = cpu_to_le32(41472000),
...
webcam_bind(struct usb_composite_dev *cdev)
{
    ...
    if (!uvc_opts->bulk_streaming_ep)
        streaming_maxpacket = streaming_maxpacket;
    else
        streaming_maxpacket = 512;

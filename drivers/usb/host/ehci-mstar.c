		...
		struct usb_hcd **hcd_out, struct platform_device *dev)
{
	...
	else if( 0==strcmp(dev->name, "soc:Mstar-ehci-3") )
	{
	...
	else if( 0==strcmp(dev->name, "soc:Mstar-ehci-4") )
	{
